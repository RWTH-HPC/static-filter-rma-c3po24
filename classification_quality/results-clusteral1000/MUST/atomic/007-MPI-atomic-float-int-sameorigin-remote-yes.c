...
/*
{
    ...
    "RACE_PAIR": ["MPI_Accumulate@59","MPI_Accumulate@61"],
    "NPROCS": 2,
    "CONSISTENCY_CALLS": ["MPI_Win_fence"],
    "SYNC_CALLS": ["MPI_Barrier", "MPI_Win_fence"],
    "DESCRIPTION": "Two atomic operations acc and acc using different datatypes
(float and int) on the same origin such that there are no atomicity guarantees."
}
*/
// RACE LABELS END
