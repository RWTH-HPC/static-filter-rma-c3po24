...
/*
{
    ...
    "NPROCS": 2,
    "DESCRIPTION": "Two non-conflicting operations rget and load executed
...
/*
{
    ...
    "DESCRIPTION": "Two conflicting operations rget and load as request-based
operations that are synchronized correctly with MPI_Wait."
}
*/
// RACE LABELS END
