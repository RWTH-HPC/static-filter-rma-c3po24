...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@60","LOAD@68"],
    "NPROCS": 3,
    "CONSISTENCY_CALLS": ["MPI_Win_lock,MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier","MPI_Send","MPI_Recv"],
    "DESCRIPTION": "Two conflicting operations put and load which are not
correctly synchronized due to wrong MPI_Send / MPI_Recv call order. Rank 1
synchronizes with rank 2 with a send/recv pair first, and only after the
conflicting load access it synchronizes with rank 0."
}
*/
// RACE LABELS END
