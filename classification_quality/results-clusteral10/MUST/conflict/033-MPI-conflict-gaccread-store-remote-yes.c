...
/*
{
    ...
    "RACE_PAIR": ["MPI_Get_accumulate@58","STORE@64"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations gaccread and store executed
...
int main(int argc, char **argv) {
  ...
  if (rank == 0) {
    /* conflicting gaccread and store */
    // CONFLICT
    MPI_Get_accumulate(NULL, 0, MPI_DATATYPE_NULL, &value, 1, MPI_INT, 1, 0, 1,
                       MPI_INT, MPI_NO_OP, win);
  }
