...
/*
{
    ...
    "DESCRIPTION": "Two conflicting operations put and put which are correctly
synchronized with MPI_Send / MPI_Recv calls. Target rank 1 does no calls in
terms of consistency or synchronization calls."
}
*/
// RACE LABELS END
