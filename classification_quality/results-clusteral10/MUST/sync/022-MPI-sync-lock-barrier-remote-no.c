...
/*
{
    ...
    "NPROCS": 2,
    "CONSISTENCY_CALLS": ["MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "DESCRIPTION": "Two conflicting operations put and load where consistency is
ensured with MPI_Win_lock/lock and process synchronization with MPI_Barrier."
}
*/
// RACE LABELS END
