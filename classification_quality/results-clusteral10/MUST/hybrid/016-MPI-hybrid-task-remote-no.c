...
/*
{
    ...
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Put and a local load at
process 1. Since the tasks are separated by a taskwait construct, the local load
must occur after the barrier."
}
*/
// RACE LABELS END
