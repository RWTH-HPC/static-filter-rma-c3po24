...
/*
{
    ...
    "RACE_PAIR": ["MPI_Get@58","LOAD@60"],
    "NPROCS": 2,
    "CONSISTENCY_CALLS": ["MPI_Win_fence"],
    "SYNC_CALLS": ["MPI_Win_fence"],
    "DESCRIPTION": "Two conflicting operations get and get which are not
synchronized correcly with an MPI_Win_fence leading to a local race."
}
*/
// RACE LABELS END
