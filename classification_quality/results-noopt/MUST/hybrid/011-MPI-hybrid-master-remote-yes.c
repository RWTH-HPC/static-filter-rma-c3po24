...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@65","LOAD@76"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Put and a local load with
missing synchronization at process 1. Since only the main thread of the target
synchronizes with the origin, the access of the non-master thread leads to a
remote race."
}
*/
// RACE LABELS END
