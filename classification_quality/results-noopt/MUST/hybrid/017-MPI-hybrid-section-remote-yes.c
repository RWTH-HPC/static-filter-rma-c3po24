...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@64","LOAD@80"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Put and a local load with
missing synchronization at process 1. Since sections are run in parallel the
second section does not synchronize with rank 0."
}
*/
// RACE LABELS END
