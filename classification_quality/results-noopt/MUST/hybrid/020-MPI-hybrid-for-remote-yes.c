...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@65","LOAD@79"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Put and a local load with
missing synchronization at process 1. Since the iterations of the loop can be
scheduled arbitrarily, the local load and MPI_Barrier are concurrent, resulting
in a remote race."
}
*/
// RACE LABELS END
