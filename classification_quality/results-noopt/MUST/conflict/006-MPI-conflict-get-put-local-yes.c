...
{
    "RACE_KIND": "local",
    "ACCESS_SET": ["local buffer write","local buffer read"],
    "RACE_PAIR": ["MPI_Get@56","MPI_Put@58"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations get and put executed concurrently
