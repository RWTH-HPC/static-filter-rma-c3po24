; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/atomic/009-MPI-atomic-int-int-remote-no.c'
...
46:                                               ; preds = %40
  ...
  %49 = call i32 @MPI_Accumulate(ptr noundef %47, i32 noundef 4, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 4, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %48), !dbg !117
  br label %50, !dbg !118
...
53:                                               ; preds = %50
  ...
  %56 = call i32 @MPI_Accumulate(ptr noundef %54, i32 noundef 4, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 4, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %55), !dbg !128
  br label %57, !dbg !129

57:                                               ; preds = %53, %50
  %58 = load ptr, ptr %8, align 8, !dbg !130
  %59 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %58), !dbg !131
  %60 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !132
  ...
  %69 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !139
