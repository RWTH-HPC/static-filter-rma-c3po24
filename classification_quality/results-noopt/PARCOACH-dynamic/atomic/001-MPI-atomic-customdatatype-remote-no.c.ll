; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c'
...
49:                                               ; preds = %41
  ...
  %52 = call i32 @MPI_Accumulate(ptr noundef %50, i32 noundef 4, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 4, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %51), !dbg !121
  br label %53, !dbg !122
...
56:                                               ; preds = %53
  ...
  %61 = call i32 @MPI_Accumulate(ptr noundef %57, i32 noundef 1, ptr noundef %58, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef %59, ptr noundef @ompi_mpi_op_sum, ptr noundef %60), !dbg !134
  br label %62, !dbg !135

62:                                               ; preds = %56, %53
  %63 = load ptr, ptr %8, align 8, !dbg !136
  %64 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %63), !dbg !137
  %65 = call i32 @MPI_Type_free(ptr noundef %16), !dbg !138
  %66 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !139
  ...
  %75 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !146
