; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c"
...
@0 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c\00", align 1
...
46:                                               ; preds = %40
  ...
  %47 = getelementptr inbounds [4 x float], ptr %16, i64 0, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @4), !dbg !117
  %48 = load ptr, ptr %8, align 8, !dbg !117
  %49 = call i32 @parcoach_rma_MPI_Accumulate(ptr %47, i32 4, ptr @ompi_mpi_float, i32 1, i64 0, i32 4, ptr @ompi_mpi_float, ptr @ompi_mpi_op_sum, ptr %48, i32 58, ptr @5), !dbg !118
  br label %50, !dbg !119
...
53:                                               ; preds = %50
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @7), !dbg !129
  %55 = load ptr, ptr %8, align 8, !dbg !129
  %56 = call i32 @parcoach_rma_MPI_Accumulate(ptr %54, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %55, i32 64, ptr @8), !dbg !130
  br label %57, !dbg !131

57:                                               ; preds = %53, %50
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @9), !dbg !132
  %58 = load ptr, ptr %8, align 8, !dbg !132
  %59 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %58, i32 67, ptr @10), !dbg !133
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @11), !dbg !134
  call void @parcoach_rma_load(ptr %6, i64 32, i32 72, ptr @12), !dbg !135
  %61 = load i32, ptr %6, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %12, i64 64, i32 72, ptr @13), !dbg !136
  %62 = load ptr, ptr %12, align 8, !dbg !136
  call void @parcoach_rma_load(ptr %62, i64 32, i32 72, ptr @14), !dbg !137
  %63 = load i32, ptr %62, align 4, !dbg !137
  call void @parcoach_rma_load(ptr %11, i64 32, i32 72, ptr @15), !dbg !138
  %64 = load i32, ptr %11, align 4, !dbg !138
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @16), !dbg !139
  %65 = load ptr, ptr %9, align 8, !dbg !139
  %66 = getelementptr inbounds i32, ptr %65, i64 0, !dbg !139
  call void @parcoach_rma_load(ptr %66, i64 32, i32 72, ptr @17), !dbg !139
  ...
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @18), !dbg !141
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/atomic/006-MPI-atomic-float-int-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "dd9f1beebdde8057e4142ec9113ed18e")
