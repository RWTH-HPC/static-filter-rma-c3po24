; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c'
...
46:                                               ; preds = %40
  ...
  %49 = call i32 @MPI_Accumulate(ptr noundef %47, i32 noundef 4, ptr noundef @ompi_mpi_float, i32 noundef 1, i64 noundef 0, i32 noundef 4, ptr noundef @ompi_mpi_float, ptr noundef @ompi_mpi_op_sum, ptr noundef %48), !dbg !121
  %50 = getelementptr inbounds [4 x i32], ptr %17, i64 0, i64 0, !dbg !122
  %51 = load ptr, ptr %8, align 8, !dbg !123
  %52 = call i32 @MPI_Accumulate(ptr noundef %50, i32 noundef 4, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 4, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %51), !dbg !124
  br label %53, !dbg !125

53:                                               ; preds = %46, %40
  %54 = load ptr, ptr %8, align 8, !dbg !126
  %55 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %54), !dbg !127
  %56 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !128
  ...
  %65 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !135
