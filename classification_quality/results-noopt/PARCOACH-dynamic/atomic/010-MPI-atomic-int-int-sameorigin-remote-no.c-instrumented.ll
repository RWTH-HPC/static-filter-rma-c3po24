; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c.ll'
...
@0 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@1 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@2 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@3 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@4 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@5 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@6 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@7 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@8 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@9 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@10 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@11 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@12 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@13 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@14 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@15 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@16 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@17 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@18 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@19 = private unnamed_addr constant [94 x i8] c"results-20240305-201640/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
...
27:                                               ; preds = %23, %2
  %28 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 45, ptr @0), !dbg !83
...
40:                                               ; preds = %29
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 51, ptr @1), !dbg !102
  %42 = load ptr, ptr %8, align 8, !dbg !103
  %43 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %42, i32 53, ptr @2), !dbg !104
...
46:                                               ; preds = %40
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @4), !dbg !118
  %48 = load ptr, ptr %8, align 8, !dbg !118
  %49 = call i32 @parcoach_rma_MPI_Accumulate(ptr %47, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %48, i32 57, ptr @5), !dbg !119
  %50 = getelementptr inbounds [4 x i32], ptr %17, i64 0, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @6), !dbg !121
  %51 = load ptr, ptr %8, align 8, !dbg !121
  %52 = call i32 @parcoach_rma_MPI_Accumulate(ptr %50, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %51, i32 58, ptr @7), !dbg !122
  br label %53, !dbg !123

53:                                               ; preds = %46, %40
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @8), !dbg !124
  %54 = load ptr, ptr %8, align 8, !dbg !124
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 60, ptr @9), !dbg !125
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @10), !dbg !126
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @11), !dbg !127
  %57 = load i32, ptr %6, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @12), !dbg !128
  %58 = load ptr, ptr %12, align 8, !dbg !128
  call void @parcoach_rma_load(ptr %58, i64 32, i32 65, ptr @13), !dbg !129
  %59 = load i32, ptr %58, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @14), !dbg !130
  %60 = load i32, ptr %11, align 4, !dbg !130
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @15), !dbg !131
  %61 = load ptr, ptr %9, align 8, !dbg !131
  %62 = getelementptr inbounds i32, ptr %61, i64 0, !dbg !131
  call void @parcoach_rma_load(ptr %62, i64 32, i32 65, ptr @16), !dbg !131
  ...
  %65 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @17), !dbg !133
