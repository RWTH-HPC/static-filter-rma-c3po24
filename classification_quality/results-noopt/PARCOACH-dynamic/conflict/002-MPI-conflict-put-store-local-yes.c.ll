; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c'
...
48:                                               ; preds = %43, %38
  ...
  %50 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %49), !dbg !113
  %51 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !114
  ...
  %60 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !121
