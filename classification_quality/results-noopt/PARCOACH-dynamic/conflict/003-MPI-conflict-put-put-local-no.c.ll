; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c'
...
43:                                               ; preds = %38
  ...
  %46 = call i32 @MPI_Put(ptr noundef %44, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %45), !dbg !108
  %47 = load ptr, ptr %12, align 8, !dbg !109
  %48 = load ptr, ptr %8, align 8, !dbg !110
  %49 = call i32 @MPI_Put(ptr noundef %47, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 1, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %48), !dbg !111
  br label %50, !dbg !112

50:                                               ; preds = %43, %38
  %51 = load ptr, ptr %8, align 8, !dbg !113
  %52 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %51), !dbg !114
  %53 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !115
  ...
  %62 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !122
