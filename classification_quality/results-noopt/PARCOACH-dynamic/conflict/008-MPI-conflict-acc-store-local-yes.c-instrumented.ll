; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c\00", align 1
...
38:                                               ; preds = %27
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 54, ptr @2), !dbg !104
  %41 = load i32, ptr %6, align 4, !dbg !104
  %42 = icmp eq i32 %41, 0, !dbg !106
  br i1 %42, label %43, label %47, !dbg !107

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @3), !dbg !108
  %44 = load ptr, ptr %8, align 8, !dbg !108
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %44, i32 56, ptr @4), !dbg !110
  call void @parcoach_rma_load(ptr %12, i64 64, i32 58, ptr @5), !dbg !111
  %46 = load ptr, ptr %12, align 8, !dbg !111
  call void @parcoach_rma_store(ptr %46, i64 32, i32 58, ptr @6), !dbg !112
  store i32 42, ptr %46, align 4, !dbg !112
  br label %47, !dbg !113

47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @7), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 60, ptr @8), !dbg !115
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @9), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @10), !dbg !117
  %51 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @11), !dbg !118
  %52 = load ptr, ptr %12, align 8, !dbg !118
  call void @parcoach_rma_load(ptr %52, i64 32, i32 65, ptr @12), !dbg !119
  %53 = load i32, ptr %52, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @13), !dbg !120
  %54 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @14), !dbg !121
  %55 = load ptr, ptr %9, align 8, !dbg !121
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %56, i64 32, i32 65, ptr @15), !dbg !121
  %57 = load i32, ptr %56, align 4, !dbg !121
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51, i32 noundef %53, i32 noundef %54, i32 noundef %57), !dbg !122
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @16), !dbg !123
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/008-MPI-conflict-acc-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "19d92e7640af690daa6e39446a762c33")
...
!105 = distinct !DILexicalBlock(scope: !38, file: !2, line: 54, column: 7)
!106 = !DILocation(line: 54, column: 12, scope: !105)
!107 = !DILocation(line: 54, column: 7, scope: !38)
!108 = !DILocation(line: 56, column: 67, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 54, column: 18)
!110 = !DILocation(line: 56, column: 5, scope: !109)
!111 = !DILocation(line: 58, column: 6, scope: !109)
!112 = !DILocation(line: 58, column: 10, scope: !109)
!113 = !DILocation(line: 59, column: 3, scope: !109)
!114 = !DILocation(line: 60, column: 20, scope: !38)
!115 = !DILocation(line: 60, column: 3, scope: !38)
!116 = !DILocation(line: 62, column: 3, scope: !38)
!117 = !DILocation(line: 65, column: 10, scope: !38)
!118 = !DILocation(line: 65, column: 17, scope: !38)
!119 = !DILocation(line: 65, column: 16, scope: !38)
!120 = !DILocation(line: 65, column: 22, scope: !38)
!121 = !DILocation(line: 65, column: 30, scope: !38)
!122 = !DILocation(line: 63, column: 3, scope: !38)
!123 = !DILocation(line: 67, column: 3, scope: !38)
!124 = !DILocation(line: 68, column: 3, scope: !38)
!125 = !DILocation(line: 70, column: 3, scope: !38)
