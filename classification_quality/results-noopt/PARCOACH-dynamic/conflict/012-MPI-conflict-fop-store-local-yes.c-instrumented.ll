; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 58, ptr @4), !dbg !111
  %46 = load ptr, ptr %12, align 8, !dbg !111
  call void @parcoach_rma_store(ptr %46, i64 32, i32 58, ptr @5), !dbg !112
  store i32 42, ptr %46, align 4, !dbg !112
  br label %47, !dbg !113

47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @6), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 60, ptr @7), !dbg !115
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @8), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @9), !dbg !117
  %51 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @10), !dbg !118
  %52 = load ptr, ptr %12, align 8, !dbg !118
  call void @parcoach_rma_load(ptr %52, i64 32, i32 65, ptr @11), !dbg !119
  %53 = load i32, ptr %52, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @12), !dbg !120
  %54 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @13), !dbg !121
  %55 = load ptr, ptr %9, align 8, !dbg !121
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %56, i64 32, i32 65, ptr @14), !dbg !121
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @15), !dbg !123
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "16aadcbc48dd41def2e170d6d9238e84")
...
!108 = !DILocation(line: 56, column: 63, scope: !109)
