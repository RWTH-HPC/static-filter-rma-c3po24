; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c'
...
54:                                               ; preds = %51, %48
  ...
  %56 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %55), !dbg !119
  %57 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !120
  ...
  %66 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !127
