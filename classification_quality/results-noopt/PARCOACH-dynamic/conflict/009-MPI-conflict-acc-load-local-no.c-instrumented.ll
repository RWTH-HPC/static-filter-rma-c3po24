; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 52, ptr @2), !dbg !109
  %41 = load i32, ptr %6, align 4, !dbg !109
  %42 = icmp eq i32 %41, 0, !dbg !111
  br i1 %42, label %43, label %49, !dbg !112

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 53, ptr @3), !dbg !113
  %44 = load ptr, ptr %8, align 8, !dbg !113
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %44, i32 53, ptr @4), !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 54, ptr @5), !dbg !116
  %46 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %46, i64 32, i32 54, ptr @6), !dbg !117
  %47 = load i32, ptr %46, align 4, !dbg !117
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %47), !dbg !118
  br label %49, !dbg !119

49:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @7), !dbg !120
  %50 = load ptr, ptr %8, align 8, !dbg !120
  %51 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %50, i32 56, ptr @8), !dbg !121
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 58, ptr @9), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @10), !dbg !123
  %53 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 61, ptr @11), !dbg !124
  %54 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %54, i64 32, i32 61, ptr @12), !dbg !125
  %55 = load i32, ptr %54, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 61, ptr @13), !dbg !126
  %56 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 61, ptr @14), !dbg !127
  %57 = load ptr, ptr %9, align 8, !dbg !127
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %58, i64 32, i32 61, ptr @15), !dbg !127
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 63, ptr @16), !dbg !129
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "ca53bd2213f55e0b7f3a0620ce598282")
