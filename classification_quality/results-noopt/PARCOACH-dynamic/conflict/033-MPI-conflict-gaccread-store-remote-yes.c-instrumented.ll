; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c"
...
@0 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c\00", align 1
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !38 {
  ...
  %20 = icmp ne i32 %19, 2, !dbg !76
  br i1 %20, label %21, label %25, !dbg !77

21:                                               ; preds = %2
  %22 = load i32, ptr %7, align 4, !dbg !78
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %22, i32 noundef 2), !dbg !80
  %24 = call i32 @MPI_Abort(ptr noundef @ompi_mpi_comm_world, i32 noundef 1), !dbg !81
  br label %25, !dbg !82

25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 47, ptr @0), !dbg !83
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 49, ptr @17), !dbg !97
  %36 = load i32, ptr %15, align 4, !dbg !97
  %37 = add nsw i32 %36, 1, !dbg !97
  call void @parcoach_rma_store(ptr %15, i64 32, i32 49, ptr @18), !dbg !97
  store i32 %37, ptr %15, align 4, !dbg !97
  br label %27, !dbg !98, !llvm.loop !99

38:                                               ; preds = %27
  %39 = load ptr, ptr %8, align 8, !dbg !102
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 53, ptr @1), !dbg !103
  call void @parcoach_rma_load(ptr %6, i64 32, i32 55, ptr @2), !dbg !104
  %41 = load i32, ptr %6, align 4, !dbg !104
  %42 = icmp eq i32 %41, 0, !dbg !106
  br i1 %42, label %43, label %46, !dbg !107

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @3), !dbg !108
  %44 = load ptr, ptr %8, align 8, !dbg !108
  %45 = call i32 @MPI_Get_accumulate(ptr noundef null, i32 noundef 0, ptr noundef @ompi_mpi_datatype_null, ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_no_op, ptr noundef %44), !dbg !110
  br label %46, !dbg !111

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 62, ptr @4), !dbg !112
  %47 = load i32, ptr %6, align 4, !dbg !112
  %48 = icmp eq i32 %47, 1, !dbg !114
  br i1 %48, label %49, label %52, !dbg !115

49:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 64, ptr @5), !dbg !116
  %50 = load ptr, ptr %9, align 8, !dbg !116
  %51 = getelementptr inbounds i32, ptr %50, i64 0, !dbg !116
  call void @parcoach_rma_store(ptr %51, i64 32, i32 64, ptr @6), !dbg !118
  store i32 42, ptr %51, align 4, !dbg !118
  br label %52, !dbg !119

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @7), !dbg !120
  %53 = load ptr, ptr %8, align 8, !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 67, ptr @8), !dbg !121
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @9), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 72, ptr @10), !dbg !123
  %56 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 72, ptr @11), !dbg !124
  %57 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %57, i64 32, i32 72, ptr @12), !dbg !125
  %58 = load i32, ptr %57, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 72, ptr @13), !dbg !126
  %59 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @14), !dbg !127
  %60 = load ptr, ptr %9, align 8, !dbg !127
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %61, i64 32, i32 72, ptr @15), !dbg !127
  %62 = load i32, ptr %61, align 4, !dbg !127
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56, i32 noundef %58, i32 noundef %59, i32 noundef %62), !dbg !128
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @16), !dbg !129
  %65 = call i32 @MPI_Finalize(), !dbg !130
  ret i32 0, !dbg !131
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/033-MPI-conflict-gaccread-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "efdd0db605ddb592ab95323b67a5e98d")
...
!108 = !DILocation(line: 59, column: 44, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 55, column: 18)
!110 = !DILocation(line: 58, column: 5, scope: !109)
!111 = !DILocation(line: 60, column: 3, scope: !109)
!112 = !DILocation(line: 62, column: 7, scope: !113)
!113 = distinct !DILexicalBlock(scope: !38, file: !2, line: 62, column: 7)
!114 = !DILocation(line: 62, column: 12, scope: !113)
!115 = !DILocation(line: 62, column: 7, scope: !38)
!116 = !DILocation(line: 64, column: 5, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 62, column: 18)
!118 = !DILocation(line: 64, column: 17, scope: !117)
!119 = !DILocation(line: 65, column: 3, scope: !117)
!120 = !DILocation(line: 67, column: 20, scope: !38)
!121 = !DILocation(line: 67, column: 3, scope: !38)
!122 = !DILocation(line: 69, column: 3, scope: !38)
!123 = !DILocation(line: 72, column: 10, scope: !38)
!124 = !DILocation(line: 72, column: 17, scope: !38)
!125 = !DILocation(line: 72, column: 16, scope: !38)
!126 = !DILocation(line: 72, column: 22, scope: !38)
!127 = !DILocation(line: 72, column: 30, scope: !38)
!128 = !DILocation(line: 70, column: 3, scope: !38)
!129 = !DILocation(line: 74, column: 3, scope: !38)
!130 = !DILocation(line: 75, column: 3, scope: !38)
!131 = !DILocation(line: 77, column: 3, scope: !38)
