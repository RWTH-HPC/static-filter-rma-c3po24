; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 49, ptr @18), !dbg !102
  %36 = load i32, ptr %15, align 4, !dbg !102
  %37 = add nsw i32 %36, 1, !dbg !102
  call void @parcoach_rma_store(ptr %15, i64 32, i32 49, ptr @19), !dbg !102
...
38:                                               ; preds = %27
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 55, ptr @2), !dbg !109
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %44, i32 58, ptr @4), !dbg !115
  br label %46, !dbg !116

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @5), !dbg !117
  %47 = load i32, ptr %6, align 4, !dbg !117
  %48 = icmp eq i32 %47, 1, !dbg !119
  br i1 %48, label %49, label %54, !dbg !120

49:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @6), !dbg !121
  %50 = load ptr, ptr %9, align 8, !dbg !121
  %51 = getelementptr inbounds i32, ptr %50, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %51, i64 32, i32 63, ptr @7), !dbg !121
  %52 = load i32, ptr %51, align 4, !dbg !121
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %52), !dbg !123
  br label %54, !dbg !124

54:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @8), !dbg !125
  %55 = load ptr, ptr %8, align 8, !dbg !125
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %55, i32 66, ptr @9), !dbg !126
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @10), !dbg !127
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @11), !dbg !128
  %58 = load i32, ptr %6, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @12), !dbg !129
  %59 = load ptr, ptr %12, align 8, !dbg !129
  call void @parcoach_rma_load(ptr %59, i64 32, i32 71, ptr @13), !dbg !130
  %60 = load i32, ptr %59, align 4, !dbg !130
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @14), !dbg !131
  %61 = load i32, ptr %11, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @15), !dbg !132
  %62 = load ptr, ptr %9, align 8, !dbg !132
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !132
  call void @parcoach_rma_load(ptr %63, i64 32, i32 71, ptr @16), !dbg !132
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @17), !dbg !134
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/027-MPI-conflict-acc-load-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "c441346828e361096fc98495311bde58")
...
!109 = !DILocation(line: 55, column: 7, scope: !110)
!110 = distinct !DILexicalBlock(scope: !43, file: !2, line: 55, column: 7)
!111 = !DILocation(line: 55, column: 12, scope: !110)
!112 = !DILocation(line: 55, column: 7, scope: !43)
!113 = !DILocation(line: 58, column: 67, scope: !114)
!114 = distinct !DILexicalBlock(scope: !110, file: !2, line: 55, column: 18)
!115 = !DILocation(line: 58, column: 5, scope: !114)
!116 = !DILocation(line: 59, column: 3, scope: !114)
!117 = !DILocation(line: 61, column: 7, scope: !118)
!118 = distinct !DILexicalBlock(scope: !43, file: !2, line: 61, column: 7)
!119 = !DILocation(line: 61, column: 12, scope: !118)
!120 = !DILocation(line: 61, column: 7, scope: !43)
!121 = !DILocation(line: 63, column: 35, scope: !122)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 61, column: 18)
!123 = !DILocation(line: 63, column: 5, scope: !122)
!124 = !DILocation(line: 64, column: 3, scope: !122)
!125 = !DILocation(line: 66, column: 20, scope: !43)
!126 = !DILocation(line: 66, column: 3, scope: !43)
!127 = !DILocation(line: 68, column: 3, scope: !43)
!128 = !DILocation(line: 71, column: 10, scope: !43)
!129 = !DILocation(line: 71, column: 17, scope: !43)
!130 = !DILocation(line: 71, column: 16, scope: !43)
!131 = !DILocation(line: 71, column: 22, scope: !43)
!132 = !DILocation(line: 71, column: 30, scope: !43)
!133 = !DILocation(line: 69, column: 3, scope: !43)
!134 = !DILocation(line: 73, column: 3, scope: !43)
!135 = !DILocation(line: 74, column: 3, scope: !43)
!136 = !DILocation(line: 76, column: 3, scope: !43)
