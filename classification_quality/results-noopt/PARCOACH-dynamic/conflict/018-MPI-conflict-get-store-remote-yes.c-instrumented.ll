; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 49, ptr @19), !dbg !94
  %36 = load i32, ptr %15, align 4, !dbg !94
  %37 = add nsw i32 %36, 1, !dbg !94
  call void @parcoach_rma_store(ptr %15, i64 32, i32 49, ptr @20), !dbg !94
...
47:                                               ; preds = %43, %38
  ...
  %49 = icmp eq i32 %48, 1, !dbg !112
  br i1 %49, label %50, label %53, !dbg !113

50:                                               ; preds = %47
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @7), !dbg !114
  %51 = load ptr, ptr %9, align 8, !dbg !114
  %52 = getelementptr inbounds i32, ptr %51, i64 0, !dbg !114
  call void @parcoach_rma_store(ptr %52, i64 32, i32 63, ptr @8), !dbg !116
  store i32 42, ptr %52, align 4, !dbg !116
  br label %53, !dbg !117

53:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @9), !dbg !118
  %54 = load ptr, ptr %8, align 8, !dbg !118
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 66, ptr @10), !dbg !119
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @11), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @12), !dbg !121
  %57 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @13), !dbg !122
  %58 = load ptr, ptr %12, align 8, !dbg !122
  call void @parcoach_rma_load(ptr %58, i64 32, i32 71, ptr @14), !dbg !123
  %59 = load i32, ptr %58, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @15), !dbg !124
  %60 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @16), !dbg !125
  %61 = load ptr, ptr %9, align 8, !dbg !125
  %62 = getelementptr inbounds i32, ptr %61, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %62, i64 32, i32 71, ptr @17), !dbg !125
  %63 = load i32, ptr %62, align 4, !dbg !125
  %64 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %57, i32 noundef %59, i32 noundef %60, i32 noundef %63), !dbg !126
  %65 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @18), !dbg !127
  %66 = call i32 @MPI_Finalize(), !dbg !128
  ret i32 0, !dbg !129
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/018-MPI-conflict-get-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "64b240f651ac8bd1548b82f16ca01699")
...
!117 = !DILocation(line: 64, column: 3, scope: !115)
!118 = !DILocation(line: 66, column: 20, scope: !35)
!119 = !DILocation(line: 66, column: 3, scope: !35)
!120 = !DILocation(line: 68, column: 3, scope: !35)
!121 = !DILocation(line: 71, column: 10, scope: !35)
!122 = !DILocation(line: 71, column: 17, scope: !35)
!123 = !DILocation(line: 71, column: 16, scope: !35)
!124 = !DILocation(line: 71, column: 22, scope: !35)
!125 = !DILocation(line: 71, column: 30, scope: !35)
!126 = !DILocation(line: 69, column: 3, scope: !35)
!127 = !DILocation(line: 73, column: 3, scope: !35)
!128 = !DILocation(line: 74, column: 3, scope: !35)
!129 = !DILocation(line: 76, column: 3, scope: !35)
