; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c\00", align 1
...
46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 57, ptr @4), !dbg !112
  %47 = load i32, ptr %6, align 4, !dbg !112
  %48 = icmp eq i32 %47, 2, !dbg !114
  br i1 %48, label %49, label %52, !dbg !115

49:                                               ; preds = %46
  call void @parcoach_rma_store(ptr %10, i64 32, i32 58, ptr @5), !dbg !116
  store i32 2, ptr %10, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @6), !dbg !118
  %50 = load ptr, ptr %8, align 8, !dbg !118
  %51 = call i32 @MPI_Fetch_and_op(ptr noundef %10, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef @ompi_mpi_op_sum, ptr noundef %50), !dbg !119
  br label %52, !dbg !120

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @7), !dbg !121
  %53 = load ptr, ptr %8, align 8, !dbg !121
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 62, ptr @8), !dbg !122
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @9), !dbg !123
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @10), !dbg !124
  %56 = load i32, ptr %6, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %12, i64 64, i32 67, ptr @11), !dbg !125
  %57 = load ptr, ptr %12, align 8, !dbg !125
  call void @parcoach_rma_load(ptr %57, i64 32, i32 67, ptr @12), !dbg !126
  %58 = load i32, ptr %57, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %11, i64 32, i32 67, ptr @13), !dbg !127
  %59 = load i32, ptr %11, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @14), !dbg !128
  %60 = load ptr, ptr %9, align 8, !dbg !128
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !128
  call void @parcoach_rma_load(ptr %61, i64 32, i32 67, ptr @15), !dbg !128
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 69, ptr @16), !dbg !130
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/036-MPI-conflict-fop-fop-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "0ceb933adeee28ac88e0750b88a61e2c")
...
!108 = !DILocation(line: 54, column: 63, scope: !109)
...
!118 = !DILocation(line: 59, column: 63, scope: !117)
!119 = !DILocation(line: 59, column: 5, scope: !117)
!120 = !DILocation(line: 60, column: 3, scope: !117)
!121 = !DILocation(line: 62, column: 20, scope: !38)
!122 = !DILocation(line: 62, column: 3, scope: !38)
!123 = !DILocation(line: 64, column: 3, scope: !38)
!124 = !DILocation(line: 67, column: 10, scope: !38)
!125 = !DILocation(line: 67, column: 17, scope: !38)
!126 = !DILocation(line: 67, column: 16, scope: !38)
!127 = !DILocation(line: 67, column: 22, scope: !38)
!128 = !DILocation(line: 67, column: 30, scope: !38)
!129 = !DILocation(line: 65, column: 3, scope: !38)
!130 = !DILocation(line: 69, column: 3, scope: !38)
!131 = !DILocation(line: 70, column: 3, scope: !38)
!132 = !DILocation(line: 72, column: 3, scope: !38)
