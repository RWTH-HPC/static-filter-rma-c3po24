; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
@19 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  call void @parcoach_rma_store(ptr %47, i64 32, i32 58, ptr @7), !dbg !110
  store i32 42, ptr %47, align 4, !dbg !110
  br label %48, !dbg !111

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @8), !dbg !112
  %49 = load ptr, ptr %8, align 8, !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %49, i32 60, ptr @9), !dbg !113
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @10), !dbg !114
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @11), !dbg !115
  %52 = load i32, ptr %6, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @12), !dbg !116
  %53 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %53, i64 32, i32 65, ptr @13), !dbg !117
  %54 = load i32, ptr %53, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @14), !dbg !118
  %55 = load i32, ptr %11, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @15), !dbg !119
  %56 = load ptr, ptr %9, align 8, !dbg !119
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %57, i64 32, i32 65, ptr @16), !dbg !119
  %58 = load i32, ptr %57, align 4, !dbg !119
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %52, i32 noundef %54, i32 noundef %55, i32 noundef %58), !dbg !120
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @17), !dbg !121
  %61 = call i32 @MPI_Finalize(), !dbg !122
  ret i32 0, !dbg !123
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/005-MPI-conflict-get-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "2bf76f477b180b30282d704fc38162bf")
