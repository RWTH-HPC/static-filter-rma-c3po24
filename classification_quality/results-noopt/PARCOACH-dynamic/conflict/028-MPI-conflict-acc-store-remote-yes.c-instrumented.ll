; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 49, ptr @18), !dbg !97
  %36 = load i32, ptr %15, align 4, !dbg !97
  %37 = add nsw i32 %36, 1, !dbg !97
  call void @parcoach_rma_store(ptr %15, i64 32, i32 49, ptr @19), !dbg !97
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !108
  %44 = load ptr, ptr %8, align 8, !dbg !108
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %44, i32 58, ptr @4), !dbg !110
  br label %46, !dbg !111

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @5), !dbg !112
  %47 = load i32, ptr %6, align 4, !dbg !112
  %48 = icmp eq i32 %47, 1, !dbg !114
  br i1 %48, label %49, label %52, !dbg !115

49:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @6), !dbg !116
  %50 = load ptr, ptr %9, align 8, !dbg !116
  %51 = getelementptr inbounds i32, ptr %50, i64 0, !dbg !116
  call void @parcoach_rma_store(ptr %51, i64 32, i32 63, ptr @7), !dbg !118
  store i32 42, ptr %51, align 4, !dbg !118
  br label %52, !dbg !119

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @8), !dbg !120
  %53 = load ptr, ptr %8, align 8, !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 66, ptr @9), !dbg !121
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @10), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @11), !dbg !123
  %56 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @12), !dbg !124
  %57 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %57, i64 32, i32 71, ptr @13), !dbg !125
  %58 = load i32, ptr %57, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @14), !dbg !126
  %59 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @15), !dbg !127
  %60 = load ptr, ptr %9, align 8, !dbg !127
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %61, i64 32, i32 71, ptr @16), !dbg !127
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @17), !dbg !129
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "38994a2817b661caf4a38733731df599")
...
!108 = !DILocation(line: 58, column: 67, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 55, column: 18)
!110 = !DILocation(line: 58, column: 5, scope: !109)
!111 = !DILocation(line: 59, column: 3, scope: !109)
!112 = !DILocation(line: 61, column: 7, scope: !113)
!113 = distinct !DILexicalBlock(scope: !38, file: !2, line: 61, column: 7)
!114 = !DILocation(line: 61, column: 12, scope: !113)
!115 = !DILocation(line: 61, column: 7, scope: !38)
!116 = !DILocation(line: 63, column: 5, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 61, column: 18)
!118 = !DILocation(line: 63, column: 17, scope: !117)
!119 = !DILocation(line: 64, column: 3, scope: !117)
!120 = !DILocation(line: 66, column: 20, scope: !38)
!121 = !DILocation(line: 66, column: 3, scope: !38)
!122 = !DILocation(line: 68, column: 3, scope: !38)
!123 = !DILocation(line: 71, column: 10, scope: !38)
!124 = !DILocation(line: 71, column: 17, scope: !38)
!125 = !DILocation(line: 71, column: 16, scope: !38)
!126 = !DILocation(line: 71, column: 22, scope: !38)
!127 = !DILocation(line: 71, column: 30, scope: !38)
!128 = !DILocation(line: 69, column: 3, scope: !38)
!129 = !DILocation(line: 73, column: 3, scope: !38)
!130 = !DILocation(line: 74, column: 3, scope: !38)
!131 = !DILocation(line: 76, column: 3, scope: !38)
