; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c"
...
@0 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@15 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@16 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@17 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@18 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@19 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@20 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 47, ptr @19), !dbg !97
  %36 = load i32, ptr %15, align 4, !dbg !97
  %37 = add nsw i32 %36, 1, !dbg !97
  call void @parcoach_rma_store(ptr %15, i64 32, i32 47, ptr @20), !dbg !97
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %12, i64 64, i32 54, ptr @3), !dbg !108
  %44 = load ptr, ptr %12, align 8, !dbg !108
  call void @parcoach_rma_load(ptr %8, i64 64, i32 54, ptr @4), !dbg !110
  %45 = load ptr, ptr %8, align 8, !dbg !110
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %44, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 54, ptr @5), !dbg !111
  br label %47, !dbg !112

47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 57, ptr @6), !dbg !113
  %48 = load i32, ptr %6, align 4, !dbg !113
  %49 = icmp eq i32 %48, 2, !dbg !115
  br i1 %49, label %50, label %53, !dbg !116

50:                                               ; preds = %47
  call void @parcoach_rma_store(ptr %10, i64 32, i32 58, ptr @7), !dbg !117
  store i32 2, ptr %10, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @8), !dbg !119
  %51 = load ptr, ptr %8, align 8, !dbg !119
  %52 = call i32 @MPI_Get_accumulate(ptr noundef null, i32 noundef 0, ptr noundef @ompi_mpi_datatype_null, ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_no_op, ptr noundef %51), !dbg !120
  br label %53, !dbg !121

53:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @9), !dbg !122
  %54 = load ptr, ptr %8, align 8, !dbg !122
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 63, ptr @10), !dbg !123
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @11), !dbg !124
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @12), !dbg !125
  %57 = load i32, ptr %6, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %12, i64 64, i32 68, ptr @13), !dbg !126
  %58 = load ptr, ptr %12, align 8, !dbg !126
  call void @parcoach_rma_load(ptr %58, i64 32, i32 68, ptr @14), !dbg !127
  %59 = load i32, ptr %58, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %11, i64 32, i32 68, ptr @15), !dbg !128
  %60 = load i32, ptr %11, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %9, i64 64, i32 68, ptr @16), !dbg !129
  %61 = load ptr, ptr %9, align 8, !dbg !129
  %62 = getelementptr inbounds i32, ptr %61, i64 0, !dbg !129
  call void @parcoach_rma_load(ptr %62, i64 32, i32 68, ptr @17), !dbg !129
  ...
  %65 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 70, ptr @18), !dbg !131
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "4b97dfcd63a9e158689cca6eed8dca6f")
...
!110 = !DILocation(line: 54, column: 48, scope: !109)
!111 = !DILocation(line: 54, column: 5, scope: !109)
!112 = !DILocation(line: 55, column: 3, scope: !109)
!113 = !DILocation(line: 57, column: 7, scope: !114)
!114 = distinct !DILexicalBlock(scope: !38, file: !2, line: 57, column: 7)
!115 = !DILocation(line: 57, column: 12, scope: !114)
!116 = !DILocation(line: 57, column: 7, scope: !38)
!117 = !DILocation(line: 58, column: 11, scope: !118)
!118 = distinct !DILexicalBlock(scope: !114, file: !2, line: 57, column: 18)
!119 = !DILocation(line: 60, column: 44, scope: !118)
!120 = !DILocation(line: 59, column: 5, scope: !118)
!121 = !DILocation(line: 61, column: 3, scope: !118)
!122 = !DILocation(line: 63, column: 20, scope: !38)
!123 = !DILocation(line: 63, column: 3, scope: !38)
!124 = !DILocation(line: 65, column: 3, scope: !38)
!125 = !DILocation(line: 68, column: 10, scope: !38)
!126 = !DILocation(line: 68, column: 17, scope: !38)
!127 = !DILocation(line: 68, column: 16, scope: !38)
!128 = !DILocation(line: 68, column: 22, scope: !38)
!129 = !DILocation(line: 68, column: 30, scope: !38)
!130 = !DILocation(line: 66, column: 3, scope: !38)
!131 = !DILocation(line: 70, column: 3, scope: !38)
!132 = !DILocation(line: 71, column: 3, scope: !38)
!133 = !DILocation(line: 73, column: 3, scope: !38)
