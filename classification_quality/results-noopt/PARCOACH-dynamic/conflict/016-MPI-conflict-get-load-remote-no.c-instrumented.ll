; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@18 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@19 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@20 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 47, ptr @19), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 47, ptr @20), !dbg !99
...
38:                                               ; preds = %27
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 53, ptr @2), !dbg !106
  %41 = load i32, ptr %6, align 4, !dbg !106
  %42 = icmp eq i32 %41, 0, !dbg !108
  br i1 %42, label %43, label %47, !dbg !109

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %12, i64 64, i32 54, ptr @3), !dbg !110
  %44 = load ptr, ptr %12, align 8, !dbg !110
  call void @parcoach_rma_load(ptr %8, i64 64, i32 54, ptr @4), !dbg !112
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %44, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 54, ptr @5), !dbg !113
  br label %47, !dbg !114

47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 57, ptr @6), !dbg !115
  %48 = load i32, ptr %6, align 4, !dbg !115
  %49 = icmp eq i32 %48, 1, !dbg !117
  br i1 %49, label %50, label %55, !dbg !118

50:                                               ; preds = %47
  call void @parcoach_rma_load(ptr %9, i64 64, i32 58, ptr @7), !dbg !119
  %51 = load ptr, ptr %9, align 8, !dbg !119
  %52 = getelementptr inbounds i32, ptr %51, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %52, i64 32, i32 58, ptr @8), !dbg !119
  %53 = load i32, ptr %52, align 4, !dbg !119
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %53), !dbg !121
  br label %55, !dbg !122

55:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @9), !dbg !123
  %56 = load ptr, ptr %8, align 8, !dbg !123
  %57 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %56, i32 61, ptr @10), !dbg !124
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @11), !dbg !125
  call void @parcoach_rma_load(ptr %6, i64 32, i32 66, ptr @12), !dbg !126
  %59 = load i32, ptr %6, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %12, i64 64, i32 66, ptr @13), !dbg !127
  %60 = load ptr, ptr %12, align 8, !dbg !127
  call void @parcoach_rma_load(ptr %60, i64 32, i32 66, ptr @14), !dbg !128
  %61 = load i32, ptr %60, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %11, i64 32, i32 66, ptr @15), !dbg !129
  %62 = load i32, ptr %11, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @16), !dbg !130
  %63 = load ptr, ptr %9, align 8, !dbg !130
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !130
  call void @parcoach_rma_load(ptr %64, i64 32, i32 66, ptr @17), !dbg !130
  ...
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 68, ptr @18), !dbg !132
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "7e34debe714d5225b5cf1826a204ae24")
...
!106 = !DILocation(line: 53, column: 7, scope: !107)
!107 = distinct !DILexicalBlock(scope: !40, file: !2, line: 53, column: 7)
!108 = !DILocation(line: 53, column: 12, scope: !107)
!109 = !DILocation(line: 53, column: 7, scope: !40)
!110 = !DILocation(line: 54, column: 13, scope: !111)
!111 = distinct !DILexicalBlock(scope: !107, file: !2, line: 53, column: 18)
!112 = !DILocation(line: 54, column: 48, scope: !111)
!113 = !DILocation(line: 54, column: 5, scope: !111)
!114 = !DILocation(line: 55, column: 3, scope: !111)
!115 = !DILocation(line: 57, column: 7, scope: !116)
!116 = distinct !DILexicalBlock(scope: !40, file: !2, line: 57, column: 7)
!117 = !DILocation(line: 57, column: 12, scope: !116)
!118 = !DILocation(line: 57, column: 7, scope: !40)
!119 = !DILocation(line: 58, column: 35, scope: !120)
!120 = distinct !DILexicalBlock(scope: !116, file: !2, line: 57, column: 18)
!121 = !DILocation(line: 58, column: 5, scope: !120)
!122 = !DILocation(line: 59, column: 3, scope: !120)
!123 = !DILocation(line: 61, column: 20, scope: !40)
!124 = !DILocation(line: 61, column: 3, scope: !40)
!125 = !DILocation(line: 63, column: 3, scope: !40)
!126 = !DILocation(line: 66, column: 10, scope: !40)
!127 = !DILocation(line: 66, column: 17, scope: !40)
!128 = !DILocation(line: 66, column: 16, scope: !40)
!129 = !DILocation(line: 66, column: 22, scope: !40)
!130 = !DILocation(line: 66, column: 30, scope: !40)
!131 = !DILocation(line: 64, column: 3, scope: !40)
!132 = !DILocation(line: 68, column: 3, scope: !40)
!133 = !DILocation(line: 69, column: 3, scope: !40)
