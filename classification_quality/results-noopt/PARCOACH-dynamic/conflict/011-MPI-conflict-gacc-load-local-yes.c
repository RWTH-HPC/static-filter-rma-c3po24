...
/*
{
    ...
    "RACE_PAIR": ["MPI_Get_accumulate@56","LOAD@59"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations gacc and load executed
...
int main(int argc, char **argv) {
  ...
  if (rank == 0) {
    // CONFLICT
    MPI_Get_accumulate(&value2, 1, MPI_INT, &value, 1, MPI_INT, 1, 0, 1,
                       MPI_INT, MPI_SUM, win);
    // CONFLICT
    printf("value is %d\n", *buf);
  }
