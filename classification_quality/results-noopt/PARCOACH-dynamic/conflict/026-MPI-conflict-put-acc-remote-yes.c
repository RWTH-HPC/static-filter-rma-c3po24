...
{
    "RACE_KIND": "remote",
    "ACCESS_SET": ["rma write","rma atomic write"],
    "RACE_PAIR": ["MPI_Put@58","MPI_Accumulate@64"],
    "NPROCS": 3,
    "DESCRIPTION": "Two conflicting operations put and acc executed concurrently
