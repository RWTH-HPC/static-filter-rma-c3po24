; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %9, i64 64, i32 58, ptr @3), !dbg !105
...
48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @5), !dbg !110
  %49 = load i32, ptr %6, align 4, !dbg !110
  %50 = icmp eq i32 %49, 1, !dbg !112
  br i1 %50, label %51, label %54, !dbg !113

51:                                               ; preds = %48
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @6), !dbg !114
  %52 = load ptr, ptr %9, align 8, !dbg !114
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !114
  call void @parcoach_rma_store(ptr %53, i64 32, i32 63, ptr @7), !dbg !116
  store i32 42, ptr %53, align 4, !dbg !116
  br label %54, !dbg !117

54:                                               ; preds = %51, %48
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @8), !dbg !118
  %55 = load ptr, ptr %8, align 8, !dbg !118
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %55, i32 66, ptr @9), !dbg !119
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @10), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @11), !dbg !121
  %58 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @12), !dbg !122
  %59 = load ptr, ptr %12, align 8, !dbg !122
  call void @parcoach_rma_load(ptr %59, i64 32, i32 71, ptr @13), !dbg !123
  %60 = load i32, ptr %59, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @14), !dbg !124
  %61 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @15), !dbg !125
  %62 = load ptr, ptr %9, align 8, !dbg !125
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %63, i64 32, i32 71, ptr @16), !dbg !125
  %64 = load i32, ptr %63, align 4, !dbg !125
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %58, i32 noundef %60, i32 noundef %61, i32 noundef %64), !dbg !126
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @17), !dbg !127
  %67 = call i32 @MPI_Finalize(), !dbg !128
  ret i32 0, !dbg !129
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1e554ced7090aebf04b88cb22e3d492c")
...
!105 = !DILocation(line: 58, column: 35, scope: !106)
!106 = distinct !DILexicalBlock(scope: !102, file: !2, line: 55, column: 18)
!107 = !DILocation(line: 58, column: 72, scope: !106)
