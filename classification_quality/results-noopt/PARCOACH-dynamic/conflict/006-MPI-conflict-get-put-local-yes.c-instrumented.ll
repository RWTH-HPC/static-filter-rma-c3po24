; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@19 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
@20 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %12, i64 64, i32 56, ptr @3), !dbg !105
  %44 = load ptr, ptr %12, align 8, !dbg !105
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @4), !dbg !107
  %45 = load ptr, ptr %8, align 8, !dbg !107
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %44, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @5), !dbg !108
  call void @parcoach_rma_load(ptr %12, i64 64, i32 58, ptr @6), !dbg !109
  %47 = load ptr, ptr %12, align 8, !dbg !109
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @7), !dbg !110
  %48 = load ptr, ptr %8, align 8, !dbg !110
  %49 = call i32 @parcoach_rma_MPI_Put(ptr %47, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %48, i32 58, ptr @8), !dbg !111
  br label %50, !dbg !112

50:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @9), !dbg !113
  %51 = load ptr, ptr %8, align 8, !dbg !113
  %52 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %51, i32 60, ptr @10), !dbg !114
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @11), !dbg !115
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @12), !dbg !116
  %54 = load i32, ptr %6, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @13), !dbg !117
  %55 = load ptr, ptr %12, align 8, !dbg !117
  call void @parcoach_rma_load(ptr %55, i64 32, i32 65, ptr @14), !dbg !118
  %56 = load i32, ptr %55, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @15), !dbg !119
  %57 = load i32, ptr %11, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @16), !dbg !120
  %58 = load ptr, ptr %9, align 8, !dbg !120
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %59, i64 32, i32 65, ptr @17), !dbg !120
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @18), !dbg !122
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/006-MPI-conflict-get-put-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "19bcbfe7b83d90ba1631f3bc1b02d57d")
...
!107 = !DILocation(line: 56, column: 48, scope: !106)
!108 = !DILocation(line: 56, column: 5, scope: !106)
!109 = !DILocation(line: 58, column: 13, scope: !106)
!110 = !DILocation(line: 58, column: 48, scope: !106)
!111 = !DILocation(line: 58, column: 5, scope: !106)
!112 = !DILocation(line: 59, column: 3, scope: !106)
!113 = !DILocation(line: 60, column: 20, scope: !35)
!114 = !DILocation(line: 60, column: 3, scope: !35)
!115 = !DILocation(line: 62, column: 3, scope: !35)
!116 = !DILocation(line: 65, column: 10, scope: !35)
!117 = !DILocation(line: 65, column: 17, scope: !35)
!118 = !DILocation(line: 65, column: 16, scope: !35)
!119 = !DILocation(line: 65, column: 22, scope: !35)
!120 = !DILocation(line: 65, column: 30, scope: !35)
!121 = !DILocation(line: 63, column: 3, scope: !35)
!122 = !DILocation(line: 67, column: 3, scope: !35)
!123 = !DILocation(line: 68, column: 3, scope: !35)
!124 = !DILocation(line: 70, column: 3, scope: !35)
