; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c'
...
43:                                               ; preds = %38
  ...
  %46 = call i32 @MPI_Get(ptr noundef %44, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %45), !dbg !113
...
50:                                               ; preds = %43, %38
  ...
  %52 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %51), !dbg !119
  %53 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !120
  ...
  %62 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !127
