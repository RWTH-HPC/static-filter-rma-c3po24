; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @MPI_Fetch_and_op(ptr noundef %11, ptr noundef %10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef @ompi_mpi_op_sum, ptr noundef %44), !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 58, ptr @4), !dbg !116
  %46 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %46, i64 32, i32 58, ptr @5), !dbg !117
  %47 = load i32, ptr %46, align 4, !dbg !117
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %47), !dbg !118
  br label %49, !dbg !119

49:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @6), !dbg !120
  %50 = load ptr, ptr %8, align 8, !dbg !120
  %51 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %50, i32 60, ptr @7), !dbg !121
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @8), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @9), !dbg !123
  %53 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @10), !dbg !124
  %54 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %54, i64 32, i32 65, ptr @11), !dbg !125
  %55 = load i32, ptr %54, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @12), !dbg !126
  %56 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @13), !dbg !127
  %57 = load ptr, ptr %9, align 8, !dbg !127
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %58, i64 32, i32 65, ptr @14), !dbg !127
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @15), !dbg !129
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/013-MPI-conflict-fop-load-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "b881f122259951abeffd86e62d2025fc")
...
!113 = !DILocation(line: 56, column: 63, scope: !114)
!114 = distinct !DILexicalBlock(scope: !110, file: !2, line: 54, column: 18)
!115 = !DILocation(line: 56, column: 5, scope: !114)
!116 = !DILocation(line: 58, column: 30, scope: !114)
!117 = !DILocation(line: 58, column: 29, scope: !114)
!118 = !DILocation(line: 58, column: 5, scope: !114)
!119 = !DILocation(line: 59, column: 3, scope: !114)
!120 = !DILocation(line: 60, column: 20, scope: !43)
!121 = !DILocation(line: 60, column: 3, scope: !43)
!122 = !DILocation(line: 62, column: 3, scope: !43)
!123 = !DILocation(line: 65, column: 10, scope: !43)
!124 = !DILocation(line: 65, column: 17, scope: !43)
!125 = !DILocation(line: 65, column: 16, scope: !43)
!126 = !DILocation(line: 65, column: 22, scope: !43)
!127 = !DILocation(line: 65, column: 30, scope: !43)
!128 = !DILocation(line: 63, column: 3, scope: !43)
!129 = !DILocation(line: 67, column: 3, scope: !43)
!130 = !DILocation(line: 68, column: 3, scope: !43)
!131 = !DILocation(line: 70, column: 3, scope: !43)
