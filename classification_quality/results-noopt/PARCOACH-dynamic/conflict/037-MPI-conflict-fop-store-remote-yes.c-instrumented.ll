; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @MPI_Fetch_and_op(ptr noundef %10, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef @ompi_mpi_op_sum, ptr noundef %44), !dbg !110
  br label %46, !dbg !111

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @4), !dbg !112
  %47 = load i32, ptr %6, align 4, !dbg !112
  %48 = icmp eq i32 %47, 1, !dbg !114
  br i1 %48, label %49, label %52, !dbg !115

49:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @5), !dbg !116
  %50 = load ptr, ptr %9, align 8, !dbg !116
  %51 = getelementptr inbounds i32, ptr %50, i64 0, !dbg !116
  call void @parcoach_rma_store(ptr %51, i64 32, i32 63, ptr @6), !dbg !118
  store i32 42, ptr %51, align 4, !dbg !118
  br label %52, !dbg !119

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @7), !dbg !120
  %53 = load ptr, ptr %8, align 8, !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 66, ptr @8), !dbg !121
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @9), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @10), !dbg !123
  %56 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @11), !dbg !124
  %57 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %57, i64 32, i32 71, ptr @12), !dbg !125
  %58 = load i32, ptr %57, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @13), !dbg !126
  %59 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @14), !dbg !127
  %60 = load ptr, ptr %9, align 8, !dbg !127
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %61, i64 32, i32 71, ptr @15), !dbg !127
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @16), !dbg !129
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "80eb5cc7356f022f89f24471b9468a77")
...
!108 = !DILocation(line: 58, column: 63, scope: !109)
