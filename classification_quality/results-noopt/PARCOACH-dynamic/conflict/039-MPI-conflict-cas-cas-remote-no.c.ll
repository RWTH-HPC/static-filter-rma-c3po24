; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c'
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %39), !dbg !100
...
56:                                               ; preds = %51, %48
  ...
  %58 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %57), !dbg !121
  %59 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !122
  ...
  %68 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !129
