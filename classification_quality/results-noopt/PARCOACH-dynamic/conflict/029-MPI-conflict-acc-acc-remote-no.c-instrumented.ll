; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@19 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
@20 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c\00", align 1
...
49:                                               ; preds = %46
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @7), !dbg !118
  %50 = load ptr, ptr %8, align 8, !dbg !118
  %51 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %50, i32 59, ptr @8), !dbg !119
  br label %52, !dbg !120

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @9), !dbg !121
  %53 = load ptr, ptr %8, align 8, !dbg !121
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 62, ptr @10), !dbg !122
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @11), !dbg !123
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @12), !dbg !124
  %56 = load i32, ptr %6, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %12, i64 64, i32 67, ptr @13), !dbg !125
  %57 = load ptr, ptr %12, align 8, !dbg !125
  call void @parcoach_rma_load(ptr %57, i64 32, i32 67, ptr @14), !dbg !126
  %58 = load i32, ptr %57, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %11, i64 32, i32 67, ptr @15), !dbg !127
  %59 = load i32, ptr %11, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @16), !dbg !128
  %60 = load ptr, ptr %9, align 8, !dbg !128
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !128
  call void @parcoach_rma_load(ptr %61, i64 32, i32 67, ptr @17), !dbg !128
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 69, ptr @18), !dbg !130
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/029-MPI-conflict-acc-acc-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "4150bc4bc4755a43bbea16bc15ea5109")
...
!118 = !DILocation(line: 59, column: 67, scope: !117)
