; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/019-MPI-conflict-get-put-remote-yes.c'
...
50:                                               ; preds = %47
  ...
  %53 = call i32 @MPI_Put(ptr noundef %51, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %52), !dbg !118
  br label %54, !dbg !119

54:                                               ; preds = %50, %47
  %55 = load ptr, ptr %8, align 8, !dbg !120
  %56 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %55), !dbg !121
  %57 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !122
  ...
  %66 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !129
