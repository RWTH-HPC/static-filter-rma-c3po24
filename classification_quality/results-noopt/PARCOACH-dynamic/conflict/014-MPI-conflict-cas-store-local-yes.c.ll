; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c'
...
49:                                               ; preds = %43, %38
  ...
  %51 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %50), !dbg !113
  %52 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !114
  ...
  %61 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !121
