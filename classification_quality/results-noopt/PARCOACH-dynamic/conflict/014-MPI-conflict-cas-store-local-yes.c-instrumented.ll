; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 49, ptr @17), !dbg !94
  %36 = load i32, ptr %15, align 4, !dbg !94
  %37 = add nsw i32 %36, 1, !dbg !94
  call void @parcoach_rma_store(ptr %15, i64 32, i32 49, ptr @18), !dbg !94
...
38:                                               ; preds = %27
  ...
  br i1 %42, label %43, label %49, !dbg !104

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %9, i64 64, i32 56, ptr @3), !dbg !105
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 58, ptr @5), !dbg !109
  %48 = load ptr, ptr %12, align 8, !dbg !109
  call void @parcoach_rma_store(ptr %48, i64 32, i32 58, ptr @6), !dbg !110
  store i32 42, ptr %48, align 4, !dbg !110
  br label %49, !dbg !111

49:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @7), !dbg !112
  %50 = load ptr, ptr %8, align 8, !dbg !112
  %51 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %50, i32 60, ptr @8), !dbg !113
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @9), !dbg !114
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @10), !dbg !115
  %53 = load i32, ptr %6, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 65, ptr @11), !dbg !116
  %54 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %54, i64 32, i32 65, ptr @12), !dbg !117
  %55 = load i32, ptr %54, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @13), !dbg !118
  %56 = load i32, ptr %11, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @14), !dbg !119
  %57 = load ptr, ptr %9, align 8, !dbg !119
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %58, i64 32, i32 65, ptr @15), !dbg !119
  %59 = load i32, ptr %58, align 4, !dbg !119
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %53, i32 noundef %55, i32 noundef %56, i32 noundef %59), !dbg !120
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 67, ptr @16), !dbg !121
  %62 = call i32 @MPI_Finalize(), !dbg !122
  ret i32 0, !dbg !123
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "cd16b0aa583fe7d9a11358ab868ef6d5")
...
!105 = !DILocation(line: 56, column: 35, scope: !106)
!106 = distinct !DILexicalBlock(scope: !102, file: !2, line: 54, column: 18)
!107 = !DILocation(line: 56, column: 72, scope: !106)
!108 = !DILocation(line: 56, column: 5, scope: !106)
!109 = !DILocation(line: 58, column: 6, scope: !106)
!110 = !DILocation(line: 58, column: 10, scope: !106)
!111 = !DILocation(line: 59, column: 3, scope: !106)
!112 = !DILocation(line: 60, column: 20, scope: !35)
!113 = !DILocation(line: 60, column: 3, scope: !35)
!114 = !DILocation(line: 62, column: 3, scope: !35)
!115 = !DILocation(line: 65, column: 10, scope: !35)
!116 = !DILocation(line: 65, column: 17, scope: !35)
!117 = !DILocation(line: 65, column: 16, scope: !35)
!118 = !DILocation(line: 65, column: 22, scope: !35)
!119 = !DILocation(line: 65, column: 30, scope: !35)
!120 = !DILocation(line: 63, column: 3, scope: !35)
!121 = !DILocation(line: 67, column: 3, scope: !35)
!122 = !DILocation(line: 68, column: 3, scope: !35)
!123 = !DILocation(line: 70, column: 3, scope: !35)
