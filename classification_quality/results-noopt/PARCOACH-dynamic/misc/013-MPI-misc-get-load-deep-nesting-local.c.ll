; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c'
...
define dso_local void @deeeeeeeeep(ptr noundef %0, ptr noundef %1) #0 !dbg !40 {
  ...
  %7 = call i32 @MPI_Get(ptr noundef %5, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %6), !dbg !55
  ret void, !dbg !56
}
...
25:                                               ; preds = %21, %2
  %26 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !171
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %39), !dbg !191
...
46:                                               ; preds = %43, %38
  ...
  %48 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %47), !dbg !202
  %49 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !203
  ...
  %58 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !210
