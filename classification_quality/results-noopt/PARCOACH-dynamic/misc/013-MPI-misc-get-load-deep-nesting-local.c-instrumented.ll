; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c\00", align 1
...
define dso_local void @deeeeeeeeep(ptr noundef %0, ptr noundef %1) #0 !dbg !40 {
  ...
  %7 = call i32 @parcoach_rma_MPI_Get(ptr %5, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %6, i32 29, ptr @0), !dbg !55
  ret void, !dbg !56
}
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 79, ptr @1), !dbg !171
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 81, ptr @16), !dbg !185
  %36 = load i32, ptr %15, align 4, !dbg !185
  %37 = add nsw i32 %36, 1, !dbg !185
  call void @parcoach_rma_store(ptr %15, i64 32, i32 81, ptr @17), !dbg !185
  store i32 %37, ptr %15, align 4, !dbg !185
  br label %27, !dbg !186, !llvm.loop !187

38:                                               ; preds = %27
  %39 = load ptr, ptr %8, align 8, !dbg !190
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 85, ptr @2), !dbg !191
  call void @parcoach_rma_load(ptr %6, i64 32, i32 87, ptr @3), !dbg !192
  %41 = load i32, ptr %6, align 4, !dbg !192
  %42 = icmp eq i32 %41, 0, !dbg !194
  br i1 %42, label %43, label %46, !dbg !195

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %12, i64 64, i32 88, ptr @4), !dbg !196
  %44 = load ptr, ptr %12, align 8, !dbg !196
  call void @parcoach_rma_load(ptr %8, i64 64, i32 88, ptr @5), !dbg !198
  %45 = load ptr, ptr %8, align 8, !dbg !198
  call void @rank0(ptr noundef %44, ptr noundef %45), !dbg !199
  br label %46, !dbg !200

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 90, ptr @6), !dbg !201
  %47 = load ptr, ptr %8, align 8, !dbg !201
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %47, i32 90, ptr @7), !dbg !202
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 92, ptr @8), !dbg !203
  call void @parcoach_rma_load(ptr %6, i64 32, i32 95, ptr @9), !dbg !204
  %50 = load i32, ptr %6, align 4, !dbg !204
  call void @parcoach_rma_load(ptr %12, i64 64, i32 95, ptr @10), !dbg !205
  %51 = load ptr, ptr %12, align 8, !dbg !205
  call void @parcoach_rma_load(ptr %51, i64 32, i32 95, ptr @11), !dbg !206
  %52 = load i32, ptr %51, align 4, !dbg !206
  call void @parcoach_rma_load(ptr %11, i64 32, i32 95, ptr @12), !dbg !207
  %53 = load i32, ptr %11, align 4, !dbg !207
  call void @parcoach_rma_load(ptr %9, i64 64, i32 95, ptr @13), !dbg !208
  %54 = load ptr, ptr %9, align 8, !dbg !208
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !208
  call void @parcoach_rma_load(ptr %55, i64 32, i32 95, ptr @14), !dbg !208
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 97, ptr @15), !dbg !210
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/misc/013-MPI-misc-get-load-deep-nesting-local.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "5274ca3828d2a43f98a599c711c3f83d")
...
!125 = !DILocation(line: 53, column: 8, scope: !120)
!126 = !DILocation(line: 53, column: 13, scope: !120)
!127 = !DILocation(line: 53, column: 3, scope: !120)
!128 = !DILocation(line: 55, column: 28, scope: !120)
!129 = !DILocation(line: 55, column: 27, scope: !120)
!130 = !DILocation(line: 55, column: 3, scope: !120)
!131 = !DILocation(line: 56, column: 1, scope: !120)
!132 = distinct !DISubprogram(name: "main", scope: !2, file: !2, line: 61, type: !133, scopeLine: 61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !17, retainedNodes: !48)
!133 = !DISubroutineType(types: !134)
!134 = !{!44, !44, !135}
!135 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !136, size: 64)
!136 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64)
!137 = !DILocalVariable(name: "argc", arg: 1, scope: !132, file: !2, line: 61, type: !44)
!138 = !DILocation(line: 61, column: 14, scope: !132)
!139 = !DILocalVariable(name: "argv", arg: 2, scope: !132, file: !2, line: 61, type: !135)
!140 = !DILocation(line: 61, column: 27, scope: !132)
!141 = !DILocalVariable(name: "rank", scope: !132, file: !2, line: 62, type: !44)
!142 = !DILocation(line: 62, column: 7, scope: !132)
!143 = !DILocalVariable(name: "size", scope: !132, file: !2, line: 62, type: !44)
!144 = !DILocation(line: 62, column: 13, scope: !132)
!145 = !DILocalVariable(name: "win", scope: !132, file: !2, line: 63, type: !45)
!146 = !DILocation(line: 63, column: 11, scope: !132)
!147 = !DILocalVariable(name: "win_base", scope: !132, file: !2, line: 64, type: !43)
!148 = !DILocation(line: 64, column: 8, scope: !132)
!149 = !DILocalVariable(name: "value", scope: !132, file: !2, line: 65, type: !44)
!150 = !DILocation(line: 65, column: 7, scope: !132)
!151 = !DILocalVariable(name: "value2", scope: !132, file: !2, line: 65, type: !44)
!152 = !DILocation(line: 65, column: 18, scope: !132)
!153 = !DILocalVariable(name: "buf", scope: !132, file: !2, line: 66, type: !43)
!154 = !DILocation(line: 66, column: 8, scope: !132)
!155 = !DILocalVariable(name: "result", scope: !132, file: !2, line: 67, type: !44)
!156 = !DILocation(line: 67, column: 7, scope: !132)
!157 = !DILocalVariable(name: "token", scope: !132, file: !2, line: 68, type: !44)
!158 = !DILocation(line: 68, column: 7, scope: !132)
!159 = !DILocation(line: 70, column: 3, scope: !132)
!160 = !DILocation(line: 71, column: 3, scope: !132)
!161 = !DILocation(line: 72, column: 3, scope: !132)
!162 = !DILocation(line: 74, column: 7, scope: !163)
!163 = distinct !DILexicalBlock(scope: !132, file: !2, line: 74, column: 7)
!164 = !DILocation(line: 74, column: 12, scope: !163)
!165 = !DILocation(line: 74, column: 7, scope: !132)
!166 = !DILocation(line: 75, column: 65, scope: !167)
!167 = distinct !DILexicalBlock(scope: !163, file: !2, line: 74, column: 25)
!168 = !DILocation(line: 75, column: 5, scope: !167)
!169 = !DILocation(line: 76, column: 5, scope: !167)
!170 = !DILocation(line: 77, column: 3, scope: !167)
!171 = !DILocation(line: 79, column: 3, scope: !132)
!172 = !DILocalVariable(name: "i", scope: !173, file: !2, line: 81, type: !44)
!173 = distinct !DILexicalBlock(scope: !132, file: !2, line: 81, column: 3)
!174 = !DILocation(line: 81, column: 12, scope: !173)
!175 = !DILocation(line: 81, column: 8, scope: !173)
!176 = !DILocation(line: 81, column: 19, scope: !177)
!177 = distinct !DILexicalBlock(scope: !173, file: !2, line: 81, column: 3)
!178 = !DILocation(line: 81, column: 21, scope: !177)
!179 = !DILocation(line: 81, column: 3, scope: !173)
!180 = !DILocation(line: 82, column: 5, scope: !181)
!181 = distinct !DILexicalBlock(scope: !177, file: !2, line: 81, column: 38)
!182 = !DILocation(line: 82, column: 14, scope: !181)
!183 = !DILocation(line: 82, column: 17, scope: !181)
!184 = !DILocation(line: 83, column: 3, scope: !181)
!185 = !DILocation(line: 81, column: 34, scope: !177)
!186 = !DILocation(line: 81, column: 3, scope: !177)
!187 = distinct !{!187, !179, !188, !189}
!188 = !DILocation(line: 83, column: 3, scope: !173)
!189 = !{!"llvm.loop.mustprogress"}
!190 = !DILocation(line: 85, column: 20, scope: !132)
!191 = !DILocation(line: 85, column: 3, scope: !132)
!192 = !DILocation(line: 87, column: 7, scope: !193)
!193 = distinct !DILexicalBlock(scope: !132, file: !2, line: 87, column: 7)
!194 = !DILocation(line: 87, column: 12, scope: !193)
!195 = !DILocation(line: 87, column: 7, scope: !132)
!196 = !DILocation(line: 88, column: 11, scope: !197)
!197 = distinct !DILexicalBlock(scope: !193, file: !2, line: 87, column: 18)
!198 = !DILocation(line: 88, column: 16, scope: !197)
!199 = !DILocation(line: 88, column: 5, scope: !197)
!200 = !DILocation(line: 89, column: 3, scope: !197)
!201 = !DILocation(line: 90, column: 20, scope: !132)
!202 = !DILocation(line: 90, column: 3, scope: !132)
!203 = !DILocation(line: 92, column: 3, scope: !132)
!204 = !DILocation(line: 95, column: 10, scope: !132)
!205 = !DILocation(line: 95, column: 17, scope: !132)
!206 = !DILocation(line: 95, column: 16, scope: !132)
!207 = !DILocation(line: 95, column: 22, scope: !132)
!208 = !DILocation(line: 95, column: 30, scope: !132)
!209 = !DILocation(line: 93, column: 3, scope: !132)
!210 = !DILocation(line: 97, column: 3, scope: !132)
!211 = !DILocation(line: 98, column: 3, scope: !132)
!212 = !DILocation(line: 100, column: 3, scope: !132)
