; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
@18 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c\00", align 1
...
define dso_local void @deeeeeeeeep(ptr noundef %0, ptr noundef %1) #0 !dbg !35 {
  ...
  %7 = call i32 @parcoach_rma_MPI_Put(ptr %5, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %6, i32 25, ptr @0), !dbg !50
  ret void, !dbg !51
}
...
define dso_local void @rank0(ptr noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  %9 = call i32 @parcoach_rma_MPI_Put(ptr %7, i32 1, ptr @ompi_mpi_int, i32 1, i64 1, i32 1, ptr @ompi_mpi_int, ptr %8, i32 50, ptr @1), !dbg !125
  ret void, !dbg !126
}
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 74, ptr @2), !dbg !166
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 76, ptr @17), !dbg !180
  %36 = load i32, ptr %15, align 4, !dbg !180
  %37 = add nsw i32 %36, 1, !dbg !180
  call void @parcoach_rma_store(ptr %15, i64 32, i32 76, ptr @18), !dbg !180
  store i32 %37, ptr %15, align 4, !dbg !180
  br label %27, !dbg !181, !llvm.loop !182

38:                                               ; preds = %27
  %39 = load ptr, ptr %8, align 8, !dbg !185
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 80, ptr @3), !dbg !186
  call void @parcoach_rma_load(ptr %6, i64 32, i32 82, ptr @4), !dbg !187
  %41 = load i32, ptr %6, align 4, !dbg !187
  %42 = icmp eq i32 %41, 0, !dbg !189
  br i1 %42, label %43, label %46, !dbg !190

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %12, i64 64, i32 83, ptr @5), !dbg !191
  %44 = load ptr, ptr %12, align 8, !dbg !191
  call void @parcoach_rma_load(ptr %8, i64 64, i32 83, ptr @6), !dbg !193
  %45 = load ptr, ptr %8, align 8, !dbg !193
  call void @rank0(ptr noundef %44, ptr noundef %45), !dbg !194
  br label %46, !dbg !195

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 85, ptr @7), !dbg !196
  %47 = load ptr, ptr %8, align 8, !dbg !196
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %47, i32 85, ptr @8), !dbg !197
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 87, ptr @9), !dbg !198
  call void @parcoach_rma_load(ptr %6, i64 32, i32 90, ptr @10), !dbg !199
  %50 = load i32, ptr %6, align 4, !dbg !199
  call void @parcoach_rma_load(ptr %12, i64 64, i32 90, ptr @11), !dbg !200
  %51 = load ptr, ptr %12, align 8, !dbg !200
  call void @parcoach_rma_load(ptr %51, i64 32, i32 90, ptr @12), !dbg !201
  %52 = load i32, ptr %51, align 4, !dbg !201
  call void @parcoach_rma_load(ptr %11, i64 32, i32 90, ptr @13), !dbg !202
  %53 = load i32, ptr %11, align 4, !dbg !202
  call void @parcoach_rma_load(ptr %9, i64 64, i32 90, ptr @14), !dbg !203
  %54 = load ptr, ptr %9, align 8, !dbg !203
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !203
  call void @parcoach_rma_load(ptr %55, i64 32, i32 90, ptr @15), !dbg !203
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 92, ptr @16), !dbg !205
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/misc/009-MPI-misc-put-put-deep-nesting-local.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "6348caac5575ab290f0bd3faa5b6e37c")
