; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c"
...
@0 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_store(ptr %10, i64 32, i32 54, ptr @3), !dbg !105
  store i32 0, ptr %10, align 4, !dbg !105
  call void @parcoach_rma_load(ptr %8, i64 64, i32 55, ptr @4), !dbg !107
  %44 = load ptr, ptr %8, align 8, !dbg !107
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 55, ptr @5), !dbg !108
  br label %46, !dbg !109

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @6), !dbg !110
  %47 = load ptr, ptr %8, align 8, !dbg !110
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %47, i32 57, ptr @7), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @8), !dbg !112
  %49 = load i32, ptr %6, align 4, !dbg !112
  %50 = icmp eq i32 %49, 2, !dbg !114
  br i1 %50, label %51, label %54, !dbg !115

51:                                               ; preds = %46
  store i32 2, ptr %10, align 4, !dbg !116
  %52 = load ptr, ptr %8, align 8, !dbg !118
  %53 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %52, i32 61, ptr @9), !dbg !119
  br label %54, !dbg !120

54:                                               ; preds = %51, %46
  %55 = load ptr, ptr %8, align 8, !dbg !121
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %55, i32 64, ptr @10), !dbg !122
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @11), !dbg !123
  %58 = load i32, ptr %6, align 4, !dbg !124
  %59 = load ptr, ptr %12, align 8, !dbg !125
  %60 = load i32, ptr %59, align 4, !dbg !126
  %61 = load i32, ptr %11, align 4, !dbg !127
  %62 = load ptr, ptr %9, align 8, !dbg !128
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !128
  %64 = load i32, ptr %63, align 4, !dbg !128
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %58, i32 noundef %60, i32 noundef %61, i32 noundef %64), !dbg !129
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 71, ptr @12), !dbg !130
  %67 = call i32 @MPI_Finalize(), !dbg !131
  ret i32 0, !dbg !132
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "beb52c3addbfc3b615025f165e4b2130")
...
!105 = !DILocation(line: 54, column: 11, scope: !106)
!106 = distinct !DILexicalBlock(scope: !102, file: !2, line: 53, column: 18)
!107 = !DILocation(line: 55, column: 51, scope: !106)
!108 = !DILocation(line: 55, column: 5, scope: !106)
!109 = !DILocation(line: 56, column: 3, scope: !106)
!110 = !DILocation(line: 57, column: 20, scope: !35)
!111 = !DILocation(line: 57, column: 3, scope: !35)
!112 = !DILocation(line: 59, column: 7, scope: !113)
!113 = distinct !DILexicalBlock(scope: !35, file: !2, line: 59, column: 7)
!114 = !DILocation(line: 59, column: 12, scope: !113)
!115 = !DILocation(line: 59, column: 7, scope: !35)
!116 = !DILocation(line: 60, column: 11, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 59, column: 18)
!118 = !DILocation(line: 61, column: 51, scope: !117)
!119 = !DILocation(line: 61, column: 5, scope: !117)
!120 = !DILocation(line: 62, column: 3, scope: !117)
!121 = !DILocation(line: 64, column: 20, scope: !35)
!122 = !DILocation(line: 64, column: 3, scope: !35)
!123 = !DILocation(line: 66, column: 3, scope: !35)
!124 = !DILocation(line: 69, column: 10, scope: !35)
!125 = !DILocation(line: 69, column: 17, scope: !35)
!126 = !DILocation(line: 69, column: 16, scope: !35)
!127 = !DILocation(line: 69, column: 22, scope: !35)
!128 = !DILocation(line: 69, column: 30, scope: !35)
!129 = !DILocation(line: 67, column: 3, scope: !35)
!130 = !DILocation(line: 71, column: 3, scope: !35)
!131 = !DILocation(line: 72, column: 3, scope: !35)
!132 = !DILocation(line: 74, column: 3, scope: !35)
