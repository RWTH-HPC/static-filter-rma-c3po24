; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
...
27:                                               ; preds = %23, %2
  %28 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 48, ptr @0), !dbg !80
...
40:                                               ; preds = %29
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 54, ptr @1), !dbg !99
...
44:                                               ; preds = %40
  ...
  %46 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %45, i32 57, ptr @2), !dbg !106
  call void @llvm.dbg.declare(metadata ptr %16, metadata !107, metadata !DIExpression()), !dbg !108
  call void @parcoach_rma_store(ptr %16, i64 32, i32 59, ptr @3), !dbg !108
  store i32 1, ptr %16, align 4, !dbg !108
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @4), !dbg !109
  %47 = load ptr, ptr %8, align 8, !dbg !109
  %48 = call i32 @parcoach_rma_MPI_Put(ptr %16, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %47, i32 61, ptr @5), !dbg !110
  %49 = load ptr, ptr %8, align 8, !dbg !111
  %50 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %49, i32 62, ptr @6), !dbg !112
  br label %65, !dbg !113

51:                                               ; preds = %40
  call void @llvm.dbg.declare(metadata ptr %17, metadata !114, metadata !DIExpression()), !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @7), !dbg !119
  %52 = load ptr, ptr %9, align 8, !dbg !119
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !119
  call void @parcoach_rma_store(ptr %17, i64 64, i32 65, ptr @8), !dbg !118
  store ptr %53, ptr %17, align 8, !dbg !118
  br label %54, !dbg !120

54:                                               ; preds = %58, %51
  call void @parcoach_rma_load(ptr %17, i64 64, i32 67, ptr @9), !dbg !121
  %55 = load ptr, ptr %17, align 8, !dbg !121
  call void @parcoach_rma_load(ptr %55, i64 32, i32 67, ptr @10), !dbg !122
...
58:                                               ; preds = %54
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @11), !dbg !126
  %60 = load ptr, ptr %8, align 8, !dbg !126
  %61 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %60, i32 70, ptr @12), !dbg !127
  call void @parcoach_rma_load(ptr %8, i64 64, i32 71, ptr @13), !dbg !128
  %62 = load ptr, ptr %8, align 8, !dbg !128
  %63 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %62, i32 71, ptr @14), !dbg !129
...
65:                                               ; preds = %64, %44
  %66 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 75, ptr @15), !dbg !132
  %67 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 77, ptr @16), !dbg !133
  ...
  %76 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 82, ptr @17), !dbg !140
