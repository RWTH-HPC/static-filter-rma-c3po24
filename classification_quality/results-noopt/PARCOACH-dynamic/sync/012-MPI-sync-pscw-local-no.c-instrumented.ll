; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c"
...
@0 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c\00", align 1
@1 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c\00", align 1
@2 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c\00", align 1
@3 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c\00", align 1
@4 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c\00", align 1
...
30:                                               ; preds = %26, %2
  %31 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 45, ptr @0), !dbg !85
...
43:                                               ; preds = %32
  ...
  %45 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 54, ptr @1), !dbg !110
...
48:                                               ; preds = %43
  ...
  %55 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %54, i32 62, ptr @2), !dbg !127
...
68:                                               ; preds = %60, %48
  %69 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @3), !dbg !145
  ...
  %78 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 78, ptr @4), !dbg !152
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/012-MPI-sync-pscw-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "01f0148224b87b2dec05b349f27cd8ba")
