...
/*
{
    ...
    "DESCRIPTION": "Two conflicting operations get and get issued from the same
origin where consistency between them is ensured with MPI_Win_flush_local and
synchronization is due to program order."
}
*/
// RACE LABELS END
