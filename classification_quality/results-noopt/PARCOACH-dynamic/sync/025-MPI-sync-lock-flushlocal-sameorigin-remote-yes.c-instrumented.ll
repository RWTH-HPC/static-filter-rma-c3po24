; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c"
...
@0 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 56, ptr @2), !dbg !107
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !108
  %45 = load ptr, ptr %8, align 8, !dbg !108
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @4), !dbg !109
  %47 = load ptr, ptr %8, align 8, !dbg !110
  %48 = call i32 @MPI_Win_flush_local(i32 noundef 1, ptr noundef %47), !dbg !111
  %49 = load ptr, ptr %8, align 8, !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %49, i32 61, ptr @5), !dbg !113
  %51 = load ptr, ptr %8, align 8, !dbg !114
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %51, i32 62, ptr @6), !dbg !115
  br label %53, !dbg !116

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @7), !dbg !117
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @8), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 70, ptr @9), !dbg !119
  %56 = load i32, ptr %6, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %12, i64 64, i32 70, ptr @10), !dbg !120
  %57 = load ptr, ptr %12, align 8, !dbg !120
  call void @parcoach_rma_load(ptr %57, i64 32, i32 70, ptr @11), !dbg !121
  %58 = load i32, ptr %57, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 70, ptr @12), !dbg !122
  %59 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @13), !dbg !123
  %60 = load ptr, ptr %9, align 8, !dbg !123
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %61, i64 32, i32 70, ptr @14), !dbg !123
  %62 = load i32, ptr %61, align 4, !dbg !123
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56, i32 noundef %58, i32 noundef %59, i32 noundef %62), !dbg !124
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 72, ptr @15), !dbg !125
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1659f0b974ff48d84cbe80664668ce9e")
...
!104 = !DILocation(line: 55, column: 11, scope: !105)
!105 = distinct !DILexicalBlock(scope: !101, file: !2, line: 54, column: 18)
!106 = !DILocation(line: 56, column: 41, scope: !105)
!107 = !DILocation(line: 56, column: 5, scope: !105)
!108 = !DILocation(line: 58, column: 51, scope: !105)
!109 = !DILocation(line: 58, column: 5, scope: !105)
!110 = !DILocation(line: 59, column: 28, scope: !105)
!111 = !DILocation(line: 59, column: 5, scope: !105)
!112 = !DILocation(line: 61, column: 51, scope: !105)
!113 = !DILocation(line: 61, column: 5, scope: !105)
!114 = !DILocation(line: 62, column: 23, scope: !105)
!115 = !DILocation(line: 62, column: 5, scope: !105)
!116 = !DILocation(line: 63, column: 3, scope: !105)
!117 = !DILocation(line: 65, column: 3, scope: !35)
!118 = !DILocation(line: 67, column: 3, scope: !35)
!119 = !DILocation(line: 70, column: 10, scope: !35)
!120 = !DILocation(line: 70, column: 17, scope: !35)
!121 = !DILocation(line: 70, column: 16, scope: !35)
!122 = !DILocation(line: 70, column: 22, scope: !35)
!123 = !DILocation(line: 70, column: 30, scope: !35)
!124 = !DILocation(line: 68, column: 3, scope: !35)
!125 = !DILocation(line: 72, column: 3, scope: !35)
!126 = !DILocation(line: 73, column: 3, scope: !35)
!127 = !DILocation(line: 75, column: 3, scope: !35)
