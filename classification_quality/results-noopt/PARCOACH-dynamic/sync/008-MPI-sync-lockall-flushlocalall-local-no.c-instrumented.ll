; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c"
...
@0 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@15 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@16 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@17 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@18 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@19 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
...
44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @4), !dbg !111
  %45 = load ptr, ptr %8, align 8, !dbg !111
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @5), !dbg !113
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @6), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @MPI_Win_flush_local_all(ptr noundef %47), !dbg !115
  call void @parcoach_rma_load(ptr %10, i64 32, i32 58, ptr @7), !dbg !116
  %49 = load i32, ptr %10, align 4, !dbg !116
  %50 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %49), !dbg !117
  br label %51, !dbg !118

51:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @8), !dbg !119
  %52 = load ptr, ptr %8, align 8, !dbg !119
  %53 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %52, i32 61, ptr @9), !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @10), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 66, ptr @11), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %12, i64 64, i32 66, ptr @12), !dbg !123
  %56 = load ptr, ptr %12, align 8, !dbg !123
  call void @parcoach_rma_load(ptr %56, i64 32, i32 66, ptr @13), !dbg !124
  %57 = load i32, ptr %56, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 66, ptr @14), !dbg !125
  %58 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @15), !dbg !126
  %59 = load ptr, ptr %9, align 8, !dbg !126
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %60, i64 32, i32 66, ptr @16), !dbg !126
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 68, ptr @17), !dbg !128
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "8cd48230318dbbb6a6aa5926a2257013")
...
!111 = !DILocation(line: 56, column: 51, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 55, column: 18)
!113 = !DILocation(line: 56, column: 5, scope: !112)
!114 = !DILocation(line: 57, column: 29, scope: !112)
!115 = !DILocation(line: 57, column: 5, scope: !112)
!116 = !DILocation(line: 58, column: 29, scope: !112)
!117 = !DILocation(line: 58, column: 5, scope: !112)
!118 = !DILocation(line: 59, column: 3, scope: !112)
!119 = !DILocation(line: 61, column: 22, scope: !40)
!120 = !DILocation(line: 61, column: 3, scope: !40)
!121 = !DILocation(line: 63, column: 3, scope: !40)
!122 = !DILocation(line: 66, column: 10, scope: !40)
!123 = !DILocation(line: 66, column: 17, scope: !40)
!124 = !DILocation(line: 66, column: 16, scope: !40)
!125 = !DILocation(line: 66, column: 22, scope: !40)
!126 = !DILocation(line: 66, column: 30, scope: !40)
!127 = !DILocation(line: 64, column: 3, scope: !40)
