; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c"
...
@0 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 59, ptr @5), !dbg !116
  br label %49, !dbg !117

49:                                               ; preds = %42, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 62, ptr @6), !dbg !118
  %50 = load i32, ptr %6, align 4, !dbg !118
  %51 = icmp eq i32 %50, 1, !dbg !120
  br i1 %51, label %52, label %57, !dbg !121

52:                                               ; preds = %49
  call void @parcoach_rma_load(ptr %9, i64 64, i32 64, ptr @7), !dbg !122
  %53 = load ptr, ptr %9, align 8, !dbg !122
  %54 = getelementptr inbounds i32, ptr %53, i64 0, !dbg !122
  call void @parcoach_rma_load(ptr %54, i64 32, i32 64, ptr @8), !dbg !122
  %55 = load i32, ptr %54, align 4, !dbg !122
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %55), !dbg !124
  br label %57, !dbg !125

57:                                               ; preds = %52, %49
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @9), !dbg !126
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @10), !dbg !127
  call void @parcoach_rma_load(ptr %6, i64 32, i32 72, ptr @11), !dbg !128
  %60 = load i32, ptr %6, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %12, i64 64, i32 72, ptr @12), !dbg !129
  %61 = load ptr, ptr %12, align 8, !dbg !129
  call void @parcoach_rma_load(ptr %61, i64 32, i32 72, ptr @13), !dbg !130
  %62 = load i32, ptr %61, align 4, !dbg !130
  call void @parcoach_rma_load(ptr %11, i64 32, i32 72, ptr @14), !dbg !131
  %63 = load i32, ptr %11, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @15), !dbg !132
  %64 = load ptr, ptr %9, align 8, !dbg !132
  %65 = getelementptr inbounds i32, ptr %64, i64 0, !dbg !132
  call void @parcoach_rma_load(ptr %65, i64 32, i32 72, ptr @16), !dbg !132
  ...
  %68 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @17), !dbg !134
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d85b1c0986b977c21116961461dce018")
...
!115 = !DILocation(line: 59, column: 23, scope: !110)
!116 = !DILocation(line: 59, column: 5, scope: !110)
!117 = !DILocation(line: 60, column: 3, scope: !110)
!118 = !DILocation(line: 62, column: 7, scope: !119)
!119 = distinct !DILexicalBlock(scope: !40, file: !2, line: 62, column: 7)
!120 = !DILocation(line: 62, column: 12, scope: !119)
!121 = !DILocation(line: 62, column: 7, scope: !40)
!122 = !DILocation(line: 64, column: 35, scope: !123)
!123 = distinct !DILexicalBlock(scope: !119, file: !2, line: 62, column: 18)
!124 = !DILocation(line: 64, column: 5, scope: !123)
!125 = !DILocation(line: 65, column: 3, scope: !123)
