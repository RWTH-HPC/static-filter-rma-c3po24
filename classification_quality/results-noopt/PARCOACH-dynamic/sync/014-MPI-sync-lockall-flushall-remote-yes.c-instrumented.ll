; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %39, i32 52, ptr @1), !dbg !105
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 53, ptr @2), !dbg !106
  %42 = load i32, ptr %6, align 4, !dbg !107
  %43 = icmp eq i32 %42, 0, !dbg !109
  br i1 %43, label %44, label %49, !dbg !110

44:                                               ; preds = %38
  store i32 1, ptr %10, align 4, !dbg !111
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @3), !dbg !114
...
57:                                               ; preds = %52, %49
  %58 = load ptr, ptr %8, align 8, !dbg !126
  %59 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %58, i32 67, ptr @4), !dbg !127
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @5), !dbg !128
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @6), !dbg !129
  %62 = load i32, ptr %6, align 4, !dbg !130
  %63 = load ptr, ptr %12, align 8, !dbg !131
  %64 = load i32, ptr %63, align 4, !dbg !132
  %65 = load i32, ptr %11, align 4, !dbg !133
  %66 = load ptr, ptr %9, align 8, !dbg !134
  %67 = getelementptr inbounds i32, ptr %66, i64 0, !dbg !134
  %68 = load i32, ptr %67, align 4, !dbg !134
  %69 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %62, i32 noundef %64, i32 noundef %65, i32 noundef %68), !dbg !135
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 75, ptr @7), !dbg !136
  %71 = call i32 @MPI_Finalize(), !dbg !137
  ret i32 0, !dbg !138
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "bf981cebd42dfb5dd311d02e7ed18280")
...
!104 = !DILocation(line: 52, column: 23, scope: !40)
!105 = !DILocation(line: 52, column: 3, scope: !40)
...
!117 = !DILocation(line: 60, column: 3, scope: !112)
...
!126 = !DILocation(line: 67, column: 22, scope: !40)
!127 = !DILocation(line: 67, column: 3, scope: !40)
!128 = !DILocation(line: 68, column: 3, scope: !40)
!129 = !DILocation(line: 70, column: 3, scope: !40)
!130 = !DILocation(line: 73, column: 10, scope: !40)
!131 = !DILocation(line: 73, column: 17, scope: !40)
!132 = !DILocation(line: 73, column: 16, scope: !40)
!133 = !DILocation(line: 73, column: 22, scope: !40)
!134 = !DILocation(line: 73, column: 30, scope: !40)
!135 = !DILocation(line: 71, column: 3, scope: !40)
!136 = !DILocation(line: 75, column: 3, scope: !40)
!137 = !DILocation(line: 76, column: 3, scope: !40)
!138 = !DILocation(line: 78, column: 3, scope: !40)
