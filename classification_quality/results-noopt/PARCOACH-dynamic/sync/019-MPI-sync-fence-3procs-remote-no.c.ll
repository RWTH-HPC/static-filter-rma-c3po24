; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c'
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %44), !dbg !108
  br label %46, !dbg !109

46:                                               ; preds = %43, %38
  %47 = load ptr, ptr %8, align 8, !dbg !110
  %48 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %47), !dbg !111
...
51:                                               ; preds = %46
  ...
  %53 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %52), !dbg !119
  br label %54, !dbg !120

54:                                               ; preds = %51, %46
  %55 = load ptr, ptr %8, align 8, !dbg !121
  %56 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %55), !dbg !122
  %57 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !123
  ...
  %66 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !130
