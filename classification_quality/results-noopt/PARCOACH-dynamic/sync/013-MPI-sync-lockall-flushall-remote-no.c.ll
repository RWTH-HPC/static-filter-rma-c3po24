; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c'
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %39), !dbg !105
  %41 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !106
...
44:                                               ; preds = %38
  ...
  %49 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !117
  br label %50, !dbg !118
...
53:                                               ; preds = %50
  %54 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !123
...
59:                                               ; preds = %53, %50
  ...
  %61 = call i32 @MPI_Win_unlock_all(ptr noundef %60), !dbg !129
  %62 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !130
  %63 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !131
  ...
  %72 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !138
