; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c"
...
@0 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@2 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@3 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@4 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@5 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@6 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@7 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@8 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@9 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@10 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@11 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@12 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@13 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@14 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@15 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @14), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @15), !dbg !99
...
42:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @3), !dbg !112
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 57, ptr @4), !dbg !113
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %49, i32 60, ptr @5), !dbg !117
  br label %51, !dbg !118

51:                                               ; preds = %42, %38
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @6), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 66, ptr @7), !dbg !120
  %53 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %12, i64 64, i32 66, ptr @8), !dbg !121
  %54 = load ptr, ptr %12, align 8, !dbg !121
  call void @parcoach_rma_load(ptr %54, i64 32, i32 66, ptr @9), !dbg !122
  %55 = load i32, ptr %54, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 66, ptr @10), !dbg !123
  %56 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @11), !dbg !124
  %57 = load ptr, ptr %9, align 8, !dbg !124
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %58, i64 32, i32 66, ptr @12), !dbg !124
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 68, ptr @13), !dbg !126
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d0c7bd7a37e954b849eadf452389aaee")
...
!112 = !DILocation(line: 57, column: 51, scope: !110)
!113 = !DILocation(line: 57, column: 5, scope: !110)
!114 = !DILocation(line: 59, column: 29, scope: !110)
!115 = !DILocation(line: 59, column: 5, scope: !110)
!116 = !DILocation(line: 60, column: 23, scope: !110)
!117 = !DILocation(line: 60, column: 5, scope: !110)
!118 = !DILocation(line: 61, column: 3, scope: !110)
!119 = !DILocation(line: 63, column: 3, scope: !40)
!120 = !DILocation(line: 66, column: 10, scope: !40)
!121 = !DILocation(line: 66, column: 17, scope: !40)
!122 = !DILocation(line: 66, column: 16, scope: !40)
!123 = !DILocation(line: 66, column: 22, scope: !40)
!124 = !DILocation(line: 66, column: 30, scope: !40)
!125 = !DILocation(line: 64, column: 3, scope: !40)
!126 = !DILocation(line: 68, column: 3, scope: !40)
!127 = !DILocation(line: 69, column: 3, scope: !40)
!128 = !DILocation(line: 71, column: 3, scope: !40)
