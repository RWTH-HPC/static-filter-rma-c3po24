; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c'
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %40), !dbg !106
...
55:                                               ; preds = %50, %47
  ...
  %57 = call i32 @MPI_Win_unlock_all(ptr noundef %56), !dbg !125
  %58 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !126
  %59 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !127
  ...
  %68 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !134
