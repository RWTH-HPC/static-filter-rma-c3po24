; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/029-MPI-sync-lock-exclusive-remote-yes.c'
...
27:                                               ; preds = %23, %2
  ...
  %29 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %16, ptr noundef %15), !dbg !90
...
45:                                               ; preds = %30
  %46 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !112
...
49:                                               ; preds = %45
  ...
  %51 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %50), !dbg !119
  %52 = load ptr, ptr %8, align 8, !dbg !120
  %53 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %52), !dbg !121
  %54 = load ptr, ptr %8, align 8, !dbg !122
  %55 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %54), !dbg !123
  %56 = call i32 (i32, ...) @sleep(i32 noundef 1), !dbg !124
  %57 = load ptr, ptr %15, align 8, !dbg !125
  %58 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %57), !dbg !126
  %59 = load ptr, ptr %15, align 8, !dbg !127
  %60 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %59), !dbg !128
  br label %70, !dbg !129

61:                                               ; preds = %45
  %62 = load ptr, ptr %15, align 8, !dbg !130
  %63 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %62), !dbg !132
  %64 = load ptr, ptr %15, align 8, !dbg !133
  %65 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %64), !dbg !134
...
70:                                               ; preds = %61, %49
  %71 = call i32 @MPI_Win_free(ptr noundef %15), !dbg !137
  %72 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !138
  ...
  %81 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !145
