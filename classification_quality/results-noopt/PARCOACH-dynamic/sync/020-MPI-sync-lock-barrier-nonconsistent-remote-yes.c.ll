; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c'
...
47:                                               ; preds = %42, %38
  %48 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !116
...
59:                                               ; preds = %56
  ...
  %61 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %60), !dbg !131
  br label %62, !dbg !132

62:                                               ; preds = %59, %56
  %63 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !133
  %64 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !134
  ...
  %73 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !141
