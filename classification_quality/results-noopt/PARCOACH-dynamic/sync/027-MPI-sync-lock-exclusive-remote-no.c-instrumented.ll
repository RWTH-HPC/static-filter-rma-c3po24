; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c"
...
@0 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@1 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@2 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@3 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@4 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@5 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@6 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@7 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@8 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@9 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@10 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@11 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@12 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@13 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@14 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@15 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
...
42:                                               ; preds = %38
  %43 = load ptr, ptr %8, align 8, !dbg !109
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %43, i32 54, ptr @2), !dbg !111
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @3), !dbg !112
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @4), !dbg !113
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 57, ptr @5), !dbg !115
  br label %49, !dbg !116

49:                                               ; preds = %42, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 60, ptr @6), !dbg !117
  %50 = load i32, ptr %6, align 4, !dbg !117
  %51 = icmp eq i32 %50, 1, !dbg !119
  br i1 %51, label %52, label %61, !dbg !120

52:                                               ; preds = %49
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @7), !dbg !121
  %53 = load ptr, ptr %8, align 8, !dbg !121
  %54 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %53, i32 61, ptr @8), !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @9), !dbg !124
  %55 = load ptr, ptr %9, align 8, !dbg !124
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %56, i64 32, i32 63, ptr @10), !dbg !124
  %57 = load i32, ptr %56, align 4, !dbg !124
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %57), !dbg !125
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @11), !dbg !126
  %59 = load ptr, ptr %8, align 8, !dbg !126
  %60 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %59, i32 64, ptr @12), !dbg !127
  br label %61, !dbg !128

61:                                               ; preds = %52, %49
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @13), !dbg !129
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @14), !dbg !130
  %64 = load i32, ptr %6, align 4, !dbg !131
  %65 = load ptr, ptr %12, align 8, !dbg !132
  %66 = load i32, ptr %65, align 4, !dbg !133
  %67 = load i32, ptr %11, align 4, !dbg !134
  %68 = load ptr, ptr %9, align 8, !dbg !135
  %69 = getelementptr inbounds i32, ptr %68, i64 0, !dbg !135
  %70 = load i32, ptr %69, align 4, !dbg !135
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %64, i32 noundef %66, i32 noundef %67, i32 noundef %70), !dbg !136
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @15), !dbg !137
  %73 = call i32 @MPI_Finalize(), !dbg !138
  ret i32 0, !dbg !139
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d93c0c8d1a6dba9c227e81110c19a3cc")
...
!109 = !DILocation(line: 54, column: 44, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 53, column: 18)
!111 = !DILocation(line: 54, column: 5, scope: !110)
!112 = !DILocation(line: 56, column: 51, scope: !110)
!113 = !DILocation(line: 56, column: 5, scope: !110)
!114 = !DILocation(line: 57, column: 23, scope: !110)
!115 = !DILocation(line: 57, column: 5, scope: !110)
!116 = !DILocation(line: 58, column: 3, scope: !110)
!117 = !DILocation(line: 60, column: 7, scope: !118)
!118 = distinct !DILexicalBlock(scope: !40, file: !2, line: 60, column: 7)
!119 = !DILocation(line: 60, column: 12, scope: !118)
!120 = !DILocation(line: 60, column: 7, scope: !40)
!121 = !DILocation(line: 61, column: 44, scope: !122)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 60, column: 18)
!123 = !DILocation(line: 61, column: 5, scope: !122)
!124 = !DILocation(line: 63, column: 35, scope: !122)
!125 = !DILocation(line: 63, column: 5, scope: !122)
!126 = !DILocation(line: 64, column: 23, scope: !122)
!127 = !DILocation(line: 64, column: 5, scope: !122)
!128 = !DILocation(line: 65, column: 3, scope: !122)
!129 = !DILocation(line: 67, column: 3, scope: !40)
!130 = !DILocation(line: 69, column: 3, scope: !40)
!131 = !DILocation(line: 72, column: 10, scope: !40)
!132 = !DILocation(line: 72, column: 17, scope: !40)
!133 = !DILocation(line: 72, column: 16, scope: !40)
!134 = !DILocation(line: 72, column: 22, scope: !40)
!135 = !DILocation(line: 72, column: 30, scope: !40)
!136 = !DILocation(line: 70, column: 3, scope: !40)
!137 = !DILocation(line: 74, column: 3, scope: !40)
!138 = !DILocation(line: 75, column: 3, scope: !40)
!139 = !DILocation(line: 77, column: 3, scope: !40)
