; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@11 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@12 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@13 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@14 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@15 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@16 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@17 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@18 = private unnamed_addr constant [95 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @17), !dbg !94
  %36 = load i32, ptr %15, align 4, !dbg !94
  %37 = add nsw i32 %36, 1, !dbg !94
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @18), !dbg !94
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %47, i32 58, ptr @5), !dbg !111
  %49 = load ptr, ptr %8, align 8, !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Get(ptr %11, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %49, i32 59, ptr @6), !dbg !113
  %51 = load ptr, ptr %8, align 8, !dbg !114
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %51, i32 60, ptr @7), !dbg !115
  br label %53, !dbg !116

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @8), !dbg !117
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @9), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @10), !dbg !119
  %56 = load i32, ptr %6, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %12, i64 64, i32 68, ptr @11), !dbg !120
  %57 = load ptr, ptr %12, align 8, !dbg !120
  call void @parcoach_rma_load(ptr %57, i64 32, i32 68, ptr @12), !dbg !121
  %58 = load i32, ptr %57, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 68, ptr @13), !dbg !122
  %59 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 68, ptr @14), !dbg !123
  %60 = load ptr, ptr %9, align 8, !dbg !123
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %61, i64 32, i32 68, ptr @15), !dbg !123
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 70, ptr @16), !dbg !125
...
declare i32 @parcoach_rma_MPI_Win_flush(i32, ptr, i32, ptr)
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "e3d3552825e78589ebd66a53384b8b46")
...
!110 = !DILocation(line: 58, column: 22, scope: !105)
!111 = !DILocation(line: 58, column: 5, scope: !105)
!112 = !DILocation(line: 59, column: 52, scope: !105)
!113 = !DILocation(line: 59, column: 5, scope: !105)
!114 = !DILocation(line: 60, column: 23, scope: !105)
!115 = !DILocation(line: 60, column: 5, scope: !105)
!116 = !DILocation(line: 61, column: 3, scope: !105)
!117 = !DILocation(line: 63, column: 3, scope: !35)
!118 = !DILocation(line: 65, column: 3, scope: !35)
!119 = !DILocation(line: 68, column: 10, scope: !35)
!120 = !DILocation(line: 68, column: 17, scope: !35)
!121 = !DILocation(line: 68, column: 16, scope: !35)
!122 = !DILocation(line: 68, column: 22, scope: !35)
!123 = !DILocation(line: 68, column: 30, scope: !35)
!124 = !DILocation(line: 66, column: 3, scope: !35)
!125 = !DILocation(line: 70, column: 3, scope: !35)
!126 = !DILocation(line: 71, column: 3, scope: !35)
