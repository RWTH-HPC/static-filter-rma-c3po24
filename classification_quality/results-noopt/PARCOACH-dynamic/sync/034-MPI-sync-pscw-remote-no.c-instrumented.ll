; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c.ll'
...
@0 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
@2 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
@3 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
@4 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
@5 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/034-MPI-sync-pscw-remote-no.c\00", align 1
...
41:                                               ; preds = %37, %2
  %42 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 46, ptr @0), !dbg !80
...
54:                                               ; preds = %43
  ...
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 59, ptr @1), !dbg !129
...
59:                                               ; preds = %54
  ...
  %66 = call i32 @parcoach_rma_MPI_Put(ptr %24, i32 1, ptr @ompi_mpi_int, i32 2, i64 0, i32 1, ptr @ompi_mpi_int, ptr %65, i32 68, ptr @2), !dbg !147
...
72:                                               ; preds = %69
  ...
  %79 = call i32 @parcoach_rma_MPI_Get(ptr %27, i32 1, ptr @ompi_mpi_int, i32 2, i64 0, i32 1, ptr @ompi_mpi_int, ptr %78, i32 76, ptr @3), !dbg !168
...
102:                                              ; preds = %101, %59
  %103 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 95, ptr @4), !dbg !200
  ...
  %112 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 100, ptr @5), !dbg !207
