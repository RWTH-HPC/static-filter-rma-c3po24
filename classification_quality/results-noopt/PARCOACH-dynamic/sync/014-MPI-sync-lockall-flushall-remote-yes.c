...
/*
{
    ...
    "CONSISTENCY_CALLS":
["MPI_Win_lock_all","MPI_Win_unlock_all","MPI_Win_flush_all"], "SYNC_CALLS":
["MPI_Barrier"], "DESCRIPTION": "Two conflicting operations put and load with
flush_all (non-collective), but missing synchronization."
}
*/
// RACE LABELS END
