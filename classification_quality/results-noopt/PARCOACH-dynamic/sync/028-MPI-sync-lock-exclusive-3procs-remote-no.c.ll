; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/028-MPI-sync-lock-exclusive-3procs-remote-no.c'
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %43), !dbg !107
  ...
  %48 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %47), !dbg !111
  br label %49, !dbg !112
...
52:                                               ; preds = %49
  ...
  %54 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %53), !dbg !119
  %55 = load ptr, ptr %8, align 8, !dbg !120
  %56 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %55), !dbg !121
  %57 = load ptr, ptr %8, align 8, !dbg !122
  %58 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %57), !dbg !123
  br label %59, !dbg !124

59:                                               ; preds = %52, %49
  %60 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !125
  %61 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !126
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !133
