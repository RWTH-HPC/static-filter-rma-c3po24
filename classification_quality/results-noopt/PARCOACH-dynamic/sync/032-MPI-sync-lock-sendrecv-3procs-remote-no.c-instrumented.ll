; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c.ll'
...
@0 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@15 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
@16 = private unnamed_addr constant [92 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/032-MPI-sync-lock-sendrecv-3procs-remote-no.c\00", align 1
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 46, ptr @0), !dbg !92
...
38:                                               ; preds = %27
  %39 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 52, ptr @1), !dbg !111
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 56, ptr @2), !dbg !119
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @3), !dbg !120
  %45 = load ptr, ptr %8, align 8, !dbg !120
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 57, ptr @4), !dbg !121
  %47 = load ptr, ptr %8, align 8, !dbg !122
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 58, ptr @5), !dbg !123
...
50:                                               ; preds = %42, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 63, ptr @6), !dbg !126
...
54:                                               ; preds = %53, %50
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @7), !dbg !132
...
57:                                               ; preds = %54
  ...
  call void @parcoach_rma_store(ptr %10, i64 32, i32 71, ptr @8), !dbg !138
  store i32 1, ptr %10, align 4, !dbg !138
  call void @parcoach_rma_load(ptr %8, i64 64, i32 72, ptr @9), !dbg !139
  %59 = load ptr, ptr %8, align 8, !dbg !139
  %60 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %59, i32 72, ptr @10), !dbg !140
  call void @parcoach_rma_load(ptr %8, i64 64, i32 73, ptr @11), !dbg !141
  %61 = load ptr, ptr %8, align 8, !dbg !141
  %62 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %61, i32 73, ptr @12), !dbg !142
  call void @parcoach_rma_load(ptr %8, i64 64, i32 74, ptr @13), !dbg !143
  %63 = load ptr, ptr %8, align 8, !dbg !143
  %64 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %63, i32 74, ptr @14), !dbg !144
  br label %65, !dbg !145

65:                                               ; preds = %57, %54
  %66 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 77, ptr @15), !dbg !146
  ...
  %75 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 82, ptr @16), !dbg !153
