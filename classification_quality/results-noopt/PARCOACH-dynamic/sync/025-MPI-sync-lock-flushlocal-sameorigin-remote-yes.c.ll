; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c'
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @MPI_Win_lock(i32 noundef 2, i32 noundef 1, i32 noundef 0, ptr noundef %43), !dbg !107
  %45 = load ptr, ptr %8, align 8, !dbg !108
  %46 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %45), !dbg !109
  ...
  %50 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %49), !dbg !113
  %51 = load ptr, ptr %8, align 8, !dbg !114
  %52 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %51), !dbg !115
  br label %53, !dbg !116

53:                                               ; preds = %42, %38
  %54 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !117
  %55 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !118
