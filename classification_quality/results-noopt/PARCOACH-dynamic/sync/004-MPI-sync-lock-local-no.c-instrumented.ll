; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c"
...
@0 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@1 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@2 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@3 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@4 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@5 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@6 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@7 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@8 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@9 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@10 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@11 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@12 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@13 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@14 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@15 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@16 = private unnamed_addr constant [75 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 56, ptr @5), !dbg !115
  call void @parcoach_rma_load(ptr %10, i64 32, i32 57, ptr @6), !dbg !116
  %49 = load i32, ptr %10, align 4, !dbg !116
  %50 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %49), !dbg !117
  br label %51, !dbg !118

51:                                               ; preds = %42, %38
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @7), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 63, ptr @8), !dbg !120
  %53 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %12, i64 64, i32 63, ptr @9), !dbg !121
  %54 = load ptr, ptr %12, align 8, !dbg !121
  call void @parcoach_rma_load(ptr %54, i64 32, i32 63, ptr @10), !dbg !122
  %55 = load i32, ptr %54, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 63, ptr @11), !dbg !123
  %56 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @12), !dbg !124
  %57 = load ptr, ptr %9, align 8, !dbg !124
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %58, i64 32, i32 63, ptr @13), !dbg !124
  %59 = load i32, ptr %58, align 4, !dbg !124
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %53, i32 noundef %55, i32 noundef %56, i32 noundef %59), !dbg !125
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 65, ptr @14), !dbg !126
  %62 = call i32 @MPI_Finalize(), !dbg !127
  ret i32 0, !dbg !128
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "589f6f344780105bdacf1d093fe38411")
...
!114 = !DILocation(line: 56, column: 23, scope: !110)
...
!120 = !DILocation(line: 63, column: 10, scope: !40)
!121 = !DILocation(line: 63, column: 17, scope: !40)
!122 = !DILocation(line: 63, column: 16, scope: !40)
!123 = !DILocation(line: 63, column: 22, scope: !40)
!124 = !DILocation(line: 63, column: 30, scope: !40)
!125 = !DILocation(line: 61, column: 3, scope: !40)
!126 = !DILocation(line: 65, column: 3, scope: !40)
