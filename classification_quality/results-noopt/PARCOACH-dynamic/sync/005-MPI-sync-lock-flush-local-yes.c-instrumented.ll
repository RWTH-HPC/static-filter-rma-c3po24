; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c"
...
@0 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@1 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@2 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@3 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@4 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@5 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@6 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@7 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@8 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@16 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @15), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @16), !dbg !99
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 55, ptr @2), !dbg !111
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !112
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @4), !dbg !113
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %49, i32 61, ptr @5), !dbg !117
  %51 = load ptr, ptr %8, align 8, !dbg !118
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %51, i32 62, ptr @6), !dbg !119
  br label %53, !dbg !120

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @7), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @8), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %12, i64 64, i32 68, ptr @9), !dbg !123
  %56 = load ptr, ptr %12, align 8, !dbg !123
  call void @parcoach_rma_load(ptr %56, i64 32, i32 68, ptr @10), !dbg !124
  %57 = load i32, ptr %56, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 68, ptr @11), !dbg !125
  %58 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 68, ptr @12), !dbg !126
  %59 = load ptr, ptr %9, align 8, !dbg !126
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %60, i64 32, i32 68, ptr @13), !dbg !126
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 70, ptr @14), !dbg !128
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "ea4bb8aefd6e085d11e041064e30c366")
...
!109 = !DILocation(line: 55, column: 41, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 54, column: 18)
!111 = !DILocation(line: 55, column: 5, scope: !110)
!112 = !DILocation(line: 58, column: 51, scope: !110)
!113 = !DILocation(line: 58, column: 5, scope: !110)
!114 = !DILocation(line: 60, column: 29, scope: !110)
!115 = !DILocation(line: 60, column: 5, scope: !110)
!116 = !DILocation(line: 61, column: 22, scope: !110)
!117 = !DILocation(line: 61, column: 5, scope: !110)
!118 = !DILocation(line: 62, column: 23, scope: !110)
!119 = !DILocation(line: 62, column: 5, scope: !110)
!120 = !DILocation(line: 63, column: 3, scope: !110)
!121 = !DILocation(line: 65, column: 3, scope: !40)
!122 = !DILocation(line: 68, column: 10, scope: !40)
!123 = !DILocation(line: 68, column: 17, scope: !40)
!124 = !DILocation(line: 68, column: 16, scope: !40)
!125 = !DILocation(line: 68, column: 22, scope: !40)
!126 = !DILocation(line: 68, column: 30, scope: !40)
!127 = !DILocation(line: 66, column: 3, scope: !40)
!128 = !DILocation(line: 70, column: 3, scope: !40)
!129 = !DILocation(line: 71, column: 3, scope: !40)
!130 = !DILocation(line: 73, column: 3, scope: !40)
