; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c"
...
@0 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@1 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@2 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@3 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@4 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@5 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@6 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@7 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@8 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@9 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@10 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@11 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@12 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@13 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@14 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@15 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@16 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@17 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@18 = private unnamed_addr constant [77 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %40, i32 54, ptr @2), !dbg !101
  call void @parcoach_rma_load(ptr %6, i64 32, i32 55, ptr @3), !dbg !102
  %42 = load i32, ptr %6, align 4, !dbg !102
  %43 = icmp eq i32 %42, 0, !dbg !104
  br i1 %43, label %44, label %47, !dbg !105

44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @4), !dbg !106
  %45 = load ptr, ptr %8, align 8, !dbg !106
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @5), !dbg !108
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @6), !dbg !109
  store i32 42, ptr %10, align 4, !dbg !109
  br label %47, !dbg !110

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @7), !dbg !111
  %48 = load ptr, ptr %8, align 8, !dbg !111
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 62, ptr @8), !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @9), !dbg !113
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @10), !dbg !114
  %51 = load i32, ptr %6, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %12, i64 64, i32 67, ptr @11), !dbg !115
  %52 = load ptr, ptr %12, align 8, !dbg !115
  call void @parcoach_rma_load(ptr %52, i64 32, i32 67, ptr @12), !dbg !116
  %53 = load i32, ptr %52, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %11, i64 32, i32 67, ptr @13), !dbg !117
  %54 = load i32, ptr %11, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @14), !dbg !118
  %55 = load ptr, ptr %9, align 8, !dbg !118
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %56, i64 32, i32 67, ptr @15), !dbg !118
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 69, ptr @16), !dbg !120
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "0b1ac9bfa6b9bbd54253adb4d02b5a14")
