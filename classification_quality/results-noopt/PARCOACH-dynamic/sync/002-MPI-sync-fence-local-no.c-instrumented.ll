; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c"
...
@0 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@2 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@3 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@4 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@5 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@6 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@7 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@8 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@9 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@10 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@11 = private unnamed_addr constant [76 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %40, i32 53, ptr @2), !dbg !106
...
44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 55, ptr @4), !dbg !111
  %45 = load ptr, ptr %8, align 8, !dbg !111
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 55, ptr @5), !dbg !113
  br label %47, !dbg !114

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @6), !dbg !115
  %48 = load ptr, ptr %8, align 8, !dbg !115
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 57, ptr @7), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 58, ptr @8), !dbg !117
  %50 = load i32, ptr %6, align 4, !dbg !117
  %51 = icmp eq i32 %50, 0, !dbg !119
  br i1 %51, label %52, label %55, !dbg !120

52:                                               ; preds = %47
  %53 = load i32, ptr %10, align 4, !dbg !121
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %53), !dbg !123
  br label %55, !dbg !124

55:                                               ; preds = %52, %47
  %56 = load ptr, ptr %8, align 8, !dbg !125
  %57 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %56, i32 62, ptr @9), !dbg !126
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @10), !dbg !127
  %59 = load i32, ptr %6, align 4, !dbg !128
  %60 = load ptr, ptr %12, align 8, !dbg !129
  %61 = load i32, ptr %60, align 4, !dbg !130
  %62 = load i32, ptr %11, align 4, !dbg !131
  %63 = load ptr, ptr %9, align 8, !dbg !132
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !132
  %65 = load i32, ptr %64, align 4, !dbg !132
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %59, i32 noundef %61, i32 noundef %62, i32 noundef %65), !dbg !133
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 69, ptr @11), !dbg !134
  %68 = call i32 @MPI_Finalize(), !dbg !135
  ret i32 0, !dbg !136
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "b271751bf40e257afde277b720fa0e11")
...
!105 = !DILocation(line: 53, column: 20, scope: !40)
...
!111 = !DILocation(line: 55, column: 51, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 54, column: 18)
!113 = !DILocation(line: 55, column: 5, scope: !112)
!114 = !DILocation(line: 56, column: 3, scope: !112)
!115 = !DILocation(line: 57, column: 20, scope: !40)
!116 = !DILocation(line: 57, column: 3, scope: !40)
!117 = !DILocation(line: 58, column: 7, scope: !118)
!118 = distinct !DILexicalBlock(scope: !40, file: !2, line: 58, column: 7)
!119 = !DILocation(line: 58, column: 12, scope: !118)
!120 = !DILocation(line: 58, column: 7, scope: !40)
!121 = !DILocation(line: 59, column: 29, scope: !122)
...
!125 = !DILocation(line: 62, column: 20, scope: !40)
!126 = !DILocation(line: 62, column: 3, scope: !40)
!127 = !DILocation(line: 64, column: 3, scope: !40)
!128 = !DILocation(line: 67, column: 10, scope: !40)
!129 = !DILocation(line: 67, column: 17, scope: !40)
!130 = !DILocation(line: 67, column: 16, scope: !40)
!131 = !DILocation(line: 67, column: 22, scope: !40)
!132 = !DILocation(line: 67, column: 30, scope: !40)
!133 = !DILocation(line: 65, column: 3, scope: !40)
!134 = !DILocation(line: 69, column: 3, scope: !40)
!135 = !DILocation(line: 70, column: 3, scope: !40)
