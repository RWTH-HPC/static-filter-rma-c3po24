; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c'
...
51:                                               ; preds = %42, %38
  %52 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !119
  ...
  %61 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !126
