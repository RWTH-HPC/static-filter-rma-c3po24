; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c'
...
57:                                               ; preds = %52, %49
  ...
  %59 = call i32 @MPI_Win_unlock_all(ptr noundef %58), !dbg !127
  %60 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !128
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !136
