; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c"
...
@0 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@13 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@14 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@15 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@16 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@17 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@18 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@19 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@20 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  br i1 %41, label %42, label %49, !dbg !108

42:                                               ; preds = %38
  store i32 1, ptr %10, align 4, !dbg !109
  %43 = load ptr, ptr %8, align 8, !dbg !111
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 55, ptr @2), !dbg !112
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @3), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @4), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !115
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 57, ptr @5), !dbg !116
  br label %49, !dbg !117

49:                                               ; preds = %42, %38
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @6), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 62, ptr @7), !dbg !119
  %51 = load i32, ptr %6, align 4, !dbg !119
  %52 = icmp eq i32 %51, 1, !dbg !121
  br i1 %52, label %53, label %58, !dbg !122

53:                                               ; preds = %49
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @8), !dbg !123
  %54 = load ptr, ptr %9, align 8, !dbg !123
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %55, i64 32, i32 63, ptr @9), !dbg !123
  %56 = load i32, ptr %55, align 4, !dbg !123
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56), !dbg !125
  br label %58, !dbg !126

58:                                               ; preds = %53, %49
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @10), !dbg !127
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @11), !dbg !128
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @12), !dbg !129
  %61 = load i32, ptr %6, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @13), !dbg !130
  %62 = load ptr, ptr %12, align 8, !dbg !130
  call void @parcoach_rma_load(ptr %62, i64 32, i32 71, ptr @14), !dbg !131
  %63 = load i32, ptr %62, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @15), !dbg !132
  %64 = load i32, ptr %11, align 4, !dbg !132
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @16), !dbg !133
  %65 = load ptr, ptr %9, align 8, !dbg !133
  %66 = getelementptr inbounds i32, ptr %65, i64 0, !dbg !133
  call void @parcoach_rma_load(ptr %66, i64 32, i32 71, ptr @17), !dbg !133
  %67 = load i32, ptr %66, align 4, !dbg !133
  %68 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %61, i32 noundef %63, i32 noundef %64, i32 noundef %67), !dbg !134
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @18), !dbg !135
  %70 = call i32 @MPI_Finalize(), !dbg !136
  ret i32 0, !dbg !137
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "79e94c7ccfb902db0a51747191d8aefc")
...
!105 = !DILocation(line: 53, column: 7, scope: !106)
!106 = distinct !DILexicalBlock(scope: !40, file: !2, line: 53, column: 7)
!107 = !DILocation(line: 53, column: 12, scope: !106)
!108 = !DILocation(line: 53, column: 7, scope: !40)
!109 = !DILocation(line: 54, column: 11, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 53, column: 18)
!111 = !DILocation(line: 55, column: 41, scope: !110)
!112 = !DILocation(line: 55, column: 5, scope: !110)
!113 = !DILocation(line: 56, column: 51, scope: !110)
!114 = !DILocation(line: 56, column: 5, scope: !110)
!115 = !DILocation(line: 57, column: 23, scope: !110)
!116 = !DILocation(line: 57, column: 5, scope: !110)
!117 = !DILocation(line: 58, column: 3, scope: !110)
...
!129 = !DILocation(line: 71, column: 10, scope: !40)
!130 = !DILocation(line: 71, column: 17, scope: !40)
!131 = !DILocation(line: 71, column: 16, scope: !40)
!132 = !DILocation(line: 71, column: 22, scope: !40)
!133 = !DILocation(line: 71, column: 30, scope: !40)
!134 = !DILocation(line: 69, column: 3, scope: !40)
!135 = !DILocation(line: 73, column: 3, scope: !40)
