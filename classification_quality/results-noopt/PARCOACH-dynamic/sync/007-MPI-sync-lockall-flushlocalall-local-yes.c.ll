; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c'
...
44:                                               ; preds = %38
  ...
  %46 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %45), !dbg !113
...
51:                                               ; preds = %44, %38
  ...
  %53 = call i32 @MPI_Win_unlock_all(ptr noundef %52), !dbg !120
  %54 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !121
  ...
  %63 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !128
