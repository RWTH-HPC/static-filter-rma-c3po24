; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c'
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %40), !dbg !106
...
47:                                               ; preds = %44, %38
  ...
  %49 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %48), !dbg !116
...
55:                                               ; preds = %52, %47
  ...
  %57 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %56), !dbg !126
  %58 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !127
  ...
  %67 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !134
