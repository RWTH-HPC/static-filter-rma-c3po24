; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@19 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@20 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@21 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@22 = private unnamed_addr constant [87 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 47, ptr @21), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 47, ptr @22), !dbg !99
  store i32 %37, ptr %15, align 4, !dbg !99
  br label %27, !dbg !100, !llvm.loop !101

38:                                               ; preds = %27
  %39 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 51, ptr @1), !dbg !104
  %40 = load ptr, ptr %8, align 8, !dbg !105
  %41 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %40, i32 52, ptr @2), !dbg !106
  call void @parcoach_rma_load(ptr %6, i64 32, i32 54, ptr @3), !dbg !107
  %42 = load i32, ptr %6, align 4, !dbg !107
  %43 = icmp eq i32 %42, 0, !dbg !109
  br i1 %43, label %44, label %47, !dbg !110

44:                                               ; preds = %38
  call void @parcoach_rma_store(ptr %10, i64 32, i32 55, ptr @4), !dbg !111
  store i32 1, ptr %10, align 4, !dbg !111
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @5), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @6), !dbg !114
  br label %47, !dbg !115

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @7), !dbg !116
  %48 = load ptr, ptr %8, align 8, !dbg !116
  %49 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %48, i32 59, ptr @8), !dbg !117
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @9), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 62, ptr @10), !dbg !119
  %51 = load i32, ptr %6, align 4, !dbg !119
  %52 = icmp eq i32 %51, 1, !dbg !121
  br i1 %52, label %53, label %58, !dbg !122

53:                                               ; preds = %47
  call void @parcoach_rma_load(ptr %9, i64 64, i32 63, ptr @11), !dbg !123
  %54 = load ptr, ptr %9, align 8, !dbg !123
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %55, i64 32, i32 63, ptr @12), !dbg !123
  %56 = load i32, ptr %55, align 4, !dbg !123
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56), !dbg !125
  br label %58, !dbg !126

58:                                               ; preds = %53, %47
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @13), !dbg !127
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @14), !dbg !128
  %60 = load i32, ptr %6, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %12, i64 64, i32 69, ptr @15), !dbg !129
  %61 = load ptr, ptr %12, align 8, !dbg !129
  call void @parcoach_rma_load(ptr %61, i64 32, i32 69, ptr @16), !dbg !130
  %62 = load i32, ptr %61, align 4, !dbg !130
  call void @parcoach_rma_load(ptr %11, i64 32, i32 69, ptr @17), !dbg !131
  %63 = load i32, ptr %11, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %9, i64 64, i32 69, ptr @18), !dbg !132
  %64 = load ptr, ptr %9, align 8, !dbg !132
  %65 = getelementptr inbounds i32, ptr %64, i64 0, !dbg !132
  call void @parcoach_rma_load(ptr %65, i64 32, i32 69, ptr @19), !dbg !132
  ...
  %68 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 71, ptr @20), !dbg !134
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d43cd4a7b28641ecb56d3108243d5ac6")
...
!104 = !DILocation(line: 51, column: 3, scope: !40)
!105 = !DILocation(line: 52, column: 23, scope: !40)
!106 = !DILocation(line: 52, column: 3, scope: !40)
!107 = !DILocation(line: 54, column: 7, scope: !108)
!108 = distinct !DILexicalBlock(scope: !40, file: !2, line: 54, column: 7)
!109 = !DILocation(line: 54, column: 12, scope: !108)
!110 = !DILocation(line: 54, column: 7, scope: !40)
!111 = !DILocation(line: 55, column: 11, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 54, column: 18)
!113 = !DILocation(line: 56, column: 51, scope: !112)
!114 = !DILocation(line: 56, column: 5, scope: !112)
!115 = !DILocation(line: 57, column: 3, scope: !112)
!116 = !DILocation(line: 59, column: 22, scope: !40)
!117 = !DILocation(line: 59, column: 3, scope: !40)
!118 = !DILocation(line: 60, column: 3, scope: !40)
!119 = !DILocation(line: 62, column: 7, scope: !120)
!120 = distinct !DILexicalBlock(scope: !40, file: !2, line: 62, column: 7)
!121 = !DILocation(line: 62, column: 12, scope: !120)
!122 = !DILocation(line: 62, column: 7, scope: !40)
!123 = !DILocation(line: 63, column: 35, scope: !124)
!124 = distinct !DILexicalBlock(scope: !120, file: !2, line: 62, column: 18)
!125 = !DILocation(line: 63, column: 5, scope: !124)
!126 = !DILocation(line: 64, column: 3, scope: !124)
!127 = !DILocation(line: 66, column: 3, scope: !40)
!128 = !DILocation(line: 69, column: 10, scope: !40)
!129 = !DILocation(line: 69, column: 17, scope: !40)
!130 = !DILocation(line: 69, column: 16, scope: !40)
!131 = !DILocation(line: 69, column: 22, scope: !40)
!132 = !DILocation(line: 69, column: 30, scope: !40)
!133 = !DILocation(line: 67, column: 3, scope: !40)
!134 = !DILocation(line: 71, column: 3, scope: !40)
!135 = !DILocation(line: 72, column: 3, scope: !40)
!136 = !DILocation(line: 74, column: 3, scope: !40)
