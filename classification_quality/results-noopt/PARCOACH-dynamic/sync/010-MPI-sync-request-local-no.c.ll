; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/010-MPI-sync-request-local-no.c'
...
26:                                               ; preds = %22, %2
  %27 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !97
...
39:                                               ; preds = %28
  %40 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !116
...
51:                                               ; preds = %45, %39
  ...
  %53 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %52), !dbg !136
  %54 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !137
  ...
  %63 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !144
