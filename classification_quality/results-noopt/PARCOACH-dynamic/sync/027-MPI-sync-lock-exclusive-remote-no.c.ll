; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c'
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %43), !dbg !111
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %45), !dbg !113
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %47), !dbg !115
  br label %49, !dbg !116
...
52:                                               ; preds = %49
  ...
  %54 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %53), !dbg !123
  ...
  %60 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %59), !dbg !127
  br label %61, !dbg !128

61:                                               ; preds = %52, %49
  %62 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !129
  %63 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !130
  ...
  %72 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !137
