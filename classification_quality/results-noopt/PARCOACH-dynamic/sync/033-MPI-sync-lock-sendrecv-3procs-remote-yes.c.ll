; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c'
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %43), !dbg !124
...
65:                                               ; preds = %63, %60
  %66 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !148
  ...
  %75 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !155
