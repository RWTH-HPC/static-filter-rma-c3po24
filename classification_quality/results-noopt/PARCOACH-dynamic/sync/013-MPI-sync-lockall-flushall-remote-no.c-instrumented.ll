; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %39, i32 51, ptr @1), !dbg !105
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 52, ptr @2), !dbg !106
...
44:                                               ; preds = %38
  ...
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @3), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !115
  %48 = call i32 @MPI_Win_flush_all(ptr noundef %47), !dbg !116
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 58, ptr @4), !dbg !117
  br label %50, !dbg !118

50:                                               ; preds = %44, %38
  %51 = load i32, ptr %6, align 4, !dbg !119
  %52 = icmp eq i32 %51, 1, !dbg !121
  br i1 %52, label %53, label %59, !dbg !122

53:                                               ; preds = %50
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @5), !dbg !123
  %55 = load ptr, ptr %9, align 8, !dbg !125
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !125
  %57 = load i32, ptr %56, align 4, !dbg !125
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %57), !dbg !126
  br label %59, !dbg !127

59:                                               ; preds = %53, %50
  %60 = load ptr, ptr %8, align 8, !dbg !128
  %61 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %60, i32 66, ptr @6), !dbg !129
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @7), !dbg !130
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @8), !dbg !131
  %64 = load i32, ptr %6, align 4, !dbg !132
  %65 = load ptr, ptr %12, align 8, !dbg !133
  %66 = load i32, ptr %65, align 4, !dbg !134
  %67 = load i32, ptr %11, align 4, !dbg !135
  %68 = load ptr, ptr %9, align 8, !dbg !136
  %69 = getelementptr inbounds i32, ptr %68, i64 0, !dbg !136
  %70 = load i32, ptr %69, align 4, !dbg !136
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %64, i32 noundef %66, i32 noundef %67, i32 noundef %70), !dbg !137
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @9), !dbg !138
  %73 = call i32 @MPI_Finalize(), !dbg !139
  ret i32 0, !dbg !140
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "3b5dbaaf272ae99b195519e9c84a4941")
...
!104 = !DILocation(line: 51, column: 23, scope: !40)
...
!116 = !DILocation(line: 57, column: 5, scope: !112)
!117 = !DILocation(line: 58, column: 5, scope: !112)
!118 = !DILocation(line: 59, column: 3, scope: !112)
!119 = !DILocation(line: 61, column: 7, scope: !120)
!120 = distinct !DILexicalBlock(scope: !40, file: !2, line: 61, column: 7)
!121 = !DILocation(line: 61, column: 12, scope: !120)
!122 = !DILocation(line: 61, column: 7, scope: !40)
!123 = !DILocation(line: 62, column: 5, scope: !124)
!124 = distinct !DILexicalBlock(scope: !120, file: !2, line: 61, column: 18)
!125 = !DILocation(line: 63, column: 35, scope: !124)
!126 = !DILocation(line: 63, column: 5, scope: !124)
!127 = !DILocation(line: 64, column: 3, scope: !124)
!128 = !DILocation(line: 66, column: 22, scope: !40)
!129 = !DILocation(line: 66, column: 3, scope: !40)
!130 = !DILocation(line: 67, column: 3, scope: !40)
!131 = !DILocation(line: 69, column: 3, scope: !40)
!132 = !DILocation(line: 72, column: 10, scope: !40)
!133 = !DILocation(line: 72, column: 17, scope: !40)
!134 = !DILocation(line: 72, column: 16, scope: !40)
!135 = !DILocation(line: 72, column: 22, scope: !40)
!136 = !DILocation(line: 72, column: 30, scope: !40)
!137 = !DILocation(line: 70, column: 3, scope: !40)
!138 = !DILocation(line: 74, column: 3, scope: !40)
!139 = !DILocation(line: 75, column: 3, scope: !40)
!140 = !DILocation(line: 77, column: 3, scope: !40)
