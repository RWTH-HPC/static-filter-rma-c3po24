; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c"
...
@0 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@21 = private unnamed_addr constant [85 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 46, ptr @0), !dbg !80
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @20), !dbg !94
  %36 = load i32, ptr %15, align 4, !dbg !94
  %37 = add nsw i32 %36, 1, !dbg !94
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @21), !dbg !94
  store i32 %37, ptr %15, align 4, !dbg !94
  br label %27, !dbg !95, !llvm.loop !96

38:                                               ; preds = %27
  %39 = load ptr, ptr %8, align 8, !dbg !99
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 52, ptr @1), !dbg !100
  call void @parcoach_rma_load(ptr %6, i64 32, i32 54, ptr @2), !dbg !101
  %41 = load i32, ptr %6, align 4, !dbg !101
  %42 = icmp eq i32 %41, 0, !dbg !103
  br i1 %42, label %43, label %46, !dbg !104

43:                                               ; preds = %38
  call void @parcoach_rma_store(ptr %10, i64 32, i32 55, ptr @3), !dbg !105
  store i32 0, ptr %10, align 4, !dbg !105
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @4), !dbg !107
  %44 = load ptr, ptr %8, align 8, !dbg !107
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 57, ptr @5), !dbg !108
  br label %46, !dbg !109

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 60, ptr @6), !dbg !110
  %47 = load i32, ptr %6, align 4, !dbg !110
  %48 = icmp eq i32 %47, 2, !dbg !112
  br i1 %48, label %49, label %52, !dbg !113

49:                                               ; preds = %46
  call void @parcoach_rma_store(ptr %10, i64 32, i32 61, ptr @7), !dbg !114
  store i32 2, ptr %10, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @8), !dbg !116
  %50 = load ptr, ptr %8, align 8, !dbg !116
  %51 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %50, i32 63, ptr @9), !dbg !117
  br label %52, !dbg !118

52:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @10), !dbg !119
  %53 = load ptr, ptr %8, align 8, !dbg !119
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 66, ptr @11), !dbg !120
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @12), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @13), !dbg !122
  %56 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %12, i64 64, i32 71, ptr @14), !dbg !123
  %57 = load ptr, ptr %12, align 8, !dbg !123
  call void @parcoach_rma_load(ptr %57, i64 32, i32 71, ptr @15), !dbg !124
  %58 = load i32, ptr %57, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @16), !dbg !125
  %59 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @17), !dbg !126
  %60 = load ptr, ptr %9, align 8, !dbg !126
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %61, i64 32, i32 71, ptr @18), !dbg !126
  %62 = load i32, ptr %61, align 4, !dbg !126
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56, i32 noundef %58, i32 noundef %59, i32 noundef %62), !dbg !127
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @19), !dbg !128
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "7075551d83816d8a0b4cb9050ec1570f")
...
!99 = !DILocation(line: 52, column: 20, scope: !35)
!100 = !DILocation(line: 52, column: 3, scope: !35)
!101 = !DILocation(line: 54, column: 7, scope: !102)
!102 = distinct !DILexicalBlock(scope: !35, file: !2, line: 54, column: 7)
!103 = !DILocation(line: 54, column: 12, scope: !102)
!104 = !DILocation(line: 54, column: 7, scope: !35)
!105 = !DILocation(line: 55, column: 11, scope: !106)
!106 = distinct !DILexicalBlock(scope: !102, file: !2, line: 54, column: 18)
!107 = !DILocation(line: 57, column: 51, scope: !106)
!108 = !DILocation(line: 57, column: 5, scope: !106)
!109 = !DILocation(line: 58, column: 3, scope: !106)
!110 = !DILocation(line: 60, column: 7, scope: !111)
!111 = distinct !DILexicalBlock(scope: !35, file: !2, line: 60, column: 7)
!112 = !DILocation(line: 60, column: 12, scope: !111)
!113 = !DILocation(line: 60, column: 7, scope: !35)
!114 = !DILocation(line: 61, column: 11, scope: !115)
!115 = distinct !DILexicalBlock(scope: !111, file: !2, line: 60, column: 18)
!116 = !DILocation(line: 63, column: 51, scope: !115)
!117 = !DILocation(line: 63, column: 5, scope: !115)
!118 = !DILocation(line: 64, column: 3, scope: !115)
!119 = !DILocation(line: 66, column: 20, scope: !35)
!120 = !DILocation(line: 66, column: 3, scope: !35)
!121 = !DILocation(line: 68, column: 3, scope: !35)
!122 = !DILocation(line: 71, column: 10, scope: !35)
!123 = !DILocation(line: 71, column: 17, scope: !35)
!124 = !DILocation(line: 71, column: 16, scope: !35)
!125 = !DILocation(line: 71, column: 22, scope: !35)
!126 = !DILocation(line: 71, column: 30, scope: !35)
!127 = !DILocation(line: 69, column: 3, scope: !35)
!128 = !DILocation(line: 73, column: 3, scope: !35)
!129 = !DILocation(line: 74, column: 3, scope: !35)
!130 = !DILocation(line: 76, column: 3, scope: !35)
