; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [86 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/030-MPI-sync-lock-sendrecv-remote-yes.c\00", align 1
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 46, ptr @0), !dbg !97
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @17), !dbg !111
  %36 = load i32, ptr %15, align 4, !dbg !111
  %37 = add nsw i32 %36, 1, !dbg !111
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @18), !dbg !111
  store i32 %37, ptr %15, align 4, !dbg !111
  br label %27, !dbg !112, !llvm.loop !113

38:                                               ; preds = %27
  %39 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 52, ptr @1), !dbg !116
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 56, ptr @2), !dbg !124
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !125
  %45 = load ptr, ptr %8, align 8, !dbg !125
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @4), !dbg !126
  %47 = load ptr, ptr %8, align 8, !dbg !127
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 59, ptr @5), !dbg !128
...
50:                                               ; preds = %42, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @6), !dbg !131
  %51 = load i32, ptr %6, align 4, !dbg !131
  %52 = icmp eq i32 %51, 1, !dbg !133
  br i1 %52, label %53, label %59, !dbg !134

53:                                               ; preds = %50
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @7), !dbg !135
  %54 = load ptr, ptr %9, align 8, !dbg !135
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !135
  call void @parcoach_rma_load(ptr %55, i64 32, i32 66, ptr @8), !dbg !135
...
59:                                               ; preds = %53, %50
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @9), !dbg !140
  call void @parcoach_rma_load(ptr %6, i64 32, i32 73, ptr @10), !dbg !141
  %61 = load i32, ptr %6, align 4, !dbg !141
  call void @parcoach_rma_load(ptr %12, i64 64, i32 73, ptr @11), !dbg !142
  %62 = load ptr, ptr %12, align 8, !dbg !142
  call void @parcoach_rma_load(ptr %62, i64 32, i32 73, ptr @12), !dbg !143
  %63 = load i32, ptr %62, align 4, !dbg !143
  call void @parcoach_rma_load(ptr %11, i64 32, i32 73, ptr @13), !dbg !144
  %64 = load i32, ptr %11, align 4, !dbg !144
  call void @parcoach_rma_load(ptr %9, i64 64, i32 73, ptr @14), !dbg !145
  %65 = load ptr, ptr %9, align 8, !dbg !145
  %66 = getelementptr inbounds i32, ptr %65, i64 0, !dbg !145
  call void @parcoach_rma_load(ptr %66, i64 32, i32 73, ptr @15), !dbg !145
  ...
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 75, ptr @16), !dbg !147
