; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c"
...
@0 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [99 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @16), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @17), !dbg !99
...
38:                                               ; preds = %27
  ...
  br i1 %41, label %42, label %47, !dbg !108

42:                                               ; preds = %38
  store i32 1, ptr %10, align 4, !dbg !109
  %43 = load ptr, ptr %8, align 8, !dbg !111
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 56, ptr @2), !dbg !112
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 58, ptr @4), !dbg !114
  br label %47, !dbg !115

47:                                               ; preds = %42, %38
  %48 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 61, ptr @5), !dbg !116
  %49 = load i32, ptr %6, align 4, !dbg !117
  %50 = icmp eq i32 %49, 1, !dbg !119
  br i1 %50, label %51, label %56, !dbg !120

51:                                               ; preds = %47
  %52 = load ptr, ptr %9, align 8, !dbg !121
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !121
  %54 = load i32, ptr %53, align 4, !dbg !121
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %54), !dbg !123
  br label %56, !dbg !124

56:                                               ; preds = %51, %47
  %57 = load i32, ptr %6, align 4, !dbg !125
  %58 = icmp eq i32 %57, 0, !dbg !127
  br i1 %58, label %59, label %62, !dbg !128

59:                                               ; preds = %56
  %60 = load ptr, ptr %8, align 8, !dbg !129
  %61 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %60, i32 69, ptr @6), !dbg !131
  br label %62, !dbg !132

62:                                               ; preds = %59, %56
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @7), !dbg !133
  %64 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @8), !dbg !134
  call void @parcoach_rma_load(ptr %6, i64 32, i32 77, ptr @9), !dbg !135
  %65 = load i32, ptr %6, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %12, i64 64, i32 77, ptr @10), !dbg !136
  %66 = load ptr, ptr %12, align 8, !dbg !136
  call void @parcoach_rma_load(ptr %66, i64 32, i32 77, ptr @11), !dbg !137
  %67 = load i32, ptr %66, align 4, !dbg !137
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @12), !dbg !138
  %68 = load i32, ptr %11, align 4, !dbg !138
  call void @parcoach_rma_load(ptr %9, i64 64, i32 77, ptr @13), !dbg !139
  %69 = load ptr, ptr %9, align 8, !dbg !139
  %70 = getelementptr inbounds i32, ptr %69, i64 0, !dbg !139
  call void @parcoach_rma_load(ptr %70, i64 32, i32 77, ptr @14), !dbg !139
  %71 = load i32, ptr %70, align 4, !dbg !139
  %72 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %65, i32 noundef %67, i32 noundef %68, i32 noundef %71), !dbg !140
  %73 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @15), !dbg !141
  %74 = call i32 @MPI_Finalize(), !dbg !142
  ret i32 0, !dbg !143
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "530a4cb5c91e4d215de5ec7a8b3a2b1e")
...
!115 = !DILocation(line: 59, column: 3, scope: !110)
!116 = !DILocation(line: 61, column: 3, scope: !40)
!117 = !DILocation(line: 63, column: 7, scope: !118)
!118 = distinct !DILexicalBlock(scope: !40, file: !2, line: 63, column: 7)
!119 = !DILocation(line: 63, column: 12, scope: !118)
!120 = !DILocation(line: 63, column: 7, scope: !40)
!121 = !DILocation(line: 65, column: 35, scope: !122)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 63, column: 18)
!123 = !DILocation(line: 65, column: 5, scope: !122)
!124 = !DILocation(line: 66, column: 3, scope: !122)
!125 = !DILocation(line: 68, column: 7, scope: !126)
!126 = distinct !DILexicalBlock(scope: !40, file: !2, line: 68, column: 7)
!127 = !DILocation(line: 68, column: 12, scope: !126)
!128 = !DILocation(line: 68, column: 7, scope: !40)
!129 = !DILocation(line: 69, column: 23, scope: !130)
!130 = distinct !DILexicalBlock(scope: !126, file: !2, line: 68, column: 18)
!131 = !DILocation(line: 69, column: 5, scope: !130)
!132 = !DILocation(line: 70, column: 3, scope: !130)
!133 = !DILocation(line: 72, column: 3, scope: !40)
!134 = !DILocation(line: 74, column: 3, scope: !40)
!135 = !DILocation(line: 77, column: 10, scope: !40)
!136 = !DILocation(line: 77, column: 17, scope: !40)
!137 = !DILocation(line: 77, column: 16, scope: !40)
!138 = !DILocation(line: 77, column: 22, scope: !40)
!139 = !DILocation(line: 77, column: 30, scope: !40)
!140 = !DILocation(line: 75, column: 3, scope: !40)
!141 = !DILocation(line: 79, column: 3, scope: !40)
!142 = !DILocation(line: 80, column: 3, scope: !40)
!143 = !DILocation(line: 82, column: 3, scope: !40)
