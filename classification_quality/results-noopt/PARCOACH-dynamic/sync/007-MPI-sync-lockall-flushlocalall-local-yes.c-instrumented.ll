; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@15 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@16 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@17 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@18 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@19 = private unnamed_addr constant [93 x i8] c"results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 48, ptr @18), !dbg !99
  %36 = load i32, ptr %15, align 4, !dbg !99
  %37 = add nsw i32 %36, 1, !dbg !99
  call void @parcoach_rma_store(ptr %15, i64 32, i32 48, ptr @19), !dbg !99
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %40, i32 54, ptr @2), !dbg !106
  call void @parcoach_rma_load(ptr %6, i64 32, i32 56, ptr @3), !dbg !107
  %42 = load i32, ptr %6, align 4, !dbg !107
  %43 = icmp eq i32 %42, 0, !dbg !109
  br i1 %43, label %44, label %51, !dbg !110

44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @4), !dbg !111
  %45 = load ptr, ptr %8, align 8, !dbg !111
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 59, ptr @5), !dbg !113
  call void @parcoach_rma_load(ptr %10, i64 32, i32 61, ptr @6), !dbg !114
  %47 = load i32, ptr %10, align 4, !dbg !114
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %47), !dbg !115
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @7), !dbg !116
  %49 = load ptr, ptr %8, align 8, !dbg !116
  %50 = call i32 @MPI_Win_flush_local_all(ptr noundef %49), !dbg !117
  br label %51, !dbg !118

51:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @8), !dbg !119
  %52 = load ptr, ptr %8, align 8, !dbg !119
  %53 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %52, i32 65, ptr @9), !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @10), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 70, ptr @11), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %12, i64 64, i32 70, ptr @12), !dbg !123
  %56 = load ptr, ptr %12, align 8, !dbg !123
  call void @parcoach_rma_load(ptr %56, i64 32, i32 70, ptr @13), !dbg !124
  %57 = load i32, ptr %56, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 70, ptr @14), !dbg !125
  %58 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @15), !dbg !126
  %59 = load ptr, ptr %9, align 8, !dbg !126
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %60, i64 32, i32 70, ptr @16), !dbg !126
  %61 = load i32, ptr %60, align 4, !dbg !126
  %62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %55, i32 noundef %57, i32 noundef %58, i32 noundef %61), !dbg !127
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 72, ptr @17), !dbg !128
  %64 = call i32 @MPI_Finalize(), !dbg !129
  ret i32 0, !dbg !130
}
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "dbcc6a6500e506f6cf69dc9a07f5fe94")
...
!105 = !DILocation(line: 54, column: 23, scope: !40)
!106 = !DILocation(line: 54, column: 3, scope: !40)
!107 = !DILocation(line: 56, column: 7, scope: !108)
!108 = distinct !DILexicalBlock(scope: !40, file: !2, line: 56, column: 7)
!109 = !DILocation(line: 56, column: 12, scope: !108)
!110 = !DILocation(line: 56, column: 7, scope: !40)
!111 = !DILocation(line: 59, column: 51, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 56, column: 18)
!113 = !DILocation(line: 59, column: 5, scope: !112)
!114 = !DILocation(line: 61, column: 29, scope: !112)
!115 = !DILocation(line: 61, column: 5, scope: !112)
!116 = !DILocation(line: 62, column: 29, scope: !112)
!117 = !DILocation(line: 62, column: 5, scope: !112)
!118 = !DILocation(line: 63, column: 3, scope: !112)
!119 = !DILocation(line: 65, column: 22, scope: !40)
!120 = !DILocation(line: 65, column: 3, scope: !40)
!121 = !DILocation(line: 67, column: 3, scope: !40)
!122 = !DILocation(line: 70, column: 10, scope: !40)
!123 = !DILocation(line: 70, column: 17, scope: !40)
!124 = !DILocation(line: 70, column: 16, scope: !40)
!125 = !DILocation(line: 70, column: 22, scope: !40)
!126 = !DILocation(line: 70, column: 30, scope: !40)
!127 = !DILocation(line: 68, column: 3, scope: !40)
!128 = !DILocation(line: 72, column: 3, scope: !40)
!129 = !DILocation(line: 73, column: 3, scope: !40)
!130 = !DILocation(line: 75, column: 3, scope: !40)
