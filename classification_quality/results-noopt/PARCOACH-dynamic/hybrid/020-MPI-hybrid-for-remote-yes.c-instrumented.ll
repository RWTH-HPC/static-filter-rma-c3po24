; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c.ll'
...
@9 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
...
50:                                               ; preds = %46
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %51, i32 62, ptr @11), !dbg !134
  call void @parcoach_rma_store(ptr %10, i64 32, i32 63, ptr @12), !dbg !135
  store i32 42, ptr %10, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @13), !dbg !136
  %53 = load ptr, ptr %8, align 8, !dbg !136
  %54 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %53, i32 65, ptr @14), !dbg !137
  %55 = load ptr, ptr %8, align 8, !dbg !138
  %56 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %55, i32 66, ptr @15), !dbg !139
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @16), !dbg !140
  br label %58, !dbg !141
...
62:                                               ; preds = %61, %58
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 85, ptr @17), !dbg !149
  ...
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 90, ptr @18), !dbg !156
...
40:                                               ; preds = %34
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 76, ptr @19), !dbg !192
  br label %47, !dbg !194
