...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@79","LOAD@100"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Put and a local load with
missing synchronization at process 1. Since there is no taskwait, local load and
MPI_Barrier are concurrent, resulting in a remote race."
}
*/
// RACE LABELS END
