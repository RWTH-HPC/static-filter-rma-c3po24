; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c;main;69;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 94, ptr @0 }, align 8
@2 = private unnamed_addr constant %struct.ident_t { i32 0, i32 322, i32 0, i32 94, ptr @0 }, align 8
@.str.2 = private unnamed_addr constant [19 x i8] c"win_base[0] is %d\0A\00", align 1, !dbg !12
@3 = private unnamed_addr constant [96 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c;main;67;22;;\00", align 1
@4 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 95, ptr @3 }, align 8
@5 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c;main;67;1;;\00", align 1
...
@7 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@8 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@16 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
@17 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c\00", align 1
...
50:                                               ; preds = %46
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %51, i32 59, ptr @9), !dbg !134
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @10), !dbg !135
  store i32 42, ptr %10, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @11), !dbg !136
  %53 = load ptr, ptr %8, align 8, !dbg !136
  %54 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %53, i32 61, ptr @12), !dbg !137
  %55 = load ptr, ptr %8, align 8, !dbg !138
  %56 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %55, i32 62, ptr @13), !dbg !139
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @14), !dbg !140
  br label %58, !dbg !141
...
61:                                               ; preds = %58
  call void @__kmpc_push_num_threads(ptr @4, i32 %17, i32 2), !dbg !146
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @6, i32 1, ptr @.omp_outlined., ptr %9), !dbg !146
  br label %62, !dbg !148

62:                                               ; preds = %61, %58
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 75, ptr @15), !dbg !149
  ...
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @16), !dbg !156
...
define internal void @.omp_outlined._debug__(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #3 !dbg !159 {
  ...
  %10 = call i32 @__kmpc_single(ptr @1, i32 %9), !dbg !173
  %11 = icmp ne i32 %10, 0, !dbg !173
  br i1 %11, label %12, label %14, !dbg !173

12:                                               ; preds = %3
  %13 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @17), !dbg !175
  call void @__kmpc_end_single(ptr @1, i32 %9), !dbg !178
  br label %14, !dbg !178

14:                                               ; preds = %12, %3
  call void @__kmpc_barrier(ptr @2, i32 %9), !dbg !179
  %15 = load ptr, ptr %7, align 8, !dbg !180
  %16 = getelementptr inbounds i32, ptr %15, i64 0, !dbg !180
  %17 = load i32, ptr %16, align 4, !dbg !180
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %17), !dbg !181
  ret void, !dbg !182
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #3 !dbg !183 {
  %4 = alloca ptr, align 8
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  store ptr %0, ptr %4, align 8
  ...
  store ptr %1, ptr %5, align 8
  call void @llvm.dbg.declare(metadata ptr %5, metadata !186, metadata !DIExpression()), !dbg !185
  store ptr %2, ptr %6, align 8
  call void @llvm.dbg.declare(metadata ptr %6, metadata !187, metadata !DIExpression()), !dbg !185
  %7 = load ptr, ptr %6, align 8, !dbg !188
  %8 = load ptr, ptr %4, align 8, !dbg !188
  %9 = load ptr, ptr %5, align 8, !dbg !188
  %10 = load ptr, ptr %6, align 8, !dbg !188
  call void @.omp_outlined._debug__(ptr %8, ptr %9, ptr %10) #5, !dbg !188
  ret void, !dbg !188
}
...
; Function Attrs: nounwind
declare !callback !189 void @__kmpc_fork_call(ptr, i32, ptr, ...) #5
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/hybrid/014-MPI-hybrid-single-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d69c6e98b92262d39c529b6d55876630")
...
!136 = !DILocation(line: 61, column: 51, scope: !133)
!137 = !DILocation(line: 61, column: 5, scope: !133)
!138 = !DILocation(line: 62, column: 23, scope: !133)
!139 = !DILocation(line: 62, column: 5, scope: !133)
!140 = !DILocation(line: 63, column: 5, scope: !133)
!141 = !DILocation(line: 64, column: 3, scope: !133)
!142 = !DILocation(line: 66, column: 7, scope: !143)
!143 = distinct !DILexicalBlock(scope: !53, file: !2, line: 66, column: 7)
!144 = !DILocation(line: 66, column: 12, scope: !143)
!145 = !DILocation(line: 66, column: 7, scope: !53)
!146 = !DILocation(line: 67, column: 1, scope: !147)
!147 = distinct !DILexicalBlock(scope: !143, file: !2, line: 66, column: 18)
!148 = !DILocation(line: 73, column: 3, scope: !147)
!149 = !DILocation(line: 75, column: 3, scope: !53)
!150 = !DILocation(line: 78, column: 10, scope: !53)
!151 = !DILocation(line: 78, column: 17, scope: !53)
!152 = !DILocation(line: 78, column: 16, scope: !53)
!153 = !DILocation(line: 78, column: 22, scope: !53)
!154 = !DILocation(line: 78, column: 30, scope: !53)
!155 = !DILocation(line: 76, column: 3, scope: !53)
!156 = !DILocation(line: 80, column: 3, scope: !53)
!157 = !DILocation(line: 81, column: 3, scope: !53)
!158 = !DILocation(line: 83, column: 3, scope: !53)
!159 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !2, file: !2, line: 68, type: !160, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
...
!172 = !DILocation(line: 68, column: 5, scope: !159)
!173 = !DILocation(line: 69, column: 1, scope: !174)
!174 = distinct !DILexicalBlock(scope: !159, file: !2, line: 68, column: 5)
!175 = !DILocation(line: 70, column: 9, scope: !176)
!176 = distinct !DILexicalBlock(scope: !177, file: !2, line: 70, column: 7)
!177 = distinct !DILexicalBlock(scope: !174, file: !2, line: 69, column: 1)
!178 = !DILocation(line: 70, column: 38, scope: !176)
!179 = !DILocation(line: 69, column: 19, scope: !177)
!180 = !DILocation(line: 71, column: 37, scope: !174)
!181 = !DILocation(line: 71, column: 7, scope: !174)
!182 = !DILocation(line: 72, column: 5, scope: !159)
!183 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 67, type: !160, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
!184 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !183, type: !162, flags: DIFlagArtificial)
!185 = !DILocation(line: 0, scope: !183)
!186 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !183, type: !162, flags: DIFlagArtificial)
!187 = !DILocalVariable(name: "win_base", arg: 3, scope: !183, type: !166, flags: DIFlagArtificial)
!188 = !DILocation(line: 67, column: 1, scope: !183)
!189 = !{!190}
