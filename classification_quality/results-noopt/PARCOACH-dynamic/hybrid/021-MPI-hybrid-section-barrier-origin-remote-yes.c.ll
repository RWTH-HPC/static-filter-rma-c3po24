; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/021-MPI-hybrid-section-barrier-origin-remote-yes.c'
...
60:                                               ; preds = %54, %51
  %61 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !144
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !151
...
26:                                               ; preds = %24
  ...
  %28 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %27), !dbg !177
  %29 = load ptr, ptr %13, align 8, !dbg !178
  %30 = call i32 @MPI_Put(ptr noundef %12, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %29), !dbg !179
  %31 = load ptr, ptr %13, align 8, !dbg !180
  %32 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %31), !dbg !181
  br label %36, !dbg !182

33:                                               ; preds = %24
  %34 = call i32 (i32, ...) @sleep(i32 noundef 1), !dbg !183
  %35 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !186
  br label %36, !dbg !187
