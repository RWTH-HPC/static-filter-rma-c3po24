...
/*
{
    ...
    "RACE_PAIR": ["MPI_Get@69","LOAD@76"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Get and a local load with
missing synchronization at process 0. Since sections are run in parallel the
second section may access the window during the access epoch for MPI_Get."
}
*/
// RACE LABELS END
