; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c"
...
@0 = private unnamed_addr constant [94 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;61;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 93, ptr @0 }, align 8
@ompi_mpi_int = external global %struct.ompi_predefined_datatype_t, align 1
@2 = private unnamed_addr constant %struct.ident_t { i32 0, i32 322, i32 0, i32 93, ptr @0 }, align 8
@.str.2 = private unnamed_addr constant [19 x i8] c"win_base[0] is %d\0A\00", align 1, !dbg !12
@3 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;59;22;;\00", align 1
@4 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 94, ptr @3 }, align 8
@5 = private unnamed_addr constant [94 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;59;1;;\00", align 1
...
@7 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@8 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@9 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@10 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@11 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@12 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@13 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@14 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@15 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@16 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@17 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@18 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@19 = private unnamed_addr constant [81 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !53 {
  ...
  %17 = call i32 @__kmpc_global_thread_num(ptr @4)
...
33:                                               ; preds = %29, %24
  %34 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 50, ptr @7), !dbg !108
...
46:                                               ; preds = %35
  %47 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 56, ptr @8), !dbg !127
  %48 = load i32, ptr %6, align 4, !dbg !128
  %49 = icmp eq i32 %48, 0, !dbg !130
  br i1 %49, label %50, label %52, !dbg !131

50:                                               ; preds = %46
  call void @__kmpc_push_num_threads(ptr @4, i32 %17, i32 2), !dbg !132
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @6, i32 2, ptr @.omp_outlined., ptr %8, ptr %9), !dbg !132
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @9), !dbg !134
  br label %52, !dbg !135
...
55:                                               ; preds = %52
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @10), !dbg !140
...
61:                                               ; preds = %55, %52
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 77, ptr @11), !dbg !145
  ...
  %71 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 82, ptr @12), !dbg !152
...
define internal void @.omp_outlined._debug__(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(8) %3) #3 !dbg !155 {
  ...
  %13 = call i32 @__kmpc_single(ptr @1, i32 %12), !dbg !172
  %14 = icmp ne i32 %13, 0, !dbg !172
  br i1 %14, label %15, label %24, !dbg !172

15:                                               ; preds = %4
  %16 = load ptr, ptr %9, align 8, !dbg !174
  %17 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %16, i32 63, ptr @13), !dbg !177
  call void @parcoach_rma_load(ptr %10, i64 64, i32 64, ptr @14), !dbg !178
  %18 = load ptr, ptr %10, align 8, !dbg !178
  %19 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !178
  call void @parcoach_rma_load(ptr %9, i64 64, i32 64, ptr @15), !dbg !179
  %20 = load ptr, ptr %9, align 8, !dbg !179
  %21 = call i32 @parcoach_rma_MPI_Get(ptr %19, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %20, i32 64, ptr @16), !dbg !180
  %22 = load ptr, ptr %9, align 8, !dbg !181
  %23 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %22, i32 65, ptr @17), !dbg !182
  call void @__kmpc_end_single(ptr @1, i32 %12), !dbg !183
  br label %24, !dbg !183

24:                                               ; preds = %15, %4
  call void @__kmpc_barrier(ptr @2, i32 %12), !dbg !184
  call void @parcoach_rma_load(ptr %10, i64 64, i32 67, ptr @18), !dbg !185
  %25 = load ptr, ptr %10, align 8, !dbg !185
  %26 = getelementptr inbounds i32, ptr %25, i64 0, !dbg !185
  call void @parcoach_rma_load(ptr %26, i64 32, i32 67, ptr @19), !dbg !185
  %27 = load i32, ptr %26, align 4, !dbg !185
  %28 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %27), !dbg !186
  ret void, !dbg !187
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(8) %3) #3 !dbg !188 {
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
  %8 = alloca ptr, align 8
  ...
  store ptr %1, ptr %6, align 8
  call void @llvm.dbg.declare(metadata ptr %6, metadata !191, metadata !DIExpression()), !dbg !190
  store ptr %2, ptr %7, align 8
  call void @llvm.dbg.declare(metadata ptr %7, metadata !192, metadata !DIExpression()), !dbg !190
  store ptr %3, ptr %8, align 8
  call void @llvm.dbg.declare(metadata ptr %8, metadata !193, metadata !DIExpression()), !dbg !190
  %9 = load ptr, ptr %7, align 8, !dbg !194
  %10 = load ptr, ptr %8, align 8, !dbg !194
  %11 = load ptr, ptr %5, align 8, !dbg !194
  %12 = load ptr, ptr %6, align 8, !dbg !194
  %13 = load ptr, ptr %7, align 8, !dbg !194
  %14 = load ptr, ptr %8, align 8, !dbg !194
  call void @.omp_outlined._debug__(ptr %11, ptr %12, ptr %13, ptr %14) #5, !dbg !194
  ret void, !dbg !194
}
...
; Function Attrs: nounwind
declare !callback !195 void @__kmpc_fork_call(ptr, i32, ptr, ...) #5
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "3b09c9cd853f63968cd1b041dd4698f4")
...
!18 = distinct !DIGlobalVariable(scope: null, file: !2, line: 78, type: !19, isLocal: true, isDefinition: true)
...
!135 = !DILocation(line: 70, column: 3, scope: !133)
!136 = !DILocation(line: 72, column: 7, scope: !137)
!137 = distinct !DILexicalBlock(scope: !53, file: !2, line: 72, column: 7)
!138 = !DILocation(line: 72, column: 12, scope: !137)
!139 = !DILocation(line: 72, column: 7, scope: !53)
!140 = !DILocation(line: 73, column: 5, scope: !141)
!141 = distinct !DILexicalBlock(scope: !137, file: !2, line: 72, column: 18)
!142 = !DILocation(line: 74, column: 35, scope: !141)
!143 = !DILocation(line: 74, column: 5, scope: !141)
!144 = !DILocation(line: 75, column: 3, scope: !141)
!145 = !DILocation(line: 77, column: 3, scope: !53)
!146 = !DILocation(line: 80, column: 10, scope: !53)
!147 = !DILocation(line: 80, column: 17, scope: !53)
!148 = !DILocation(line: 80, column: 16, scope: !53)
!149 = !DILocation(line: 80, column: 22, scope: !53)
!150 = !DILocation(line: 80, column: 30, scope: !53)
!151 = !DILocation(line: 78, column: 3, scope: !53)
!152 = !DILocation(line: 82, column: 3, scope: !53)
!153 = !DILocation(line: 83, column: 3, scope: !53)
!154 = !DILocation(line: 85, column: 3, scope: !53)
...
!174 = !DILocation(line: 63, column: 48, scope: !175)
!175 = distinct !DILexicalBlock(scope: !176, file: !2, line: 62, column: 7)
!176 = distinct !DILexicalBlock(scope: !173, file: !2, line: 61, column: 1)
!177 = !DILocation(line: 63, column: 9, scope: !175)
!178 = !DILocation(line: 64, column: 18, scope: !175)
!179 = !DILocation(line: 64, column: 61, scope: !175)
!180 = !DILocation(line: 64, column: 9, scope: !175)
!181 = !DILocation(line: 65, column: 27, scope: !175)
!182 = !DILocation(line: 65, column: 9, scope: !175)
!183 = !DILocation(line: 66, column: 7, scope: !175)
!184 = !DILocation(line: 61, column: 19, scope: !176)
!185 = !DILocation(line: 67, column: 37, scope: !173)
!186 = !DILocation(line: 67, column: 7, scope: !173)
!187 = !DILocation(line: 68, column: 5, scope: !155)
!188 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 59, type: !156, scopeLine: 59, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
!189 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !188, type: !158, flags: DIFlagArtificial)
!190 = !DILocation(line: 0, scope: !188)
!191 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !188, type: !158, flags: DIFlagArtificial)
!192 = !DILocalVariable(name: "win", arg: 3, scope: !188, type: !162, flags: DIFlagArtificial)
!193 = !DILocalVariable(name: "win_base", arg: 4, scope: !188, type: !163, flags: DIFlagArtificial)
!194 = !DILocation(line: 59, column: 1, scope: !188)
!195 = !{!196}
