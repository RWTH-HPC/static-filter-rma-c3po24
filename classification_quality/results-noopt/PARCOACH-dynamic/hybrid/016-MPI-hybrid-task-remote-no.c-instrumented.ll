; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c.ll'
...
@11 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@20 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
@21 = private unnamed_addr constant [80 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/016-MPI-hybrid-task-remote-no.c\00", align 1
...
51:                                               ; preds = %47
  ...
  %53 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %52, i32 74, ptr @13), !dbg !165
  call void @parcoach_rma_store(ptr %10, i64 32, i32 75, ptr @14), !dbg !166
  store i32 42, ptr %10, align 4, !dbg !166
  call void @parcoach_rma_load(ptr %8, i64 64, i32 76, ptr @15), !dbg !167
  %54 = load ptr, ptr %8, align 8, !dbg !167
  %55 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %54, i32 76, ptr @16), !dbg !168
  %56 = load ptr, ptr %8, align 8, !dbg !169
  %57 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %56, i32 77, ptr @17), !dbg !170
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @18), !dbg !171
  br label %59, !dbg !172
...
63:                                               ; preds = %62, %59
  %64 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 102, ptr @19), !dbg !182
  ...
  %73 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 107, ptr @20), !dbg !189
...
define internal i32 @.omp_task_entry.(i32 noundef %0, ptr noalias noundef %1) #5 !dbg !221 {
  ...
  %19 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 90, ptr @21), !dbg !278
  ret i32 0, !dbg !237
}
