...
/*
{
    ...
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Get and a local load at
process 0. Since the creating thread waits in the taskwait construct for
completion, the access epoch must occur before the local load."
}
*/
// RACE LABELS END
