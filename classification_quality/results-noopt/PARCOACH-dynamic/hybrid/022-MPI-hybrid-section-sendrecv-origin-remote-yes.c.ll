; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/022-MPI-hybrid-section-sendrecv-origin-remote-yes.c'
...
34:                                               ; preds = %30, %25
  %35 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !120
...
47:                                               ; preds = %36
  %48 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !139
...
61:                                               ; preds = %55, %52
  %62 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !159
  ...
  %71 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !166
...
27:                                               ; preds = %25
  ...
  %29 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %28), !dbg !192
  %30 = load ptr, ptr %14, align 8, !dbg !193
  %31 = call i32 @MPI_Put(ptr noundef %12, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %30), !dbg !194
  %32 = load ptr, ptr %14, align 8, !dbg !195
  %33 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %32), !dbg !196
  br label %37, !dbg !197
