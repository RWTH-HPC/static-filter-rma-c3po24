; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c"
...
@0 = private unnamed_addr constant [96 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c;main;70;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 95, ptr @0 }, align 8
@2 = private unnamed_addr constant [96 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c;main;72;1;;\00", align 1
...
@5 = private unnamed_addr constant [97 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c;main;68;22;;\00", align 1
@6 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 96, ptr @5 }, align 8
@7 = private unnamed_addr constant [96 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c;main;68;1;;\00", align 1
...
@9 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@10 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@11 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@12 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@13 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@14 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@15 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@16 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@17 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@18 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
@19 = private unnamed_addr constant [83 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c\00", align 1
...
50:                                               ; preds = %46
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %51, i32 59, ptr @11), !dbg !134
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @12), !dbg !135
  store i32 42, ptr %10, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @13), !dbg !136
  %53 = load ptr, ptr %8, align 8, !dbg !136
  %54 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %53, i32 62, ptr @14), !dbg !137
  %55 = load ptr, ptr %8, align 8, !dbg !138
  %56 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %55, i32 63, ptr @15), !dbg !139
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @16), !dbg !140
  br label %58, !dbg !141
...
62:                                               ; preds = %61, %58
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 83, ptr @17), !dbg !149
  ...
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 88, ptr @18), !dbg !156
...
define internal void @.omp_outlined._debug__(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #3 !dbg !159 {
  ...
  call void @__kmpc_dispatch_init_4(ptr @1, i32 %16, i32 66, i32 0, i32 1, i32 1, i32 1), !dbg !183
  br label %17, !dbg !183

17:                                               ; preds = %45, %3
  %18 = call i32 @__kmpc_dispatch_next_4(ptr @1, i32 %16, ptr %12, ptr %9, ptr %10, ptr %11), !dbg !183
  %19 = icmp ne i32 %18, 0, !dbg !183
  br i1 %19, label %20, label %46, !dbg !183

20:                                               ; preds = %17
  %21 = load i32, ptr %9, align 4, !dbg !178
  store i32 %21, ptr %7, align 4, !dbg !178
  br label %22, !dbg !183

22:                                               ; preds = %41, %20
  %23 = load i32, ptr %7, align 4, !dbg !178
  %24 = load i32, ptr %10, align 4, !dbg !178
  %25 = icmp sle i32 %23, %24, !dbg !184
  br i1 %25, label %26, label %44, !dbg !183

26:                                               ; preds = %22
  %27 = load i32, ptr %7, align 4, !dbg !178
  %28 = mul nsw i32 %27, 1, !dbg !185
  %29 = add nsw i32 0, %28, !dbg !185
  store i32 %29, ptr %13, align 4, !dbg !185
  call void @__kmpc_ordered(ptr @3, i32 %16), !dbg !186
  %30 = load i32, ptr %13, align 4, !dbg !188
  %31 = icmp eq i32 %30, 0, !dbg !191
  br i1 %31, label %32, label %34, !dbg !192

32:                                               ; preds = %26
  %33 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @19), !dbg !193
  br label %39, !dbg !195

34:                                               ; preds = %26
  %35 = load ptr, ptr %14, align 8, !dbg !196
  %36 = getelementptr inbounds i32, ptr %35, i64 0, !dbg !196
  %37 = load i32, ptr %36, align 4, !dbg !196
  %38 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %37), !dbg !198
  br label %39

39:                                               ; preds = %34, %32
  call void @__kmpc_end_ordered(ptr @3, i32 %16), !dbg !199
  br label %40, !dbg !200
...
41:                                               ; preds = %40
  %42 = load i32, ptr %7, align 4, !dbg !178
  %43 = add nsw i32 %42, 1, !dbg !184
  store i32 %43, ptr %7, align 4, !dbg !184
  call void @__kmpc_dispatch_fini_4(ptr @1, i32 %16), !dbg !201
  br label %22, !dbg !201, !llvm.loop !202

44:                                               ; preds = %22
  br label %45, !dbg !201

45:                                               ; preds = %44
  br label %17, !dbg !201, !llvm.loop !204
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #3 !dbg !206 {
  %4 = alloca ptr, align 8
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  store ptr %0, ptr %4, align 8
  ...
  store ptr %1, ptr %5, align 8
  call void @llvm.dbg.declare(metadata ptr %5, metadata !209, metadata !DIExpression()), !dbg !208
  store ptr %2, ptr %6, align 8
  call void @llvm.dbg.declare(metadata ptr %6, metadata !210, metadata !DIExpression()), !dbg !208
  %7 = load ptr, ptr %6, align 8, !dbg !211
  %8 = load ptr, ptr %4, align 8, !dbg !211
  %9 = load ptr, ptr %5, align 8, !dbg !211
  %10 = load ptr, ptr %6, align 8, !dbg !211
  call void @.omp_outlined._debug__(ptr %8, ptr %9, ptr %10) #5, !dbg !211
  ret void, !dbg !211
}
...
; Function Attrs: nounwind
declare !callback !212 void @__kmpc_fork_call(ptr, i32, ptr, ...) #5
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/hybrid/019-MPI-hybrid-ordered-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "a6b78ff8afcf6c3307b090c616cf0cda")
...
!132 = !DILocation(line: 59, column: 44, scope: !133)
!133 = distinct !DILexicalBlock(scope: !129, file: !2, line: 58, column: 18)
!134 = !DILocation(line: 59, column: 5, scope: !133)
!135 = !DILocation(line: 60, column: 11, scope: !133)
...
!148 = !DILocation(line: 81, column: 3, scope: !147)
!149 = !DILocation(line: 83, column: 3, scope: !53)
!150 = !DILocation(line: 86, column: 10, scope: !53)
!151 = !DILocation(line: 86, column: 17, scope: !53)
!152 = !DILocation(line: 86, column: 16, scope: !53)
!153 = !DILocation(line: 86, column: 22, scope: !53)
!154 = !DILocation(line: 86, column: 30, scope: !53)
!155 = !DILocation(line: 84, column: 3, scope: !53)
!156 = !DILocation(line: 88, column: 3, scope: !53)
!157 = !DILocation(line: 89, column: 3, scope: !53)
!158 = !DILocation(line: 91, column: 3, scope: !53)
...
!170 = !DILocalVariable(name: "win_base", arg: 3, scope: !159, file: !2, line: 30, type: !166)
!171 = !DILocation(line: 30, column: 8, scope: !159)
!172 = !DILocation(line: 69, column: 5, scope: !159)
!173 = !DILocalVariable(name: ".omp.iv", scope: !174, type: !56, flags: DIFlagArtificial)
!174 = distinct !DILexicalBlock(scope: !175, file: !2, line: 70, column: 1)
!175 = distinct !DILexicalBlock(scope: !159, file: !2, line: 69, column: 5)
!176 = !DILocation(line: 0, scope: !174)
!177 = !DILocalVariable(name: ".omp.lb", scope: !174, type: !56, flags: DIFlagArtificial)
!178 = !DILocation(line: 71, column: 12, scope: !174)
...
!183 = !DILocation(line: 70, column: 1, scope: !175)
!184 = !DILocation(line: 71, column: 7, scope: !174)
!185 = !DILocation(line: 71, column: 30, scope: !174)
!186 = !DILocation(line: 72, column: 1, scope: !187)
!187 = distinct !DILexicalBlock(scope: !174, file: !2, line: 71, column: 35)
!188 = !DILocation(line: 73, column: 13, scope: !189)
!189 = distinct !DILexicalBlock(scope: !190, file: !2, line: 73, column: 13)
!190 = distinct !DILexicalBlock(scope: !187, file: !2, line: 72, column: 1)
!191 = !DILocation(line: 73, column: 15, scope: !189)
!192 = !DILocation(line: 73, column: 13, scope: !190)
!193 = !DILocation(line: 74, column: 11, scope: !194)
!194 = distinct !DILexicalBlock(scope: !189, file: !2, line: 73, column: 21)
!195 = !DILocation(line: 75, column: 9, scope: !194)
!196 = !DILocation(line: 77, column: 41, scope: !197)
!197 = distinct !DILexicalBlock(scope: !189, file: !2, line: 75, column: 16)
!198 = !DILocation(line: 77, column: 11, scope: !197)
!199 = !DILocation(line: 73, column: 18, scope: !189)
!200 = !DILocation(line: 79, column: 7, scope: !187)
!201 = !DILocation(line: 70, column: 1, scope: !174)
!202 = distinct !{!202, !201, !203}
!203 = !DILocation(line: 70, column: 24, scope: !174)
!204 = distinct !{!204, !201, !203}
!205 = !DILocation(line: 80, column: 5, scope: !159)
!206 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 68, type: !160, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
!207 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !206, type: !162, flags: DIFlagArtificial)
!208 = !DILocation(line: 0, scope: !206)
!209 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !206, type: !162, flags: DIFlagArtificial)
!210 = !DILocalVariable(name: "win_base", arg: 3, scope: !206, type: !166, flags: DIFlagArtificial)
!211 = !DILocation(line: 68, column: 1, scope: !206)
!212 = !{!213}
