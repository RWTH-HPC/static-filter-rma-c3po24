; ModuleID = 'results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c.ll'
source_filename = "results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;69;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 94, ptr @0 }, align 8
@2 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;71;1;;\00", align 1
@3 = private unnamed_addr constant %struct.ident_t { i32 0, i32 34, i32 0, i32 94, ptr @2 }, align 8
@.str.2 = private unnamed_addr constant [19 x i8] c"win_base[0] is %d\0A\00", align 1, !dbg !12
@4 = private unnamed_addr constant [96 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;67;22;;\00", align 1
@5 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 95, ptr @4 }, align 8
@6 = private unnamed_addr constant [95 x i8] c";results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;67;1;;\00", align 1
...
@8 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@16 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@17 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@18 = private unnamed_addr constant [82 x i8] c"results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
...
50:                                               ; preds = %46
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %51, i32 59, ptr @10), !dbg !134
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @11), !dbg !135
  store i32 42, ptr %10, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @12), !dbg !136
  %53 = load ptr, ptr %8, align 8, !dbg !136
  %54 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %53, i32 61, ptr @13), !dbg !137
  %55 = load ptr, ptr %8, align 8, !dbg !138
  %56 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %55, i32 62, ptr @14), !dbg !139
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @15), !dbg !140
  br label %58, !dbg !141
...
61:                                               ; preds = %58
  call void @__kmpc_push_num_threads(ptr @5, i32 %17, i32 2), !dbg !146
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @7, i32 1, ptr @.omp_outlined., ptr %9), !dbg !146
  br label %62, !dbg !148

62:                                               ; preds = %61, %58
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 76, ptr @16), !dbg !149
  ...
  %72 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @17), !dbg !156
...
12:                                               ; preds = %3
  %13 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @18), !dbg !176
  call void @__kmpc_end_master(ptr @1, i32 %9), !dbg !178
  br label %14, !dbg !178

14:                                               ; preds = %12, %3
  call void @__kmpc_barrier(ptr @3, i32 %9), !dbg !179
...
define internal void @.omp_outlined.(ptr noalias noundef %0, ptr noalias noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #3 !dbg !183 {
  ...
  call void @.omp_outlined._debug__(ptr %8, ptr %9, ptr %10) #4, !dbg !188
  ret void, !dbg !188
}
...
; Function Attrs: nounwind
declare !callback !189 void @__kmpc_fork_call(ptr, i32, ptr, ...) #4
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "919031705f4586c2d3903c6bc889abb0")
...
!148 = !DILocation(line: 74, column: 3, scope: !147)
!149 = !DILocation(line: 76, column: 3, scope: !53)
!150 = !DILocation(line: 79, column: 10, scope: !53)
!151 = !DILocation(line: 79, column: 17, scope: !53)
!152 = !DILocation(line: 79, column: 16, scope: !53)
!153 = !DILocation(line: 79, column: 22, scope: !53)
!154 = !DILocation(line: 79, column: 30, scope: !53)
!155 = !DILocation(line: 77, column: 3, scope: !53)
!156 = !DILocation(line: 81, column: 3, scope: !53)
!157 = !DILocation(line: 82, column: 3, scope: !53)
!158 = !DILocation(line: 84, column: 3, scope: !53)
...
!174 = distinct !DILexicalBlock(scope: !175, file: !2, line: 69, column: 1)
!175 = distinct !DILexicalBlock(scope: !159, file: !2, line: 68, column: 5)
!176 = !DILocation(line: 70, column: 9, scope: !177)
!177 = distinct !DILexicalBlock(scope: !174, file: !2, line: 70, column: 7)
!178 = !DILocation(line: 70, column: 38, scope: !177)
!179 = !DILocation(line: 71, column: 1, scope: !175)
!180 = !DILocation(line: 72, column: 37, scope: !175)
!181 = !DILocation(line: 72, column: 7, scope: !175)
!182 = !DILocation(line: 73, column: 5, scope: !159)
