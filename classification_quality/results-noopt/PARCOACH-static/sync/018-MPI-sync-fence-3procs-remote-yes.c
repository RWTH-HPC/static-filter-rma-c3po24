...
/*
{
    ...
    "RACE_PAIR": ["MPI_Put@57","MPI_Get@63"],
    "NPROCS": 3,
    "CONSISTENCY_CALLS": ["MPI_Win_fence"],
    "SYNC_CALLS": ["MPI_Win_fence"],
    "DESCRIPTION": "Two conflicting operations get and put which are not
synchronized correcly with an MPI_Win_fence leading to a remote race."
}
*/
// RACE LABELS END
