...
/*
{
    ...
    "RACE_PAIR": ["MPI_Get@69","LOAD@73"],
    "CONSISTENCY_CALLS": ["MPI_Win_lock","MPI_Win_unlock"],
    "SYNC_CALLS": ["MPI_Barrier"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations MPI_Get and a local load with
missing synchronization at process 0. Since the iterations of the loop can be
scheduled arbitrarily, the local load and MPI_Get are concurrent, resulting in a
local race."
}
*/
// RACE LABELS END
