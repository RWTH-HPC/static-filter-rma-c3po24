; ModuleID = 'results-20240305-201640/PARCOACH-static/hybrid/010-MPI-hybrid-task-local-no.c'
...
51:                                               ; preds = %47
  ...
  %52 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !167
  br label %53, !dbg !168
...
56:                                               ; preds = %53
  %57 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !173
...
62:                                               ; preds = %56, %53
  %63 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !178
  ...
  %72 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !185
...
define internal i32 @.omp_task_entry.(i32 noundef %0, ptr noalias noundef %1) #5 !dbg !220 {
  ...
  %22 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %21) #6, !dbg !282
  ...
  %29 = call i32 @MPI_Get(ptr noundef %25, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %28) #6, !dbg !285
  ...
  %33 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %32) #6, !dbg !287
  ret i32 0, !dbg !236
}
