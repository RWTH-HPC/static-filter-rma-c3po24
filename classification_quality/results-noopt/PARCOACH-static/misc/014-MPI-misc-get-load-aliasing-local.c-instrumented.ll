; ModuleID = 'results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c.ll'
source_filename = "results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c"
...
@0 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@13 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@14 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@15 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@16 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@17 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@18 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
@19 = private unnamed_addr constant [84 x i8] c"results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c\00", align 1
...
45:                                               ; preds = %40
  ...
  %48 = call i32 @parcoach_rma_MPI_Get(ptr %46, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %47, i32 66, ptr @5), !dbg !132
  call void @parcoach_rma_load(ptr %16, i64 64, i32 68, ptr @6), !dbg !133
  %49 = load ptr, ptr %16, align 8, !dbg !133
  call void @parcoach_rma_load(ptr %49, i64 32, i32 68, ptr @7), !dbg !134
  %50 = load i32, ptr %49, align 4, !dbg !134
  %51 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %50), !dbg !135
  br label %52, !dbg !136

52:                                               ; preds = %45, %40
  call void @parcoach_rma_load(ptr %8, i64 64, i32 71, ptr @8), !dbg !137
  %53 = load ptr, ptr %8, align 8, !dbg !137
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 71, ptr @9), !dbg !138
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @10), !dbg !139
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @11), !dbg !140
  %56 = load i32, ptr %6, align 4, !dbg !140
  call void @parcoach_rma_load(ptr %12, i64 64, i32 76, ptr @12), !dbg !141
  %57 = load ptr, ptr %12, align 8, !dbg !141
  call void @parcoach_rma_load(ptr %57, i64 32, i32 76, ptr @13), !dbg !142
  %58 = load i32, ptr %57, align 4, !dbg !142
  call void @parcoach_rma_load(ptr %11, i64 32, i32 76, ptr @14), !dbg !143
  %59 = load i32, ptr %11, align 4, !dbg !143
  call void @parcoach_rma_load(ptr %9, i64 64, i32 76, ptr @15), !dbg !144
  %60 = load ptr, ptr %9, align 8, !dbg !144
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !144
  call void @parcoach_rma_load(ptr %61, i64 32, i32 76, ptr @16), !dbg !144
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 78, ptr @17), !dbg !146
...
!2 = !DIFile(filename: "results-20240305-201640/PARCOACH-static/misc/014-MPI-misc-get-load-aliasing-local.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "68ae12ba289d5aac3ddfc855ad9cf407")
