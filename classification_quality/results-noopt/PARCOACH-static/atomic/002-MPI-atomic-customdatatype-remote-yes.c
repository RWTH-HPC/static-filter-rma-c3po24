...
/*
{
    ...
    "RACE_PAIR": ["MPI_Accumulate@63","MPI_Accumulate@69"],
    "NPROCS": 3,
    "CONSISTENCY_CALLS": ["MPI_Win_fence"],
    "SYNC_CALLS": ["MPI_Barrier", "MPI_Win_fence"],
    "DESCRIPTION": "Two atomic operations acc and acc using a custom datatype.
Since the used predefined data types are not the same, the operations are
conflicting."
}
*/
// RACE LABELS END
