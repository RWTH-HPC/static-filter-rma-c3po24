...
def gen_misc_races():
    ...
    local_src_templates = [
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-deep-nesting-local.c.j2", 2,  [], local_race_combinations), 
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-aliasing-local.c.j2", 2,  [], local_race_combinations),
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-retval-local.c.j2", 2,  [], local_race_combinations),
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-memcpy-local.c.j2", 2,  [], local_race_combinations),
    ]

    remote_src_templates = [
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-deep-nesting-remote.c.j2", 2, [], remote_race_combinations),
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-funcpointer-remote.c.j2", 2,  [], remote_race_combinations), 
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-aliasing-remote.c.j2", 2,  [], remote_race_combinations),
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-retval-remote.c.j2", 2,  [], remote_race_combinations),
            SourceTemplate("templates/MPIRMA/misc/MPI-misc-op1-op2-memcpy-remote.c.j2", 2,  [], remote_race_combinations),
    ]
