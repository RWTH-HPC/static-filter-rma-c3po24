...
#define CLIENT_TOOL_VERBOSE_INIT_VAR OMPT_MULTIPLEX_TOOL_NAME "_TOOL_VERBOSE_INIT"
#endif
#endif
...
void setup_verbose_init()
{
    ...
    if (ompt_env_verbose_init && strcmp(ompt_env_verbose_init, "") &&
        ...
        if (OMPT_STR_MATCH(ompt_env_verbose_init, "STDERR"))
            ...
            verbose_file = stdout;
        else if (!OMPT_STR_MATCH(ompt_env_verbose_init, getenv("OMP_TOOL_VERBOSE_INIT")))
...
#define OMPT_LOAD_CLIENT_FOREACH_OMPT_EVENT(macro)                                                 \
    ...
    macro(callback_error, ompt_callback_error_t, 37);
...
ompt_multiplex_callbacks_t ompt_multiplex_own_callbacks, ompt_multiplex_client_callbacks;
...
static ompt_multiplex_data_pair_t* ompt_multiplex_allocate_data_pair(ompt_data_t* data_pointer)
{
    ...
    ompt_multiplex_data_pair_t* data_pair = (ompt_multiplex_data_pair_t*)data_pointer->ptr;
    data_pair->own_data.ptr = NULL;
    data_pair->client_data.ptr = NULL;
    return data_pair;
}

static void ompt_multiplex_free_data_pair(ompt_data_t* data_pointer) { free((*data_pointer).ptr); }
...
static ompt_data_t* ompt_multiplex_get_own_ompt_data(ompt_data_t* data)
{
    ...
    if (!data->ptr)
        return NULL;
    ompt_multiplex_data_pair_t* data_pair = (ompt_multiplex_data_pair_t*)data->ptr;
...
static void ompt_multiplex_callback_mutex_acquire(
    ompt_mutex_t kind,
    unsigned int hint,
    unsigned int impl,
    ...
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_mutex_acquire) {
        ompt_multiplex_own_callbacks
            .ompt_callback_mutex_acquire(kind, hint, impl, wait_id, codeptr_ra);
    }
...
static void ompt_multiplex_callback_mutex_acquired(
    ompt_mutex_t kind,
    ompt_wait_id_t wait_id,
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_mutex_acquired) {
        ompt_multiplex_own_callbacks.ompt_callback_mutex_acquired(kind, wait_id, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_mutex_acquired) {
        ompt_multiplex_client_callbacks.ompt_callback_mutex_acquired(kind, wait_id, codeptr_ra);
    }
}

static void ompt_multiplex_callback_mutex_released(
    ompt_mutex_t kind,
    ompt_wait_id_t wait_id,
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_mutex_released) {
        ompt_multiplex_own_callbacks.ompt_callback_mutex_released(kind, wait_id, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_mutex_released) {
        ompt_multiplex_client_callbacks.ompt_callback_mutex_released(kind, wait_id, codeptr_ra);
    }
}

static void ompt_multiplex_callback_nest_lock(
    ompt_scope_endpoint_t endpoint,
    ompt_wait_id_t wait_id,
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_nest_lock) {
        ompt_multiplex_own_callbacks.ompt_callback_nest_lock(endpoint, wait_id, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_nest_lock) {
        ompt_multiplex_client_callbacks.ompt_callback_nest_lock(endpoint, wait_id, codeptr_ra);
    }
}

static void ompt_multiplex_callback_sync_region(
...
static void
ompt_multiplex_callback_cancel(ompt_data_t* task_data, int flags, const void* codeptr_ra)
{
...
static void ompt_multiplex_callback_lock_init(
    ompt_mutex_t kind,
    unsigned int hint,
    unsigned int impl,
    ompt_wait_id_t wait_id,
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_lock_init) {
        ompt_multiplex_own_callbacks.ompt_callback_lock_init(kind, hint, impl, wait_id, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_lock_init) {
        ompt_multiplex_client_callbacks
            .ompt_callback_lock_init(kind, hint, impl, wait_id, codeptr_ra);
    }
}

static void ompt_multiplex_callback_lock_destroy(
    ompt_mutex_t kind,
    ompt_wait_id_t wait_id,
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_lock_destroy) {
        ompt_multiplex_own_callbacks.ompt_callback_lock_destroy(kind, wait_id, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_lock_destroy) {
        ompt_multiplex_client_callbacks.ompt_callback_lock_destroy(kind, wait_id, codeptr_ra);
    }
}

static void ompt_multiplex_callback_work(
    ompt_work_t wstype,
    ompt_scope_endpoint_t endpoint,
    ompt_data_t* parallel_data,
    ompt_data_t* task_data,
...
static void ompt_multiplex_callback_masked(
    ompt_scope_endpoint_t endpoint,
    ompt_data_t* parallel_data,
    ompt_data_t* task_data,
    const void* codeptr_ra)
    ...
    const void* codeptr_ra)
{
    ...
    if (ompt_multiplex_own_callbacks.ompt_callback_parallel_begin) {
        ompt_multiplex_own_callbacks.ompt_callback_parallel_begin(
            ompt_multiplex_get_own_task_data(parent_task_data),
            parent_task_frame,
            ompt_multiplex_get_own_parallel_data(parallel_data),
            requested_team_size,
            flag,
...
static void ompt_multiplex_callback_parallel_end(
    ompt_data_t* parallel_data,
    ompt_data_t* task_data,
    int flag,
    const void* codeptr_ra)
    ...
    const void* codeptr_ra)
{
    ...
    if (ompt_multiplex_own_callbacks.ompt_callback_task_create) {
        ompt_multiplex_own_callbacks.ompt_callback_task_create(
            ompt_multiplex_get_own_task_data(parent_task_data),
            parent_frame,
            ompt_multiplex_get_own_task_data(new_task_data),
            type,
            has_dependences,
            codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_task_create) {
        ompt_multiplex_client_callbacks.ompt_callback_task_create(
            ompt_multiplex_get_client_task_data(parent_task_data),
            parent_frame,
            ompt_multiplex_get_client_task_data(new_task_data),
            type,
            has_dependences,
            codeptr_ra);
    }
...
static void ompt_multiplex_callback_task_schedule(
...
static void ompt_multiplex_callback_dependences(
    ompt_data_t* task_data,
...
static void
ompt_multiplex_callback_task_dependence(ompt_data_t* first_task_data, ompt_data_t* second_task_data)
{
...
static void
ompt_multiplex_callback_thread_begin(ompt_thread_t thread_type, ompt_data_t* thread_data)
{
#ifndef OMPT_MULTIPLEX_CUSTOM_GET_CLIENT_THREAD_DATA
...
static int ompt_multiplex_callback_control_tool(
    uint64_t command,
    uint64_t modifier,
    void* arg,
    const void* codeptr_ra)
    ...
    const char* documentation)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_device_initialize) {
        ompt_multiplex_own_callbacks
            .ompt_callback_device_initialize(device_num, type, device, lookup, documentation);
    }
...
static void ompt_multiplex_callback_device_load(
    int device_num,
    const char* filename,
...
static void ompt_multiplex_callback_device_unload(int device_num, uint64_t module_id)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_device_unload) {
        ompt_multiplex_own_callbacks.ompt_callback_device_unload(device_num, module_id);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_device_unload) {
        ompt_multiplex_client_callbacks.ompt_callback_device_unload(device_num, module_id);
    }
}

static void ompt_multiplex_callback_target_map(
    ompt_id_t target_id,
    unsigned int nitems,
    void** host_addr,
    void** device_addr,
...
static void ompt_multiplex_callback_reduction(
    ompt_sync_region_t kind,
    ompt_scope_endpoint_t endpoint,
    ompt_data_t* parallel_data,
    ompt_data_t* task_data,
...
static void ompt_multiplex_callback_dispatch(
    ompt_data_t* parallel_data,
    ompt_data_t* task_data,
    ...
    if (endpoint == ompt_scope_begin) {
        ...
        if (ompt_multiplex_own_callbacks.ompt_callback_target_emi) {
            ompt_multiplex_own_callbacks.ompt_callback_target_emi(
                ...
                ompt_multiplex_get_own_target_data(target_data),
                codeptr_ra);
        }
        if (ompt_multiplex_client_callbacks.ompt_callback_target_emi) {
            ompt_multiplex_client_callbacks.ompt_callback_target_emi(
                ...
                ompt_multiplex_get_client_target_data(target_data),
                codeptr_ra);
        }
    } else {
        // defines to make sure, callbacks are called in correct order depending on
...
static void ompt_multiplex_callback_error(
    ...
    const void* codeptr_ra)
{
    if (ompt_multiplex_own_callbacks.ompt_callback_error) {
        ompt_multiplex_own_callbacks.ompt_callback_error(severity, message, length, codeptr_ra);
    }
    if (ompt_multiplex_client_callbacks.ompt_callback_error) {
        ompt_multiplex_client_callbacks.ompt_callback_error(severity, message, length, codeptr_ra);
    }
}
...
int ompt_multiplex_own_get_task_info(
    ...
    int* thread_num)
{
    int ret = ompt_multiplex_get_task_info(
        ancestor_level,
        type,
        task_data,
        task_frame,
...
#else
        *parallel_data = OMPT_MULTIPLEX_CUSTOM_GET_CLIENT_PARALLEL_DATA(*parallel_data);
#endif
    return ret;
}
...
#else
    ret = OMPT_MULTIPLEX_CUSTOM_GET_CLIENT_THREAD_DATA(ompt_multiplex_get_thread_data());
#endif
    return ret;
}
...
int ompt_multiplex_own_get_parallel_info(
    ...
    int* team_size)
{
    int ret = ompt_multiplex_get_parallel_info(ancestor_level, parallel_data, team_size);
    if (parallel_data)
...
ompt_multiplex_own_set_callback(ompt_callbacks_t which, ompt_callback_t callback)
{
    switch (which) {
...
OMPT_API_ROUTINE int
ompt_multiplex_client_set_callback(ompt_callbacks_t which, ompt_callback_t callback)
{
    switch (which) {

#define ompt_event_macro(event_name, callback_type, event_id)                                      \
    case ompt_##event_name:                                                                        \
        ompt_multiplex_client_callbacks.ompt_##event_name = (callback_type)callback;               \
        if (ompt_multiplex_implementation_status.ompt_##event_name == -1)                          \
            return ompt_multiplex_implementation_status.ompt_##event_name =                        \
                       ompt_multiplex_set_callback(                                                \
                           ompt_##event_name,                                                      \
...
int ompt_multiplex_initialize(
    ompt_function_lookup_t lookup,
    int initial_device_num,
    ompt_data_t* data)
{
    ompt_multiplex_lookup_function = lookup;
    ompt_multiplex_set_callback = (ompt_set_callback_t)lookup("ompt_set_callback");
    ompt_multiplex_get_task_info = (ompt_get_task_info_t)lookup("ompt_get_task_info");
    ompt_multiplex_get_unique_id = (ompt_get_unique_id_t)lookup("ompt_get_unique_id");
    ompt_multiplex_get_thread_data = (ompt_get_thread_data_t)lookup("ompt_get_thread_data");
    ompt_multiplex_get_parallel_info = (ompt_get_parallel_info_t)lookup("ompt_get_parallel_info");
...
{
    if (ompt_multiplex_client_fns)
        ompt_multiplex_client_fns->finalize(&(ompt_multiplex_client_fns->tool_data));
...
ompt_multiplex_own_start_tool(unsigned int omp_version, const char* runtime_version);

ompt_start_tool_result_t* ompt_start_tool(unsigned int omp_version, const char* runtime_version)
{
    setup_verbose_init();
    OMPT_VERBOSE_INIT_PRINT("----- START LOGGING OF CLIENT TOOL REGISTRATION -----\n");
    // try loading client tool
    OMPT_VERBOSE_INIT_PRINT("Search for " CLIENT_TOOL_LIBRARIES_VAR " env var... ");
    ...
    if (tool_libs) {
        ...
        while (progress < strlen(tool_libs)) {
            ...
            ompt_start_tool_result_t* (*client_start_tool)(unsigned int, const char*) = NULL;
            OMPT_VERBOSE_INIT_PRINT("Look for candidates within " CLIENT_TOOL_LIBRARIES_VAR
                                    "...\n");
            int tmp_progress = progress;
            while (tmp_progress < strlen(tool_libs) && tool_libs_buffer[tmp_progress] != ':')
                tmp_progress++;
            ...
            if (h) {
                client_start_tool = (ompt_start_tool_result_t * (*)(unsigned int, const char*))
                    dlsym(h, "ompt_start_tool");
                if (client_start_tool && (ompt_multiplex_client_fns =
        ...
        OMPT_VERBOSE_INIT_PRINT("----- END LOGGING OF CLIENT TOOL REGISTRATION -----\n");
    }
    // load own tool
    OMPT_VERBOSE_INIT_PRINT("----- START LOGGING OF OWN TOOL REGISTRATION -----\n");
    ompt_multiplex_own_fns = ompt_multiplex_own_start_tool(omp_version, runtime_version);
