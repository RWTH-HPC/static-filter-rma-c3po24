 ...
 * These IDs represent a call location in source, which is at least the name of the call and
 * potentially a call stack. In addition, these id's encode an occurrence count that represents how
 * often this call was issued by the application.
 */
...
struct MustStackLevelInfo {
    ...
    MustStackLevelInfo(std::string fileModule, std::string symName, std::string lineOffset = "")
...
enum MustArgumentNameIds {
    ...
    MUST_ARGUMENT_PARTITIONS,
    MUST_ARGUMENT_PARTITION,
    MUST_ARGUMENT_PARTITION_LOW,
    MUST_ARGUMENT_PARTITION_HIGH,
    MUST_ARGUMENT_LENGTH,
    MUST_ARGUMENT_ARRAY_OF_PARTITIONS,
