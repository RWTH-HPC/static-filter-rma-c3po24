...
ArgumentAnalysis::ArgumentAnalysis(const char* instanceName)
    : gti::ModuleBase<ArgumentAnalysis, I_ArgumentAnalysis>(instanceName), myArgNames(NULL)
{
    // create sub modules
    ...
    myArgNames[MUST_ARGUMENT_SOURCES] = "sources";
    myArgNames[MUST_ARGUMENT_DEGREES] = "degrees";
    myArgNames[MUST_ARGUMENT_DESTINATIONS] = "destinations";
    myArgNames[MUST_ARGUMENT_WEIGHTS] = "weights";
    myArgNames[MUST_ARGUMENT_COMM_DIST_GRAPH] = "comm_dist_graph";
    ...
    myArgNames[MUST_ARGUMENT_PARTITIONS] = "partitions";
    myArgNames[MUST_ARGUMENT_PARTITION] = "partition";
    myArgNames[MUST_ARGUMENT_PARTITION_LOW] = "partition_low";
    myArgNames[MUST_ARGUMENT_PARTITION_HIGH] = "partition_high";
    myArgNames[MUST_ARGUMENT_LENGTH] = "length";
    myArgNames[MUST_ARGUMENT_ARRAY_OF_PARTITIONS] = "array_of_partitions";
}
...
// getIndex
//=============================
int ArgumentAnalysis::getIndex(MustArgumentId id) { return id >> 24; }
