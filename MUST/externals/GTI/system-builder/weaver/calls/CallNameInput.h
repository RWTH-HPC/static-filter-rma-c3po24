...
#ifndef CALLNAMEINPUT_H
#define CALLNAMEINPUT_H
 ...
 */
class CallNameInput : public Input, virtual public Printable
{
  public:
    /**
     ...
     * Proper Constructor.
     */
    CallNameInput(Call* call);

    /**
     * Empty Destructor
     */
    virtual ~CallNameInput();
