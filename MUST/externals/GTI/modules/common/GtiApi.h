 ...
 * b) Deactivate potentially existent event aggregation (I.e., all successive sends will be
 * immediate)
 */
 ...
 * @see gtiBreakRequest
 */
inline int PgtiBroadcastBreak(int code) { return 0; }
typedef int (*gtiBroadcastBreakP)(int);

/**
 * API event for starting VectorClock module
 */
inline int PgtiVectorClock (void) {return 0;}
typedef int (*gtiVectorClockP) (void);
