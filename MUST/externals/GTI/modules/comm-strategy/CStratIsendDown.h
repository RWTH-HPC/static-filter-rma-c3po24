...
#ifndef CSTRAT_ISEND_DOWN_H
#define CSTRAT_ISEND_DOWN_H
 ...
 */
class CStratIsendDown : public ModuleBase<CStratIsendDown, CStratDownQueue>, public CStratIsend
{
  protected:
  ...
  public:
     ...
     */
    CStratIsendDown(const char* instanceName);

    /**
     *Destructor.
     */
    ~CStratIsendDown(void);
