...
CStratSimpleUp::CStratSimpleUp(const char* instanceName)
    : ModuleBase<CStratSimpleUp, CStratUpQueue>(instanceName), myMsgQueue()
{
...
// shutdown
//=============================
GTI_RETURN CStratSimpleUp::shutdown(GTI_FLUSH_TYPE flush_behavior, GTI_SYNC_TYPE sync_behavior)
{
...
// flush
//=============================
GTI_RETURN CStratSimpleUp::flush(void)
{
