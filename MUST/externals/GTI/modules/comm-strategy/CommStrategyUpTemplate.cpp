...
//=============================
GTI_RETURN
CommStrategyUpTemplate::shutdown(GTI_FLUSH_TYPE flush_behavior, GTI_SYNC_TYPE sync_behavior)
{
    return GTI_SUCCESS;
}
...
// flush
//=============================
GTI_RETURN CommStrategyUpTemplate::flush(void) { return GTI_SUCCESS; }
