...
CStratPRecvUp::CStratPRecvUp(const char* instanceName)
    : ModuleBase<CStratPRecvUp, CStratUpQueue>(instanceName), CStratPRecvSender(&protocol)
{
...
// shutdown
//=============================
GTI_RETURN CStratPRecvUp::shutdown(GTI_FLUSH_TYPE flush_behavior, GTI_SYNC_TYPE sync_behavior)
{
...
// flush
//=============================
GTI_RETURN CStratPRecvUp::flush(void)
{
    //==Check whether a connection exists
    if (!protocol->isConnected()) {
        return GTI_ERROR_NOT_INITIALIZED;
