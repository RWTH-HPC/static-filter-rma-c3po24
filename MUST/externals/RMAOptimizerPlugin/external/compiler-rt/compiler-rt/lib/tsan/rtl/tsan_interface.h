...
// Call after first possibility of races occurring
SANITIZER_INTERFACE_ATTRIBUTE void __tsan_start_racedetect();
SANITIZER_INTERFACE_ATTRIBUTE void __tsan_stop_racedetect();
