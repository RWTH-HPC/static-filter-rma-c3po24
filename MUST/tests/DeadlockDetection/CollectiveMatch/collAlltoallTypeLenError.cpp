...
// RUN: %builddir/tests/DeadlockDetection/DCollectiveMatch/collAlltoallTypeLenErrorlayout.xml \
// RUN: %must-bin-dir/DcollAlltoallTypeLenError 2>&1 \
...
/**
 * @file collAlltoallTypeLenError.cpp
 * Collective matching test.
 *
 * Description:
 * Performs a MPI_Alltoall collective with an error
 *
 *
 *  @date 27.03.2012
