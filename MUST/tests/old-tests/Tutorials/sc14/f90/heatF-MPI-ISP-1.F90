...
contains
  ...
  subroutine heatBoundary(grid, mympi)
    ...
    CALL MPI_SEND (grid%theta(mympi%start_x, mympi%start_y), &
    ...
    CALL MPI_SEND (grid%theta(mympi%start_x+mympi%num_cells_x-1, mympi%start_y), &
    ...
    CALL MPI_SEND (grid%theta(mympi%start_x, mympi%start_y+mympi%num_cells_y-1), &
