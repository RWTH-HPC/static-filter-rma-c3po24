...
// RUN: %builddir/tests/TypeMatch/MatchSimpleNoErrorlayout.xml \
// RUN: %must-bin-dir/MatchSimpleNoError 2>&1 \
// RUN: | %filecheck --implicit-check-not \
// RUN: '[MUST-REPORT]{{.*(Error|ERROR|Warning|WARNING)}}' %s

// RUN: %must-run %mpiexec-numproc-flag 2 --must:layout \
// RUN: %builddir/tests/TypeMatch/DMatchSimpleNoErrorlayout.xml \
// RUN: %must-bin-dir/DMatchSimpleNoError 2>&1 \
// RUN: | %filecheck --implicit-check-not \
// RUN: '[MUST-REPORT]{{.*(Error|ERROR|Warning|WARNING)}}' %s
