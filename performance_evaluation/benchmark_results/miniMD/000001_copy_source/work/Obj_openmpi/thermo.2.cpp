...
#pragma omp master
  {
    ...
    double oldtime = timer.array[0];
    timer.barrier_stop(0);

    if(threads->mpi_me == 0) {
      fprintf(stdout, "%i %e %e %e %6.3lf\n", istep, t, eng, p, istep == 0 ? 0.0 : timer.array[0]);
    }

    timer.array[0] = oldtime;
  }
}
...
MMD_float Thermo::energy(Atom &atom, Neighbor &neighbor, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype)0x4c00040a), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  else
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
...
#pragma omp master
  {
    if(sizeof(MMD_float) == 4)
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype)0x4c00040a), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
    else
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
...
MMD_float Thermo::pressure(MMD_float t, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype)0x4c00040a), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  else
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
