            ...
            Thermo &thermo, Integrate &integrate, Timer &timer, int screen_yaml)
{
  ...
  int natoms;
  MPI_Allreduce(&atom.nlocal, &natoms, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));

  int nlost = 0;

  for(i = 0; i < atom.nlocal; i++) {
    if(atom.x[i * 3 + 0] < 0.0 || atom.x[i * 3 + 0] >= atom.box.xprd ||
        atom.x[i * 3 + 1] < 0.0 || atom.x[i * 3 + 1] >= atom.box.yprd ||
        atom.x[i * 3 + 2] < 0.0 || atom.x[i * 3 + 2] >= atom.box.zprd) nlost++;
  }

  int nlostall;
  MPI_Allreduce(&nlost, &nlostall, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  ...
  if(me == 0) {
    ...
    time_t general_time = time(__null);
    ...
    fprintf(fp, "  variant: " "miniMD-Reference 2.0 (MPI+OpenMP)" "\n");
  ...
  double time_total = timer.array[0];
  MPI_Allreduce(&time_total, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  ...
  double time_force = timer.array[2];
  MPI_Allreduce(&time_force, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  tmp /= nprocs;
  ...
  double time_neigh = timer.array[3];
  MPI_Allreduce(&time_neigh, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  tmp /= nprocs;
  ...
  double time_comm = timer.array[1];
  MPI_Allreduce(&time_comm, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  tmp /= nprocs;
  ...
  MPI_Allreduce(&time_other, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  tmp /= nprocs;
  ...
  MPI_Allreduce(&tmp, &total, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
           ...
           int nhisto, int* histo)
{
  ...
  int ntotal;
  MPI_Allreduce(&n, &ntotal, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  double tmp;
  MPI_Allreduce(&ave, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
  ave = tmp / ntotal;
  MPI_Allreduce(&min, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000002), ((MPI_Comm)0x44000000));
  min = tmp;
  MPI_Allreduce(&max, &tmp, 1, ((MPI_Datatype)0x4c00080b), (MPI_Op)(0x58000001), ((MPI_Comm)0x44000000));
  max = tmp;
  ...
  MPI_Allreduce(histo, histotmp, nhisto, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), ((MPI_Comm)0x44000000));
