...
struct ThreadSanitizerMODPass : public PassInfoMixin<ThreadSanitizerMODPass> {
...
struct ModuleThreadSanitizerMODPass
  : public PassInfoMixin<ModuleThreadSanitizerMODPass> {
